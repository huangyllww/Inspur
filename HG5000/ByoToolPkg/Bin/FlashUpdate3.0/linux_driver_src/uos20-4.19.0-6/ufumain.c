...
ufu_ioctl (struct file *filp, unsigned int cmd, unsigned long arg)
{
  ...
  switch (cmd) {
    case IOCTL_UFU_MEM_ALLOCATE:
      ...
      raw_copy_from_user(&mem, (void *)arg, sizeof(UFU_MEM_OPERATION_BUFFER));
      ...
      raw_copy_to_user((void*)arg, &mem, sizeof(UFU_MEM_OPERATION_BUFFER));
    ...
    case IOCTL_UFU_MEM_WRITE:
      ...
      ret = raw_copy_from_user((void *)mem.dst, (void *)mem.src, mem.size);
      break;

    case IOCTL_UFU_MEM_READ:
      raw_copy_from_user(&mem, (void *)arg, sizeof(UFU_MEM_OPERATION_BUFFER));
      printk(KERN_INFO "bytt, IOCTL_UFU_MEM_READ, src=%p, dest=%p, size=%u\n", mem.src, mem.dst, mem.size);
      ret = raw_copy_to_user((void *)mem.dst, (void *)mem.src, mem.size);
      break;
    ...
    case IOCTL_UFU_SMI_CALL:
      raw_copy_from_user(&smi,(void*)arg,sizeof(UFU_SMI_BUFFER));
    ...
    case IOCTL_UFU_RD_PHYSICAL_MEM:
      ...
      ret = raw_copy_to_user((void *)mem.dst, (void *)addr, mem.size);
      iounmap(addr);
      break;
