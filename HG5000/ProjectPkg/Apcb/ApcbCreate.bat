...
REM ============================================================================
SET APCB_BIN_FILE=%APCB_WORK_DIR%\%RELEASE_DIR%\%APCB_BIN_FILE_BASE_NAME%.bin
...
:BUILD_ALL_C_SOURCES
  ...
  SET C_INCLUDE_PATH_FLAG=/IInclude /I%WORK_SPACE%\AgesaPkg\Addendum\Apcb\Inc /I%WORK_SPACE%
...
:RUN_APCB_TOOL_WITH_EXE_LOG
	...
	REM --------------------------------------------------------------------
	SET APCB_EXE_LOG=%APCB_WORK_DIR%\%LOG_DIR%\%APCB_EXE_LOG_INPUT%.txt
