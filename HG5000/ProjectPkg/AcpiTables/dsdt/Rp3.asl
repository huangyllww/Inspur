...
//-         Name (LVGA, 0x00)
            ...
            {
                CreateWordField (CRS2, \_SB.S0D3._Y21._MIN, MIN2)  // _MIN: Minimum Base Address
                CreateWordField (CRS2, \_SB.S0D3._Y21._MAX, MAX2)  // _MAX: Maximum Base Address
                CreateWordField (CRS2, \_SB.S0D3._Y21._LEN, LEN2)  // _LEN: Length
                Store(\R3BB, MIN2)
                Store(\R3BL, MAX2)
                Subtract(MAX2, MIN2, Local0)
                Add(Local0, 1, LEN2)
                
                CreateWordField (CRS2, \_SB.S0D3._Y22._MIN, MIN4)  // _MIN: Minimum Base Address
                CreateWordField (CRS2, \_SB.S0D3._Y22._MAX, MAX4)  // _MAX: Maximum Base Address
                CreateWordField (CRS2, \_SB.S0D3._Y22._LEN, LEN4)  // _LEN: Length
                Store (\R3IB, MIN4)
                Store (\R3IL, LEN4)
                Store (LEN4, Local1)
                ...
                If (\GFX3)
                {
                    CreateWordField (CRS2, \_SB.S0D3._Y23._MIN, IMN2)  // _MIN: Minimum Base Address
                    CreateWordField (CRS2, \_SB.S0D3._Y23._MAX, IMX2)  // _MAX: Maximum Base Address
                    CreateWordField (CRS2, \_SB.S0D3._Y23._LEN, ILN2)  // _LEN: Length
                    Store (0x03B0, IMN2)
                    Store (0x03DF, IMX2)
                    Store (0x30, ILN2)
                    CreateDWordField (CRS2, \_SB.S0D3._Y24._MIN, VMN2)  // _MIN: Minimum Base Address
                    CreateDWordField (CRS2, \_SB.S0D3._Y24._MAX, VMX2)  // _MAX: Maximum Base Address
                    CreateDWordField (CRS2, \_SB.S0D3._Y24._LEN, VLN2)  // _LEN: Length
                    Store (0x000A0000, VMN2)
                    Store (0x000BFFFF, VMX2)
                    Store (0x00020000, VLN2)
                }

                CreateDWordField (CRS2, \_SB.S0D3._Y25._MIN, MIN5)  // _MIN: Minimum Base Address
                CreateDWordField (CRS2, \_SB.S0D3._Y25._MAX, MAX5)  // _MAX: Maximum Base Address
                CreateDWordField (CRS2, \_SB.S0D3._Y25._LEN, LEN5)  // _LEN: Length
                Store (\RP3B, MIN5)
                Store (\RP3L, LEN5)
                Store (LEN5, Local1)
                Add (MIN5, Decrement (Local1), MAX5)
               
                CreateQWordField (CRS2, \_SB.S0D3._Y26._MIN, MIN9)  // _MIN: Minimum Base Address
                CreateQWordField (CRS2, \_SB.S0D3._Y26._MAX, MAX9)  // _MAX: Maximum Base Address
                CreateQWordField (CRS2, \_SB.S0D3._Y26._LEN, LEN9)  // _LEN: Length
                Store (\R3HB, MIN9)
                Store (\R3HL, LEN9)
                Store (LEN9, Local0)
