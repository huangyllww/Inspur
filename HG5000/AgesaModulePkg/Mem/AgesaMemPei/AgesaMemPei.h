...
**/
#ifndef __AGESA_MEM_PEI_H_
#define __AGESA_MEM_PEI_H_
#ifdef __cplusplus
extern "C" {
#endif
...
//  UINT8  SocketId;
  ...
  UINT8  DimmId;
  UINT8  SmbusAddress;
} AGESA_DIMM_INFO_SMBUS;
#pragma pack (pop)


//#define DIMM_DEVICE_SLOT_COUNT      DIMM_SLOTS_PER_SCKT       // Dimm Slot depends on platform       // winddy -
...
//#define DIMM_HOB_SERIAL_NO_LENGTH   DIMM_SPD_SERIAL_NO_LENGTH * DIMM_DEVICE_SLOT_COUNT               // winddy -
// 512 Bytes * DIMM number Hob Data
//#define DIMM_HOB_DATA_LENGTH        DIMM_SPD_DATA_LENGTH * DIMM_DEVICE_SLOT_COUNT                    // winddy -
