  ...
  )
{
  ...
  IDS_HDT_CONSOLE (CPU_TRACE, "ZenZpGetCoreDmiInfo(%d)\n", Socket);       // wz200731 +
...
// wz200731 - <<	
    ...
    IDS_HDT_CONSOLE (CPU_TRACE, "SmtEnByFuse:%d DieCount:%d CoreCountByFuse:%d\n", SmtEnByFuse, DieCount, CoreCountByFuse);  // wz200731 +
