  ...
  )
{
  ...
  for (Index = 0; Index < BootOptionCount; Index++) {
    ...
    ASSERT (BootOption[Index].OptionalDataSize == LegacyBootOptionalDataGetSize());
    ...
    NewLegacyDevContext->BbsIndex    = LegacyBootOptionalDataGetBbsIndex(BootOption[Index].OptionalData);
