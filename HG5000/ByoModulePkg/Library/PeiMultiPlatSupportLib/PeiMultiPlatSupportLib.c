...
#if TKN_KEEP_PASSWORD_WHEN_LOAD_FCE    
//  {&gByoSystemPassword2VariableGuid, SYSTEM_PASSWORD2_NAME},
...
--*/
{
  ...
  UpdateVariableInHob(VarStoreHeaderHob, &SetupData);
