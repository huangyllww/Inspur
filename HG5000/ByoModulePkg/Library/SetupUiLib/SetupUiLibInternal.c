  ...
  )
{
  ...
  gStrUiDefaultAndSave = UiGetToken (STRING_TOKEN (STR_UI_DEFAULT_AND_SAVE), mSetupUiStringHandle);
  gStrUiSetMfgDefault = UiGetToken (STRING_TOKEN (STR_UI_SET_MFG_DEFAULT), mSetupUiStringHandle);
  ...
  )
{
  ...
  UiSafeFree(&gStrUiDefaultAndSave);    
  UiSafeFree(&gStrUiSetMfgDefault);
