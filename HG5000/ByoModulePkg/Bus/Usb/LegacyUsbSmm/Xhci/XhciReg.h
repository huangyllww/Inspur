...
#define XHC_HUB_PORTSC_BHRC                BIT21 // Hub's BH Reset Change
#define XHC_HUB_PORTSC_PLC                 BIT22 // Hub's Port Link State Change. Refer to USB 3.2 Spec Table 10-14
...
//  For more details, Please refer to USB 3.2 Spec Table 10-9.
//
typedef enum {
  Usb3PortCPortLinkStateChange = 25,
