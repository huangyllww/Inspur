...
Routine Description:
  Decodes a JFIF image into a UGA formatted image,
   and returns the decoded image, images width and images height
...
Arguments:
  ...
  DecodedData    - The decoded data, this output parameter contains 
                    ...
                    callers responsibility to free this memory buffer.
  DecodedDataSize  - The size in bytes of DecodedData
  Height           - The height of the images displaying
  Width            - The width of the images displaying 
...
Returns: 
  ...
  EFI_SUCCESS            - The markers information is retrieved sucessfully.
