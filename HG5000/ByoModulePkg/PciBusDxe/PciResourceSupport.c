...
BOOLEAN mVgaPaletteSnoopingSupport = TRUE;
  ...
  )
{
  ...
  if (!mPolicyDetermined) {
    ...
    mVgaPaletteSnoopingSupport = PcdGetBool(PcdPciVgaPaletteSnoopingSupport);
    DEBUG((EFI_D_ERROR, "mVgaPaletteSnoopingSupport:%d\n", mVgaPaletteSnoopingSupport));
