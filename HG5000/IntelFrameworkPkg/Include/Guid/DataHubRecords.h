...
//
// Misc. Onboard Device Extended - SMBIOS Type 41
//
typedef struct {
  STRING_REF                        OnBoardDeviceDescription;
  EFI_MISC_ONBOARD_DEVICE_STATUS    OnBoardDeviceStatus;
  ...
  UINT8                             BusNum;
  UINT8                             DevFuncNum;
  EFI_DEVICE_PATH_PROTOCOL          OnBoardDeviceExPath;
} EFI_MISC_ONBOARD_DEVICE_EXTENDED_DATA;

//
// OEM SMBIOS Type 131
//
typedef struct {
  UINT8                             EndOfPostFlagSet      :1;
  UINT8                             MfgPhysicalPresenceSet:1;
  UINT8                             Reserved              :6;
} EFI_MISC_OEM_TVT_FEATURE;

typedef struct {
  STRING_REF                        TVTDescription;           
  UINT8                             Version;
  EFI_MISC_OEM_TVT_FEATURE          TVTFeature1;
  UINT8                             TVTFeature2[15];
  EFI_DEVICE_PATH_PROTOCOL          Type131DevicePath;
} EFI_MISC_OEM_TYPE_131_DATA;
...
typedef EFI_MISC_ONBOARD_DEVICE_EXTENDED_DATA             EFI_MISC_ONBOARD_DEVICE_EX;
...
typedef EFI_MISC_OEM_TYPE_131_DATA                        EFI_MISC_OEM_TYPE_131;
typedef EFI_MISC_HARDWARE_SECURITY_SETTINGS_DATA          EFI_MISC_HARDWARE_SECURITY;
///
/// Inconsistent with specification here:  
/// In MemSubclass specification 0.9, the following data structures are NOT defined.
/// It is implementation-specific to simplify the code logic.
