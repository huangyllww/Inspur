...
//            {mPortPresent, mDevAddress, mDevFunction, mMaxLinkSpeed, mAspm, mAspmL1_1, mAspmL1_2, 0, mHotplug, {0, mMaxLinkCap, 0, mClkPmSupport}, {0, 0, 0}, DxioEndpointDetect}
    ...
    { //G0[0:15] - PCIE J28 Slot select 0: X16
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE16, LANE16+15, DxioHotplugDisabled, 1),
      DXIO_PORT_DATA_INITIALIZER_PCIE (
        DxioPortEnabled,                      // Port Present
        0,                                    // Requested Device
...
#else
    { //G0[0:15] - PCIE J28 Slot select 1: X8X8
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE16, LANE16+7, DxioHotplugDisabled, 1),
      DXIO_PORT_DATA_INITIALIZER_PCIE (
        DxioPortEnabled,                      // Port Present
        0,                                    // Requested Device
        0,                                    // Requested Function
    ...
    { //G0[0:15] - PCIE J28 Slot select 1: X8X8
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE16+8, LANE16+15, DxioHotplugDisabled, 1),
      DXIO_PORT_DATA_INITIALIZER_PCIE (
        DxioPortEnabled,                      // Port Present
        0,                                    // Requested Device
        0,                                    // Requested Function
    ...
    { //G0[0:15] - PCIE J28 Slot select 2: X4X4X4X4
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE16, LANE16+3, DxioHotplugDisabled, 1),
      DXIO_PORT_DATA_INITIALIZER_PCIE (
        DxioPortEnabled,                      // Port Present
        0,                                    // Requested Device
        0,                                    // Requested Function
    ...
    { //G0[0:15] - PCIE J28 Slot select 2: X4X4X4X4
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE16+4, LANE16+7, DxioHotplugDisabled, 1),
      DXIO_PORT_DATA_INITIALIZER_PCIE (
        DxioPortEnabled,                      // Port Present
        0,                                    // Requested Device
        0,                                    // Requested Function
    ...
    { //G0[0:15] - PCIE J28 Slot select 2: X4X4X4X4
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE16+8, LANE16+11, DxioHotplugDisabled, 1),
      DXIO_PORT_DATA_INITIALIZER_PCIE (
        DxioPortEnabled,                      // Port Present
        0,                                    // Requested Device
        0,                                    // Requested Function
    ...
    { //G0[0:15] - PCIE J28 Slot select 2: X4X4X4X4
      0,
      DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE16+12, LANE16+15, DxioHotplugDisabled, 1),
      DXIO_PORT_DATA_INITIALIZER_PCIE (
        DxioPortEnabled,                      // Port Present
        0,                                    // Requested Device
        0,                                    // Requested Function
    ...
    { //P1 [0:3]- MiniSAS HD0 J18
               0,
               DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 32, 35, DxioHotplugServerExpress, 1),
               DXIO_PORT_DATA_INITIALIZER_PCIE (
                 DxioPortEnabled,                      // Port Present
                 0,                                    // Requested Device
                 0,                                    // Requested Function
     ...
     { // P1 [4:7] - MiniSAS HD1 J19
               0,
               DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 36, 39, DxioHotplugServerExpress, 1),
               DXIO_PORT_DATA_INITIALIZER_PCIE (
                 DxioPortEnabled,                      // Port Present
                 0,                                    // Requested Device
                 0,                                    // Requested Function
...
#else
     { //P1[7:15] - MEZZ Slot J30_1 select 1: x4x4
       0,
     ...
     { //G1[0:15] - PCIE J24 Slot select 0: X16
        0,
        DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE48, LANE48+15, DxioHotplugDisabled, 1),
        DXIO_PORT_DATA_INITIALIZER_PCIE (
          DxioPortEnabled,                      // Port Present
          0,                                    // Requested Device
          0,                                    // Requested Function
...
#else
      { //G1[0:15] - PCIE J24 Slot select 1: X8X8
        0,
        DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE48, LANE48+7, DxioHotplugDisabled, 1),
        DXIO_PORT_DATA_INITIALIZER_PCIE (
          DxioPortEnabled,                      // Port Present
          0,                                    // Requested Device
          0,                                    // Requested Function
      ...
      { //G0G1[0:15] - PCIE J24 Slot select 1: X8X8
        0,
        DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE48+8, LANE48+15, DxioHotplugDisabled, 1),
        DXIO_PORT_DATA_INITIALIZER_PCIE (
          DxioPortEnabled,                      // Port Present
          0,                                    // Requested Device
          0,                                    // Requested Function
      ...
      { //G1[0:15] - PCIE J24 Slot select 2: X4X4X4X4
        0,
        DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE48, LANE48+3, DxioHotplugDisabled, 1),
        DXIO_PORT_DATA_INITIALIZER_PCIE (
          DxioPortEnabled,                      // Port Present
          0,                                    // Requested Device
          0,                                    // Requested Function
      ...
      { //G1[0:15] - PCIE J24 Slot select 2: X4X4X4X4
        0,
        DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE48+4, LANE48+7, DxioHotplugDisabled, 1),
        DXIO_PORT_DATA_INITIALIZER_PCIE (
          DxioPortEnabled,                      // Port Present
          0,                                    // Requested Device
          0,                                    // Requested Function
      ...
      { //G1[0:15] - PCIE J24 Slot select 2: X4X4X4X4
        0,
        DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE48+8, LANE48+11, DxioHotplugDisabled, 1),
        DXIO_PORT_DATA_INITIALIZER_PCIE (
          DxioPortEnabled,                      // Port Present
          0,                                    // Requested Device
          0,                                    // Requested Function
      ...
      { //G1[0:15] - PCIE J24 Slot select 2: X4X4X4X4
        0,
        DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE48+12, LANE48+15, DxioHotplugDisabled, 1),
        DXIO_PORT_DATA_INITIALIZER_PCIE (
          DxioPortEnabled,                      // Port Present
          0,                                    // Requested Device
          0,                                    // Requested Function
     ...
     { // G2 [0:3] - MiniSAS HD2 J16
              0,
              DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 64, 67, DxioHotplugDisabled, 1),
              DXIO_PORT_DATA_INITIALIZER_PCIE (
                           DxioPortEnabled,                      // Port Present
                           0,                                    // Requested Device
                           0,                                    // Requested Function
      ...
      { // G2 [4:7] - MiniSAS HD3 J17
               0,
               DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 68, 71, DxioHotplugDisabled, 1),
               DXIO_PORT_DATA_INITIALIZER_PCIE (
                           DxioPortEnabled,                      // Port Present
                           0,                                    // Requested Device
                           0,                                    // Requested Function
      ...
      { // G2 [12:15]- MiniSAS HD5 J15
...
#if 1
       { //P2[0:15] - PCIE J25 Slot select 0: X16
          0,
...
#else        
        { //P2[0:15] - PCIE J25 Slot select 1: X8X8
          0,
        ...
        { //P2[0:15] - PCIE J25 Slot select 2: X4X4X4X4
          0,
          DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE80, LANE80+3, DxioHotplugServerExpress, 1),
          DXIO_PORT_DATA_INITIALIZER_PCIE (
            DxioPortEnabled,                      // Port Present
            0,                                    // Requested Device
            0,                                    // Requested Function
        ...
        { //P2[0:15] - PCIE J25 Slot select 2: X4X4X4X4
          0,
          DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE80+4, LANE80+7, DxioHotplugServerExpress, 1),
          DXIO_PORT_DATA_INITIALIZER_PCIE (
            DxioPortEnabled,                      // Port Present
            0,                                    // Requested Device
            0,                                    // Requested Function
        ...
        { //P2[0:15] - PCIE J25 Slot select 2: X4X4X4X4
          0,
          DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE80+8, LANE80+11, DxioHotplugServerExpress, 1),
          DXIO_PORT_DATA_INITIALIZER_PCIE (
            DxioPortEnabled,                      // Port Present
            0,                                    // Requested Device
            0,                                    // Requested Function
        ...
        { //P2[0:15] - PCIE J25 Slot select 2: X4X4X4X4
          0,
          DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE80+12, LANE80+15, DxioHotplugServerExpress, 1),
          DXIO_PORT_DATA_INITIALIZER_PCIE (
            DxioPortEnabled,                      // Port Present
            0,                                    // Requested Device
            0,                                    // Requested Function
        ...
        { // G3 [0:3]- MiniSAS HD6 J12
              0,
              DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 96, 99, DxioHotplugServerExpress, 1),
              DXIO_PORT_DATA_INITIALIZER_PCIE (
                DxioPortEnabled,                      // Port Present
                0,                                    // Requested Device
                0,                                    // Requested Function
        ...
        { // G3 [4:7]- MiniSAS HD7 J13
              0,
              DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, 100, 103, DxioHotplugServerExpress, 1),
              DXIO_PORT_DATA_INITIALIZER_PCIE (
                DxioPortEnabled,                      // Port Present
                0,                                    // Requested Device
                0,                                    // Requested Function
...
#endif
#if 1
       { //G3[8:15] - PCIE Slot J27 select 0: x8
         0,
         DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE104, LANE104+7, DxioHotplugDisabled, 1),
         DXIO_PORT_DATA_INITIALIZER_PCIE (
           DxioPortEnabled,                      // Port Present
           0,                                    // Requested Device
           0,                                    // Requested Function
...
#else
       { //G3[8:15] - PCIE Slot J27 select 1: x4x4
         0,
         DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE104, LANE104+3, DxioHotplugDisabled, 1),
         DXIO_PORT_DATA_INITIALIZER_PCIE (
           DxioPortEnabled,                      // Port Present
           0,                                    // Requested Device
           0,                                    // Requested Function
       ...
       { //G3[8:15] - PCIE Slot J27 select 1: x4x4
         0,
         DXIO_ENGINE_DATA_INITIALIZER (DxioPcieEngine, LANE104+4, LANE104+7, DxioHotplugDisabled, 1),
         DXIO_PORT_DATA_INITIALIZER_PCIE (
           DxioPortEnabled,                      // Port Present
           0,                                    // Requested Device
           0,                                    // Requested Function
...
#endif
#if 1
       { //P3[0:15] - PCIE J26 Slot select 0: X16
...
#else
        { //P3[0:15] - PCIE J26 Slot select 1: X8X8
          0,
        ...
        { //P3[0:15] - PCIE J26 Slot select 2: X4X4X4X4
          0,
...
//
AMD_CPM_DXIO_TOPOLOGY_TABLE gCpmDxioTopologyTableHygon35N16S1 = {
//{  UINT32 TableSignature;   // Signature of CPM table
//   UINT16 TableSize;        // Table size
//   UINT8  FormatRevision;   // Revision of table format
//   UINT8  ContentRevision;  // Revision of table contect
//   UINT32 PlatformMask;     // The mask of platform table supports
//   UINT32 Attribute;        // Table attribute},
  {CPM_SIGNATURE_DXIO_TOPOLOGY_S1, sizeof (gCpmDxioTopologyTableHygon35N16S1) / sizeof (UINT8), 0, 0, 0, 0x0000000F},
  1,  // SocketId
  {   // DXIO_PORT_DESCRIPTOR
//  { UINT32  Flags;                    /**< Descriptor flags
//    #define DXIO_ENGINE_DATA_INITIALIZER(mType, mStartLane, mEndLane, mHotplug, mGpioGroupId) {mType, mHotplug, 0, mStartLane, mEndLane, mGpioGroupId, 0, 0, 0}
