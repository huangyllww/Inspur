...
#include "UsbReg.h"
 ...
 USB20_TX_EQ_INIT_TABLE USB20TxEqInitTable[]={
	...
	//        |       |      |
	{0,        0,      0,     0,      3},//Socket 0 Die 0 Port 4
	{0,        0,      1,     0,      3},//Socket 0 Die 0 Port 5
	{0,        0,      2,     0,      3},//Socket 0 Die 0 Port 6
	{0,        0,      3,     0,      3},//Socket 0 Die 0 Port 7
    //Table end	
	{0xFF,0,0,0,0}
 };
USB30_TX_EQ_INIT_TABLE USB30TxEqInitTable[]={
   ...
   //		 |		 |		|       |
   {0,		  0,	  0,	 3, 	 0x12 },//Socket 0 Die 0 Port 4
   {0,		  0,	  1,	 3, 	 0x12 },//Socket 0 Die 0 Port 5
   {0,		  0,	  2,	 3, 	 0x12 },//Socket 0 Die 0 Port 6
   {0,		  0,	  3,	 3, 	 0x12 },//Socket 0 Die 0 Port 7
   //Table end 
   {0xFF,0,0,0,0}
};
