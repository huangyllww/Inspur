...
#define USB_EHCI_HOST_MAX   4
#define USB_XHCI_HOST_MAX   4
...
typedef struct {
  ...
  UINTN                       EhciPciAddr[USB_EHCI_HOST_MAX];
  UINTN                       EhciMemBase[USB_EHCI_HOST_MAX];
  UINTN                       XhciPciAddr[USB_XHCI_HOST_MAX];
