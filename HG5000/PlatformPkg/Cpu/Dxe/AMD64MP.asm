...
TKN_LOCAL_APIC_BASE	=	0fee00000h
...
SwitchBspProgramReg proc public
        ...
        mov   esi, TKN_LOCAL_APIC_BASE + TKN_APIC_SPURIOUS_VECTOR_REGISTER
        mov   eax, [esi]
        or    eax, 0100h
        mov   [esi], eax  
        ;Set this processor's LVT LINIT[1:0]
        ;Set 350 LINT0
        mov   esi, TKN_LOCAL_APIC_BASE + TKN_APIC_LVT_LINT0_REGISTER
        mov   eax, [esi]
        and   eax, 0FFFE58FFh
        ...
        ;Set 360 LINT1
        mov   esi, TKN_LOCAL_APIC_BASE + TKN_APIC_LVT_LINT1_REGISTER
        mov   eax, [esi]
        and   eax, 0FFFE58FFh
        mov   [esi], eax      ; clear Mask bit
        or    eax, 00000400h
...
IF TKN_USE_AP_HLT
        ...
        shl   eax, 24
        push  rbx
        mov   rbx, TKN_LOCAL_APIC_BASE + TKN_APIC_ICR_HIGH_REGISTER
        mov   DWORD PTR[rbx], eax
        mov   bx, TKN_APIC_ICR_LOW_REGISTER
