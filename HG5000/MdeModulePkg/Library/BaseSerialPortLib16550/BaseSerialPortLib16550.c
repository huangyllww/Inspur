...
#ifdef BSCPKG_SUPPORT
/*<BEGIN>: Modified by John 13482, 20200330 PN:NA LABEL:BSC_HYGON_001 */
/*<DESC> : Hardware porting. */
#include "../../../BscPkg/Include/Patch/BscDebugMode.h"
#include "../../../BscPkg/Include/Patch/BscDebugMode.c"
/*<END>: Modified by John 13482, 20200330 PN:NA */
#endif
  ...
  )
{
  ...
  SerialPortWriteRegister (SerialRegisterBase, R_UART_MCR, 0x03);
  /*<BEGIN>: Modified by John 13482, 20200330 PN:NA */
#else
  SerialPortWriteRegister (SerialRegisterBase, R_UART_MCR, 0x00);
#endif
  ...
  )
{
  ...
  BOOLEAN RecordMem = FALSE;
  BSC_CHECK_DEBUG_MODE(DebugMode, RecordMem);
  if (!DebugMode)
  {
      return 0;
  }
  /*<END>: Modified by John 13482, 20200330 PN:NA LABEL:BSC_HYGON_001 */
#endif
