...
// wz190218 + >>
    case SMM_VARIABLE_FUNCTION_SYNC_NVRAM:
      Status = ReInitNonVolatileVariableStore();
      break;
// wz190218 + <<
  ...
  )
{
  ...
  REPORT_STATUS_CODE(EFI_PROGRESS_CODE, PcdGet32(PcdProgressCodeSmmVariableInit));
