...
// GPIO Init Table
//
HYGON_CPM_GPIO_INIT_TABLE  gCpmGpioInitTableNanHaiVtb3HyGx = {
  // {  UINT32 TableSignature;   // Signature of CPM table
  // UINT16 TableSize;        // Table size
  // UINT8  FormatRevision;   // Revision of table format
  ...
  // UINT32 PlatformMask;     // The mask of platform table supports
  // UINT32 Attribute;        // Table attribute},
  { HYGX_CPM_SIGNATURE_GPIO_INIT, sizeof (gCpmGpioInitTableNanHaiVtb3HyGx) / sizeof (UINT8), 0, 0, 0, 0x0000000F },
  { // Socket PhysicalDie gpio function          output            pullup
    ...
    GPIO_DEF_V3 (0, 0, 147, GPIO_FUNCTION_1, GPIO_NA, GPIO_PU_PD_DIS),                       // SFP_SCL
    GPIO_DEF_V3 (0, 0, 148, GPIO_FUNCTION_1, GPIO_NA, GPIO_PU_PD_DIS),                       // SFP_SDA
...
// GEVENT Init Table
//
HYGON_CPM_GEVENT_INIT_TABLE  gCpmGeventInitTableNanHaiVtb3HyGx = {
  // {  UINT32 TableSignature;   // Signature of CPM table
  // UINT16 TableSize;        // Table size
  // UINT8  FormatRevision;   // Revision of table format
  // UINT8  ContentRevision;  // Revision of table contect
  // UINT32 PlatformMask;     // The mask of platform table supports
  // UINT32 Attribute;        // Table attribute},
  { HYGX_CPM_SIGNATURE_GEVENT_INIT, sizeof (gCpmGeventInitTableNanHaiVtb3HyGx) / sizeof (UINT8), 0, 0, 0, 0x00000001 },
...
HYGON_CPM_GPIO_DEVICE_CONFIG_TABLE  gCpmGpioDeviceConfigTableNanHaiVtb3HyGx = {
  // {  UINT32 TableSignature;   // Signature of CPM table
  // UINT16 TableSize;        // Table size
  // UINT8  FormatRevision;   // Revision of table format
  // UINT8  ContentRevision;  // Revision of table contect
  // UINT32 PlatformMask;     // The mask of platform table supports
  // UINT32 Attribute;        // Table attribute},
  { HYGX_CPM_SIGNATURE_GPIO_DEVICE_CONFIG, sizeof (gCpmGpioDeviceConfigTableNanHaiVtb3HyGx) / sizeof (UINT8), 0, 0, 0,
    0x0000000F },
...
//
HYGON_CPM_GPIO_DEVICE_DETECTION_TABLE  gCpmGpioDeviceDetectionTableNanHaiVtb3HyGx = {
  // {  UINT32 TableSignature;   // Signature of CPM table
  // UINT16 TableSize;        // Table size
  // UINT8  FormatRevision;   // Revision of table format
  // UINT8  ContentRevision;  // Revision of table contect
  // UINT32 PlatformMask;     // The mask of platform table supports
  // UINT32 Attribute;        // Table attribute},
  { HYGX_CPM_SIGNATURE_GPIO_DEVICE_DETECTION, sizeof (gCpmGpioDeviceDetectionTableNanHaiVtb3HyGx) / sizeof (UINT8), 0, 0, 0,
    0x0000000F },
  {
...
//
HYGON_CPM_GPIO_DEVICE_RESET_TABLE  gCpmGpioDeviceResetTableNanHaiVtb3HyGx = {
  // {  UINT32 TableSignature;   // Signature of CPM table
  // UINT16 TableSize;        // Table size
  // UINT8  FormatRevision;   // Revision of table format
  // UINT8  ContentRevision;  // Revision of table contect
  // UINT32 PlatformMask;     // The mask of platform table supports
  // UINT32 Attribute;        // Table attribute},
  { HYGX_CPM_SIGNATURE_GPIO_DEVICE_RESET, sizeof (gCpmGpioDeviceResetTableNanHaiVtb3HyGx) / sizeof (UINT8), 0, 0, 0,
    0x0000000F },
  {
    // {UINT8  DeviceId;       // Device Id
...
//
HYGON_CPM_GPIO_DEVICE_POWER_TABLE  gCpmGpioDevicePowerTableNanHaiVtb3HyGx = {
  // {  UINT32 TableSignature;   // Signature of CPM table
  // UINT16 TableSize;        // Table size
  // UINT8  FormatRevision;   // Revision of table format
  // UINT8  ContentRevision;  // Revision of table contect
  // UINT32 PlatformMask;     // The mask of platform table supports
  // UINT32 Attribute;        // Table attribute},
  { HYGX_CPM_SIGNATURE_GPIO_DEVICE_POWER, sizeof (gCpmGpioDevicePowerTableNanHaiVtb3HyGx) / sizeof (UINT8), 0, 0, 0,
    0x0000000F },
  {
    // {UINT8  DeviceId;       // Device Id
...
// PCIE Clock Table
//
HYGON_CPM_PCIE_CLOCK_TABLE  gCpmPcieClockTableNanHaiVtb3HyGx = {
  // {  UINT32 TableSignature;   // Signature of CPM table
  // UINT16 TableSize;        // Table size
  // UINT8  FormatRevision;   // Revision of table format
  // UINT8  ContentRevision;  // Revision of table content
  // UINT32 PlatformMask;     // The mask of platform table supports
  // UINT32 Attribute;        // Table attribute},
  { HYGX_CPM_SIGNATURE_PCIE_CLOCK, sizeof (gCpmPcieClockTableNanHaiVtb3HyGx) / sizeof (UINT8), 0, 0, 0, 0x0F },
  {
...
//
HYGON_CPM_HSIO_TOPOLOGY_TABLE  gCpmHsioTopologyTableNanHaiVtb3S0HyGx = {
  // {  UINT32 TableSignature;   // Signature of CPM table
  // UINT16 TableSize;        // Table size
  // UINT8  FormatRevision;   // Revision of table format
  // UINT8  ContentRevision;  // Revision of table contect
  // UINT32 PlatformMask;     // The mask of platform table supports
  // UINT32 Attribute;        // Table attribute},
  { HYGX_CPM_SIGNATURE_HSIO_TOPOLOGY, sizeof (gCpmHsioTopologyTableNanHaiVtb3S0HyGx) / sizeof (UINT8), 0, 0, 0,
    0x0000000F },
  0,  // SocketId
  {   // HSIO_PORT_DESCRIPTOR
    { // P8 - 0-3 SATA port
      0,
      HSIO_ENGINE_DATA_INITIALIZER (HsioSATAEngine, 0, 3, HsioHotplugDisabled, 1),
    ...
    { // P8 4-7 x4
      0,
      HSIO_ENGINE_DATA_INITIALIZER (HsioPcieEngine, 4, 7, HsioHotplugDisabled, 1),
    ...
    { // G2 - x16 slot 144-159
      0,
      HSIO_ENGINE_DATA_INITIALIZER (HsioPcieEngine, 144, 159, HsioHotplugDisabled, 1),
      HSIO_PORT_DATA_INITIALIZER_PCIE (
        HsioPortEnabled,                      // Port Present
        0,                                    // Requested Device
        0,                                    // Requested Function
    ...
    { // G3 - x16 slot 128-143
      0,
      HSIO_ENGINE_DATA_INITIALIZER (HsioPcieEngine, 128, 143, HsioHotplugDisabled, 1),
      HSIO_PORT_DATA_INITIALIZER_PCIE (
        HsioPortEnabled,                      // Port Present
        0,                                    // Requested Device
        0,                                    // Requested Function
...
HYGON_CPM_DIMM_MAP_TABLE  gCpmDimmMapTableHyGx = {
  // {  UINT32 TableSignature;   // Signature of CPM table
  // UINT16 TableSize;        // Table size
  // UINT8  FormatRevision;   // Revision of table format
  // UINT8  ContentRevision;  // Revision of table contect
  ...
  { HYGX_CPM_SIGNATURE_DIMM_MAP, sizeof (gCpmDimmMapTableHyGx) / sizeof (UINT8), 0, 0, 0, 0x01 },
