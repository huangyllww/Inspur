...
#include <Library/DebugLib.h>                                                                      // byo231008 +
...
// This should based on Resume SEC phase design.
  ...
  ResetVectorSeg = EntryAddress + EntrySize - 0x10000;                                             // byo231008 -
  ...
  DEBUG((EFI_D_INFO, "RsmInfoLocation:%lx, EntryAddress:%lx\n", RsmInfoLocation, EntryAddress));   // byo231008 +
  ASSERT(*(UINT32*)(UINTN)(RsmInfoLocation-4) == 0x54535251);                                      // byo231008 +
