...
#ifndef _HYGON_CPM_PEI_H_
#define _HYGON_CPM_PEI_H_
...
#include CPM_PPI_DEFINITION (HygonCpmOemTablePpi)
#include CPM_PPI_DEFINITION (HygonCpmOverrideTablePpi)
#include CPM_PPI_DEFINITION (HygonCpmTablePpi)
#include CPM_PPI_DEFINITION (HygonCpmTableHobPpi)
#include CPM_PPI_DEFINITION (HygonCpmGpioInitFinishedPpi)
