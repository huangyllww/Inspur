 ...
 * @file
 *
 * HYGON CPM post code definitions
 *
 * Contains HYGON CPM Post Code Definitions
 *
...
#ifndef _HYGON_CPM_POST_CODE_H_
#define _HYGON_CPM_POST_CODE_H_
...
typedef enum {
  ...
  CpmTpErrorTableNumberOverflow     =             0x02,       ///< Table number is greater than HYGON_TABLE_LIST_ITEM_SIZE
