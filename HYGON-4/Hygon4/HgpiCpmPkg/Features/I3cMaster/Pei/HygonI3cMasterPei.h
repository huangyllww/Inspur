...
#ifndef _HYGON_I3C_MASTER_PEI_H_
#define _HYGON_I3C_MASTER_PEI_H_
...
{ 0x33df1edf, 0xfdfa, 0x4def, { 0x34, 0xfe, 0x43, 0x61, 0x75, 0x88, 0xa4, 0x2c } };
...
/// I3cSdaHold
typedef struct _I3C_SDA_HOLD {
  BOOLEAN    OverrideEn;
  UINT32     SdaHold;
} I3C_SDA_HOLD;

I3C_SDA_HOLD  I3cSdaHoldTimeList[] = {
  TRUE, 0x20202,     // I3C Bus 0, bit18:16 SDA_TX_HOLD
  TRUE, 0x20202      // I3C Bus 1
};
...
/// I3cMaster PPI Private
typedef struct _I3CMASTER_PPI_PRIVATE {
  EFI_PEI_I3C_MASTER_PPI    I3cPpi;               ///< I3cPpi;
...
} I3CMASTER_PPI_PRIVATE;

/// Private I3cMaster Data Block Structure
typedef struct _HYGON_PEI_I3C_MASTER_PRIVATE {
  I3CMASTER_PPI_PRIVATE    I3cMasterPpi[I3C_CONTROLLER_COUNT];     ///< I3c0~1 Data Block
} HYGON_PEI_I3C_MASTER_PRIVATE;
