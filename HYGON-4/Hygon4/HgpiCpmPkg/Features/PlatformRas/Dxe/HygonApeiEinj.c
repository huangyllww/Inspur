  ...
  )
{
  ...
  EinjActMemRegAddr->EinjGetErrTypeReg = EFI_ACPI_6_0_EINJ_ERROR_PROCESSOR_UNCORRECTABLE_NONFATAL| EFI_ACPI_6_0_EINJ_ERROR_PROCESSOR_UNCORRECTABLE_FATAL;    // byo231031 -
  ...
  if(!mPlatformApeiPrivate->PlatRasPolicy.ApeiEinjCpuCeDisable){                                                                                             // byo231031 +
    EinjActMemRegAddr->EinjGetErrTypeReg |= EFI_ACPI_6_0_EINJ_ERROR_PROCESSOR_CORRECTABLE;                                                                   // byo231031 +
  }                                                                                                                                                          // byo231031 +
  ...
  gBS->CopyMem (&mEinjTable.InjectionHeader.Header.OemTableId, (UINT64 *)PcdGetPtr (PcdHygonAcpiEinjTableHeaderOemTableId), sizeof (UINT64));
