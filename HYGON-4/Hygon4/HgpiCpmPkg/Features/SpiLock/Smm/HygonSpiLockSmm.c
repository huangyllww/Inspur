...
{
  PciAndThenOr32 ((LPC_BUS_DEV_FUN << 12) + FCH_LPC_REG50, ~(UINT32)BIT10, 1 << 10);
  PciAndThenOr32 ((LPC_BUS_DEV_FUN << 12) + FCH_LPC_REG54, ~(UINT32)BIT10, 1 << 10);
  PciAndThenOr32 ((LPC_BUS_DEV_FUN << 12) + FCH_LPC_REG58, ~(UINT32)BIT10, 1 << 10);
  PciAndThenOr32 ((LPC_BUS_DEV_FUN << 12) + FCH_LPC_REG5C, ~(UINT32)BIT10, 1 << 10);
  return EFI_SUCCESS;
}
