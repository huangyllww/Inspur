 ...
 * @file
 *
 * HYGON CPM Library for IO Access
 *
...
{
  HYGON_CPM_TABLE_PPI  *HygonCpmTablePpi;
  UINT32               Address;

  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  return HygonCpmTablePpi->CommonFunction.MmioRead8 (Address);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  return HygonCpmTablePpi->CommonFunction.MmioRead16 (Address);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  return HygonCpmTablePpi->CommonFunction.MmioRead32 (Address);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioWrite8 (Address, Data);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioWrite16 (Address, Data);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioWrite32 (Address, Data);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioAnd8 (Address, AndData);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioAnd16 (Address, AndData);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioAnd32 (Address, AndData);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioOr8 (Address, OrData);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioOr16 (Address, OrData);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioOr32 (Address, OrData);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioAndThenOr8 (Address, AndData, OrData);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioAndThenOr16 (Address, AndData, OrData);
}
  ...
  )
{
  ...
  HygonCpmTablePpi = This;
  Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20) + (Device << 15) + (Function << 12) + Offset;
  HygonCpmTablePpi->CommonFunction.MmioAndThenOr32 (Address, AndData, OrData);
}

/*---------------------------------------------------------------------------------------*/

/**
 * Get Multi-Die Bus Number from HYGON_CPM_CORE_TOPOLOGY_TABLE
 *
 *
 * @param[in] This    The pointer of HYGON CPM Table Ppi or Protocol
 * @param[in] Socket: Socket Number
 * @param[in] RbNumber: RootBridge Number
 *
 * @retval            Bus Number
 *
 */
  ...
  )
{
  ...
  HYGON_CPM_CORE_TOPOLOGY_LIST   *TablePtr;
  UINT8                          Bus;
  UINT32                         CpuModel;
  ...
  if (CpuModel == HYGON_EX_CPU) {
    HygonCpmCoreTopologyPtr = CommonFunctionPtr->GetTablePtr (This, HYEX_CPM_SIGNATURE_CORE_TOPOLOGY);
  } else if (CpuModel == HYGON_GX_CPU) {
    HygonCpmCoreTopologyPtr = CommonFunctionPtr->GetTablePtr (This, HYGX_CPM_SIGNATURE_CORE_TOPOLOGY);
  }

  if (HygonCpmCoreTopologyPtr) {
    TablePtr = &HygonCpmCoreTopologyPtr->CoreList[0];
  ...
  )
{
  ...
  SmnRegisterReadBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth16, &Data);
  return Data;
}
  ...
  )
{
  ...
  SmnRegisterReadBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth32, &Data);
  return Data;
}
...
{
  SmnRegisterWriteBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth16, &Data);
  return;
}
...
{
  SmnRegisterWriteBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth32, &Data);
  return;
}
...
{
  SmnRegisterRMWBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth8, AndData, 0);
  return;
}
...
{
  SmnRegisterRMWBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth16, AndData, 0);
  return;
}
...
{
  SmnRegisterRMWBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth32, AndData, 0);
  return;
}
...
{
  SmnRegisterRMWBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth8, 0xFF, OrData);
  return;
}
...
{
  SmnRegisterRMWBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth16, 0xFFFF, OrData);
  return;
}
...
{
  SmnRegisterRMWBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth32, 0xFFFFFFFF, OrData);
  return;
}
...
{
  SmnRegisterRMWBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth8, AndData, OrData);
  return;
}
...
{
  SmnRegisterRMWBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth16, AndData, OrData);
  return;
}
...
{
  SmnRegisterRMWBySocket ((UINT8)Socket, SmnAddr + Offset, AccessWidth32, AndData, OrData);
  return;
}
  ...
  )
{
  if (CpuidFamilyModelStepping) {
    *CpuidFamilyModelStepping = BaseGetRawIdOnExecutingCore ();
  }

  if (PkgType) {
    *PkgType = (UINT32)GetSocPkgType ();
  }
}
...
{
  HYGON_CPM_TABLE_PPI  *HygonCpmTablePpi = This;
  UINT32               Address;
  ...
  BridgeAddress = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Device << 15) + (Function << 12) + 0x19;
  Bus     = HygonCpmTablePpi->CommonFunction.MmioRead8 (BridgeAddress);
  BusTemp = Bus;
  Status  = 0;
  Address = 0;
  if (Bus) {
    if (Bus != 0xFF) {
      Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (Bus << 20);
      Value   = HygonCpmTablePpi->CommonFunction.MmioRead32 (Address);
    } else {
      Value = 0xFFFFFFFF;
    }
  } else {
    BusTemp = 0x1F;
    HygonCpmTablePpi->CommonFunction.MmioWrite8 (BridgeAddress, BusTemp);
    Address = HygonCpmTablePpi->MainTablePtr->PcieMemIoBaseAddr + (BusTemp << 20);
    Value   = HygonCpmTablePpi->CommonFunction.MmioRead32 (Address);
  }

  if (Value != 0xFFFFFFFF && Value != 0) {
    Status = 3;
    Offset = HygonCpmTablePpi->CommonFunction.MmioRead8 (Address + 0x34);
    while (Offset != 0 && Offset != 0xFF) {
      Value8 = HygonCpmTablePpi->CommonFunction.MmioRead8 (Address + Offset);
      if (Value8 != 0x10) {
        Offset = HygonCpmTablePpi->CommonFunction.MmioRead8 (Address + Offset + 0x01);
      } else {
        Value = HygonCpmTablePpi->CommonFunction.MmioRead32 (Address + Offset + 0x0C);
        if (Value & BIT18) {
          Value = HygonCpmTablePpi->CommonFunction.MmioRead32 (Address + Offset + 0x10);
          if (Value & BIT8) {
            Status = 1;
          } else {
            Status = 2;
  ...
  if (Bus != 0xFF) {
    HygonCpmTablePpi->CommonFunction.MmioWrite8 (BridgeAddress, Bus);
  }
  ...
  )
{
  ...
  if (DetectionTablePtr) {
    for (Index = 0; Index < HYGON_GPIO_DEVICE_DETECT_SIZE; Index++) {
  ...
  )
{
  ...
  if (CpuModel == HYGON_EX_CPU) {
    PowerTablePtr = ((HYGON_CPM_TABLE_PPI *)This)->CommonFunction.GetTablePtr (This, HYEX_CPM_SIGNATURE_GPIO_DEVICE_POWER);
  } else if (CpuModel == HYGON_GX_CPU) {
    PowerTablePtr = ((HYGON_CPM_TABLE_PPI *)This)->CommonFunction.GetTablePtr (This, HYGX_CPM_SIGNATURE_GPIO_DEVICE_POWER);
  }
  ...
  for (Index = 0; Index < HYGON_GPIO_DEVICE_POWER_SIZE; Index++) {
    ...
    if (PowerTablePtr->DevicePowerList[Index].DeviceId == DeviceId && PowerTablePtr->DevicePowerList[Index].Mode == State) {
      switch (PowerTablePtr->DevicePowerList[Index].Type) {
        case 0:
          ((HYGON_CPM_TABLE_PPI *)This)->CommonFunction.SetGpio (
                                                          This,
          ...
          break;
        case 1:
          while (((HYGON_CPM_TABLE_PPI *)This)->CommonFunction.GetGpio (This, PowerTablePtr->DevicePowerList[Index].Config.WaitGpio.Pin) !=
                 PowerTablePtr->DevicePowerList[Index].Config.WaitGpio.Value) {
          }

          break;
        case 2:
          ((HYGON_CPM_TABLE_PPI *)This)->CommonFunction.Stall (This, PowerTablePtr->DevicePowerList[Index].Config.Stall);
          break;
      }
    }
  }
  ...
  )
{
  ...
  if (CpuModel == HYGON_EX_CPU) {
    ConfigTablePtr = ((HYGON_CPM_TABLE_PPI *)This)->CommonFunction.GetTablePtr (This, HYEX_CPM_SIGNATURE_GPIO_DEVICE_CONFIG);
  } else if (CpuModel == HYGON_GX_CPU) {
    ConfigTablePtr = ((HYGON_CPM_TABLE_PPI *)This)->CommonFunction.GetTablePtr (This, HYGX_CPM_SIGNATURE_GPIO_DEVICE_CONFIG);
  }

  for (Index = 0; Index < HYGON_GPIO_DEVICE_SIZE; Index++) {
