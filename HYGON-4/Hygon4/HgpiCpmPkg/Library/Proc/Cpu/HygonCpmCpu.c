 ...
 * @file
 *
 * HYGON CPM Library for Common CPU/APU Function
 *
...
CPU_REVISION_ITEM  *CpuRevisionTable[] = {
  ...
  OPTION_CPM_CPU_REVISION_ID_SAT
  OPTION_CPM_CPU_REVISION_ID_HYGON_SAT // PS-473
  NULL
};
...
PCIE_BRIDGE_NAME  *PcieBridgeName[] = {
  ...
  OPTION_CPM_PCIE_BRIDGE_NAME_SAT
  OPTION_CPM_PCIE_BRIDGE_NAME_HYGON_SAT // PS-473
  NULL
};

UINT8  HygonCpmSsdtSupport = HYGON_CPM_SSDT_SUPPORT;
  ...
  )
{
  ...
  CommonFunctionPtr->CpuidRead (This, &Value, NULL);            // HYGON_CPUID_FMF
  Item = 0;
  ...
  )
{
  ...
  switch (CpuRevision) {
    ...
    case CPM_CPU_REVISION_ID_BR:
      ...
      break;
    case CPM_CPU_REVISION_ID_SAT:
    case CPM_CPU_REVISION_ID_HYGON_SAT:// PS-473
      break;
    default:
      if (Device == 4 && Function == 1) {
        Value = TRUE;
