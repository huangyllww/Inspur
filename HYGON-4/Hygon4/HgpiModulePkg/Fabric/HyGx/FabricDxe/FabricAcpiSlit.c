...
#define FILECODE  FABRIC_HYGX_FABRICDXE_FABRICACPISLIT_FILECODE
 ...
 *----------------------------------------------------------------------------------------
 */
STATIC HYGON_FABRIC_ACPI_SLIT_SERVICES_PROTOCOL  mFabricAcpiSlitServicesProtocol = {
  0x1,
  FabricGetSlitInfo
};
...
EFI_STATUS
EFIAPI
FabricStAcpiSlitProtocolInstall (
  ...
  )
{
  return (gBS->InstallProtocolInterface (
                 &ImageHandle,
                 &gHygonFabricAcpiSlitServicesProtocolGuid,
  ...
  )
{
  ...
  FabricNuma->GetDomainInfo (FabricNuma, &NumOfDomain, &DomainInfo, &NumOfCxlDomain, &CxlDomainInfo);
  *DomainCount = (UINT8) (NumOfDomain + NumOfCxlDomain);

  return FabricGetDistanceInfo (Distance, NumOfDomain, DomainInfo, NumOfCxlDomain, CxlDomainInfo);
}
