...
#define FILECODE  FABRIC_HYGX_FABRICPEI_HYGONFABRICSTPEI_FILECODE

EFI_STATUS
EFIAPI
FabricHyGxEndOfPeiSignalPpiCallback (
  IN  EFI_PEI_SERVICES                **PeiServices,
  IN  EFI_PEI_NOTIFY_DESCRIPTOR       *NotifyDesc,
  IN  VOID                            *InvokePpi
  );

EFI_PEI_NOTIFY_DESCRIPTOR  mFabricHyGxEndOfPeiSignalPpiCallback = {
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (CPU_TRACE, "  HygonFabricHyGxPeiInit Entry\n");
  ...
  Status = (**PeiServices).NotifyPpi (PeiServices, &mFabricHyGxEndOfPeiSignalPpiCallback);

  IDS_HDT_CONSOLE (CPU_TRACE, "  HygonFabricHyGxPeiInit End\n");
...
{
  IDS_HDT_CONSOLE_PSP_TRACE ("HygonFabricHyGxPei.EndOfPeiSignalPpiCallback\n");
