...
#define FILECODE  FABRIC_HYEX_FABRICDXE_FABRICACPIMSCT_FILECODE
  ...
  )
{
  ...
  FabricNumaServices->GetMaxDomains (FabricNumaServices, &MaxProxDomains, NULL);
  ...
  FabricNumaServices->GetDomainInfo (FabricNumaServices, &NumberOfDomainsInSystem, &DomainInfo, NULL, NULL);
