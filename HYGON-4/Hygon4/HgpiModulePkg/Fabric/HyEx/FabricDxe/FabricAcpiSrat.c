...
#define FILECODE  FABRIC_HYEX_FABRICDXE_FABRICACPISRAT_FILECODE
  ...
  )
{
  ...
  for (DramMapIndex = 0; DramMapIndex < NUMBER_OF_DRAM_REGIONS; DramMapIndex++) {
    ...
    if (DramBaseAddr.Field.AddrRngVal == 1) {
      ...
      FabricTopologyGetLocationFromFabricId (DramLimitAddr.HyExField.DstFabricID, &SocketId, &LogicalDieId, NULL);
      ...
      MemoryLength = LShiftU64 (((UINT64)(DramLimitAddr.HyExField.DramLimitAddr + 1 - DramBaseAddr.Field.DramBaseAddr)), 28);
      ...
      if (DramBaseAddr.Field.LgcyMmioHoleEn == 1) {
        ...
        MemoryLength = LShiftU64 (((UINT64)(DramLimitAddr.HyExField.DramLimitAddr + 1 - 0x10)), 28);
      }
