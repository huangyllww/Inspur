...
#define FILECODE  FABRIC_HYEX_FABRICPEI_FABRICPIERASINIT_FILECODE
 ...
 *----------------------------------------------------------------------------------------
 */
CONST UINTN ROMDATA IodDfGlblCtrlInstanceIdsHyEx[] = {
  IOMS0_INSTANCE_ID,
  IOMS1_INSTANCE_ID,
  IOMS2_INSTANCE_ID,
  IOMS3_INSTANCE_ID,
  ...
  CAKE4_INSTANCE_ID,
  CAKE5_INSTANCE_ID,
  CAKE6_INSTANCE_ID_HYEX,
  CAKE7_INSTANCE_ID_HYEX,
  CAKE8_INSTANCE_ID_HYEX,
  CAKE9_INSTANCE_ID_HYEX,
  CAKE10_INSTANCE_ID_HYEX,
  CAKE11_INSTANCE_ID_HYEX,
  CAKE12_INSTANCE_ID_HYEX,
  CAKE13_INSTANCE_ID_HYEX
};

CONST UINTN ROMDATA CddDfGlblCtrlInstanceIdsHyEx[] = {
  CS0_INSTANCE_ID,
  CS1_INSTANCE_ID,
  CCM0_INSTANCE_ID,
  CCM1_INSTANCE_ID,
  ...
  )
{
  ...
  for (i = 0; i < FabricTopologyGetNumberOfSocketPresent (); i++) {
    for (j = 0; j < FabricTopologyGetNumberOfLogicalDiesOnSocket (i); j++) {
      ...
      for (k = 0; k < (sizeof (IodDfGlblCtrlInstanceIdsHyEx) / sizeof (IodDfGlblCtrlInstanceIdsHyEx[0])); k++) {
        DfGlblCtrl.Value = FabricRegisterAccRead (i, j, DF_GLBL_CTRL_FUNC, DF_GLBL_CTRL_REG, IodDfGlblCtrlInstanceIdsHyEx[k]);
        if (WdtCfgRequest <= 3) {
        ...
        DfGlblCtrl.Field.DisImmSyncFloodOnFatalErr = 1;  //disable syncflood 
        ...
        FabricRegisterAccWrite (
          ...
          DF_GLBL_CTRL_FUNC,
          DF_GLBL_CTRL_REG,
          IodDfGlblCtrlInstanceIdsHyEx[k],
          DfGlblCtrl.Value,
          FALSE
          );
      }
