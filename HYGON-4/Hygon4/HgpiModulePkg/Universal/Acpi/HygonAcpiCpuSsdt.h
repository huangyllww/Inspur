 ...
 * Generate SSDT.
 *
 * Contains implementation of the interfaces: Generate SSDT in HygonAcpiCpuSsdt.h. *
 *
...
#ifndef _HYGON_ACPI_CPU_SSDT_H_
#define _HYGON_ACPI_CPU_SSDT_H_
