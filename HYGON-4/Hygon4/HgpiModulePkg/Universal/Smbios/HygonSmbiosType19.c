...
#define FILECODE  UNIVERSAL_SMBIOS_HYGONSMBIOSTYPE19_FILECODE
  ...
  )
{
  ...
  HYGON_SMBIOS_TABLE_TYPE19  *SmbiosTableType19;
  ...
  StructureSize     = sizeof (HYGON_SMBIOS_TABLE_TYPE19);
  ...
  SmbiosTableType19->Hdr.Handle = HYGON_SMBIOS_HANDLE_PI_RESERVED;
  SmbiosTableType19->Hdr.Type   = HYGON_EFI_SMBIOS_TYPE_MEMORY_ARRAY_MAPPED_ADDRESS;
