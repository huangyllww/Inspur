...
#define FILECODE  CCX_DHARMA_CCXDHARMADXE_CCXDHARMACPB_FILECODE
  ...
  )
{
  ...
  CpbMode = PcdGet8 (PcdHygonCpbMode);

  if (CpbMode == 0) {
    IDS_HDT_CONSOLE (CPU_TRACE, "  CcxDharmaInitializeCpb - Disable CPB\n");
