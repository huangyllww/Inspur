...
#ifndef _IDS_NV_DEF_SAT_H_
#define _IDS_NV_DEF_SAT_H_
...
/// CSV VMs using ASIDs below the CSV-ES ASID Space Limit must enable the CSV-ES feature. The valid values for this field are from 0x1 (1) - 0x10 (16).
#define IDSOPT_CMN_CPU_CSV_ASID_SPACE_LIMIT_MIN  1 ///< Min of CSV-ES ASID Space Limit
#define IDSOPT_CMN_CPU_CSV_ASID_SPACE_LIMIT_MAX  16 ///< Max of CSV-ES ASID Space Limit
...
/// Enables or disables the Core Watchdog functionality
typedef enum {
  IDSOPT_CMN_CORE_WATCHDOG_CTRL_DISABLED = 0,///< Disabled
  IDSOPT_CMN_CORE_WATCHDOG_CTRL_ENABLED  = 1,///< Enabled
  IDSOPT_CMN_CORE_WATCHDOG_CTRL_AUTO     = 3,///< Auto
} IDSOPT_CMN_CORE_WATCHDOG_CTRL;
...
typedef enum {
  IDSOPT_DF_CMN_HMI_ENCRYPTION_DISABLED = 0,///< Disabled
  IDSOPT_DF_CMN_HMI_ENCRYPTION_ENABLED  = 1,///< Enabled
  IDSOPT_DF_CMN_HMI_ENCRYPTION_AUTO     = 3,///< Auto
} IDSOPT_DF_CMN_HMI_ENCRYPTION;

/// xHMI encryption control
/// Control xHMI link encryption
typedef enum {
  IDSOPT_DF_CMN_X_HMI_ENCRYPTION_DISABLED = 0,///< Disabled
  IDSOPT_DF_CMN_X_HMI_ENCRYPTION_ENABLED  = 1,///< Enabled
  IDSOPT_DF_CMN_X_HMI_ENCRYPTION_AUTO     = 3,///< Auto
} IDSOPT_DF_CMN_X_HMI_ENCRYPTION;
...
typedef enum {
  ...
  IDSOPT_CMN_MEM_TIMING_TWTR_L_DDR4_0DHCLK = 267,///< 0Dh Clk
...
// TDP Boost
typedef enum {
  IDSOPT_CMN_TDP_BOOST_DISABLED = 0,///< Disabled
  IDSOPT_CMN_TDP_BOOST_ENABLED  = 1,///< Enabled
  IDSOPT_CMN_TDP_BOOST_AUTO     = 0xF,///< Auto
} IDSOPT_CMN_TDP_BOOST;
...
/// I3C 0 Enable
typedef enum {
  IDSOPT_CMN_FCH_I3_C0_CONFIG_DISABLED = 0,///< Disabled
  IDSOPT_CMN_FCH_I3_C0_CONFIG_ENABLED  = 1,///< Enabled
  IDSOPT_CMN_FCH_I3_C0_CONFIG_AUTO     = 0xf,///< AUTO
} IDSOPT_CMN_FCH_I3_C0_CONFIG;

/// I3C 1 Enable
typedef enum {
  IDSOPT_CMN_FCH_I3_C1_CONFIG_DISABLED = 0,///< Disabled
  IDSOPT_CMN_FCH_I3_C1_CONFIG_ENABLED  = 1,///< Enabled
