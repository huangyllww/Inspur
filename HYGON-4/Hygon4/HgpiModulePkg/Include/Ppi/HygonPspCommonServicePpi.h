...
#ifndef _HYGON_PSP_COMMONSERVICE_PPI_H_
#define _HYGON_PSP_COMMONSERVICE_PPI_H_
...
/// PPI prototype
///
/// Defines HYGON_PSP_COMMON_SERVICE_PPI, which public the common PSP service across all programs
///
typedef struct _HYGON_PSP_COMMON_SERVICE_PPI {
...
} HYGON_PSP_COMMON_SERVICE_PPI;

extern EFI_GUID  gHygonPspCommonServicePpiGuid;

#endif //_HYGON_PSP_COMMONSERVICE_PPI_H_
