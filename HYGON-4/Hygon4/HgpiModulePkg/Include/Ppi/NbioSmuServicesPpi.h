...
#ifndef _HYGON_NBIO_SMU_SERVICES_PPI_H_
#define _HYGON_NBIO_SMU_SERVICES_PPI_H_

// Current PPI revision
#define HYGON_NBIO_SMU_SERVICES_REVISION  0x00

typedef struct _PEI_HYGON_NBIO_SMU_SERVICES_PPI PEI_HYGON_NBIO_SMU_SERVICES_PPI;
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_READ_FUSE_BY_NAME)(
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_READ_FUSE_BY_NUMBER)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         InstanceId,
  IN  UINT32                         FuseChain,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_SMU_SERVICE_REQUEST)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         SocketId,
...
/**
* Executes a specific HSIO service and returns the results
* (Generally intended for NBIO internal requests)
  ...
  PhysicalDieId
    The unique identifier of this Physical Die
  ServiceRequest
    The HSIO service request identifier
  InputParameters
    Pointer to an array of service request arguments (for CZ, UINT32[6]).  Input parameters are not validated by the driver prior to issuing the service request.
  ReturnValues
    Pointer to an array of service request response values (for CZ, UINT32[6])
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_HSIO_SERVICE_REQUEST)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         SocketId,
  IN  UINT32                         PhysicalDieId,
  IN  UINT32                         ServiceRequest,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_SMU_REGISTER_READ)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         InstanceId,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_SMU_REGISTER_WRITE)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         InstanceId,
  IN  UINT32                         RegisterIndex,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_SMU_REGISTER_RMW)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         InstanceId,
  IN  UINT32                         RegisterIndex,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_HTC_CONTROL)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         InstanceId,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_READ_CAC_WEIGHTS)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         InstanceId,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_PSI_CONTROL)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         InstanceId,
  IN  UINT32                         TargetVid,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_GET_TDP_VALUE)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         InstanceId,
  OUT UINT32                         *TdpValue
  );
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_READ_BRAND_STRING)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         InstanceId,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_READ_CORE_PLL_LOCK_TIMER)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT32                         InstanceId,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_SET_DOWNCORE_REGISTER)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMU_SERVICES_SET_SMT)(
  IN  PEI_HYGON_NBIO_SMU_SERVICES_PPI  *This,
  IN  UINT8                          SmtMode
  );
...
///
struct _PEI_HYGON_NBIO_SMU_SERVICES_PPI {
  UINT32                                         Revision;              ///< revision
  HYGON_SMU_SERVICES_READ_FUSE_BY_NAME           SmuReadFuseByName;     ///<
  HYGON_SMU_SERVICES_READ_FUSE_BY_NUMBER         SmuReadFuseByLocation; ///<
  HYGON_SMU_SERVICES_SMU_SERVICE_REQUEST         SmuServiceRequest;     ///<
  HYGON_SMU_SERVICES_HSIO_SERVICE_REQUEST        SmuHsioServiceRequest; ///<
  HYGON_SMU_SERVICES_SMU_REGISTER_READ           SmuRegisterRead;       ///<
  HYGON_SMU_SERVICES_SMU_REGISTER_WRITE          SmuRegisterWrite;      ///<
  HYGON_SMU_SERVICES_SMU_REGISTER_RMW            SmuRegisterRMW;        ///<
  HYGON_SMU_SERVICES_HTC_CONTROL                 SmuHtcControl;         ///<
  HYGON_SMU_SERVICES_READ_CAC_WEIGHTS            SmuReadCacWeights;     ///<
  HYGON_SMU_SERVICES_PSI_CONTROL                 SmuPsiControl;         ///<
  HYGON_SMU_SERVICES_GET_TDP_VALUE               SmuGetTdpValue;        ///<
  HYGON_SMU_SERVICES_READ_BRAND_STRING           SmuReadBrandString;    ///<
  HYGON_SMU_SERVICES_READ_CORE_PLL_LOCK_TIMER    SmuReadCorePllLockTimer; ///<
  HYGON_SMU_SERVICES_SET_DOWNCORE_REGISTER       SmuSetDownCoreRegister; ///<
  HYGON_SMU_SERVICES_SET_SMT                     SmuSetSmt;              ///<
};

extern EFI_GUID  gHygonNbioSmuServicesPpiGuid;
