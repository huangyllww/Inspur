...
typedef
EFI_STATUS
(EFIAPI *HYGON_PEI_SOC_LOGICAL_ID_GET_LOGICAL_ID_ON_CURRENT_CORE)(
...
typedef
EFI_STATUS
(EFIAPI *HYGON_PEI_SOC_LOGICAL_ID_GET_LOGICAL_ID_ON_GIVEN_SOCKET)(
  IN    UINTN                                               Socket,
  OUT   SOC_LOGICAL_ID                                      *LogicalId
  );
...
/// processors.
///
typedef struct _HYGON_PEI_SOC_LOGICAL_ID_PPI {
  UINTN                                                      Revision;                  ///< Revision Number
  HYGON_PEI_SOC_LOGICAL_ID_GET_LOGICAL_ID_ON_CURRENT_CORE    GetLogicalIdOnCurrentCore; ///< Get logical revision of the executing core
  HYGON_PEI_SOC_LOGICAL_ID_GET_LOGICAL_ID_ON_GIVEN_SOCKET    GetLogicalIdOnGivenSocket; ///< Get logical revision of the given socket
} HYGON_PEI_SOC_LOGICAL_ID_PPI;

extern EFI_GUID  gHygonSocLogicalIdPpiGuid;
