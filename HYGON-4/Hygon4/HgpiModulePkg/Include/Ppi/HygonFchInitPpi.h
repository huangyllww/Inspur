...
* @file
*
* HYGON FCH INIT API, and related functions.
*
...
#ifndef _HYGON_FCH_INIT_PPI_H_
#define _HYGON_FCH_INIT_PPI_H_

extern EFI_GUID  gHygonFchInitPpiGuid;

typedef struct _HYGON_FCH_INIT_PPI HYGON_FCH_INIT_PPI;
...
typedef struct _HYGON_FCH_INIT_PPI {
...
//
#define HYGON_FCH_INIT_PPI_REV  0x01

#endif // _HYGON_FCH_INIT_PPI_H_
