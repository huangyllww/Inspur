...
#ifndef _HYGON_S3_SAVE_LIB_H_
#define _HYGON_S3_SAVE_LIB_H_
/// HygonS3<Func> will set register and save to S3 Script
/// HygonS3SaveScript<Func> will save to S3 Script Only
HGPI_STATUS
HygonS3IoWrite (
