...
#ifndef _HYGON_IDS_DEBUGPRINT_LIB_H_
#define _HYGON_IDS_DEBUGPRINT_LIB_H_
#define HYGON_IDS_DP_FLAG_ALL  0xFFFFFFFFFFFFFFFFull
/// HDTOUT Header.
...
#endif //_HYGON_IDS_DEBUGPRINT_LIB_H_
