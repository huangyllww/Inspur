 ...
 *
 *
 * HYGON Register Table Related Functions
 *
...
#ifndef _HYGON_TABLE_LIB_H_
#define _HYGON_TABLE_LIB_H_
#include "HGPI.h"
#include "Uefi.h"
#include "HYGON.h"
 ...
 */
typedef enum {
  HygonRegisterTableTpBeforeApLaunch,         ///< Cpu code just prior to launching APs.
  HygonRegisterTableTpAfterApLaunch,          ///< Cpu code just after all APs have been launched.
  HygonRegisterTableTpBeforeApLaunchSecureS3, ///< Cpu code just prior to launching APs for secure S3
  HygonRegisterTableTpAfterApLaunchSecureS3,  ///< Cpu code just after all APs have been launched for secure S3
  MaxHygonRegisterTableTps                    ///< Not a valid time point, use for limit checking.
...
//
// ----------------------------------------------------------------------------
#define SMN_ON_ALL_SOCKETS  0xFF
...
#define HYGON_PF_DHM1    BIT0
#define HYGON_PF_DM1     BIT1
#define HYGON_PF_X2APIC  BIT2
#define HYGON_PF_APIC    BIT3

// Not a platform type, but treat all others as AND
#define HYGON_PF_AND  BIT31

#define HYGON_PF_ALL  (HYGON_PF_DHM1 | HYGON_PF_DM1 | HYGON_PF_X2APIC | HYGON_PF_APIC)
// Do not include HYGON_PF_AND in HYGON_PF_ALL !
 ...
 */
typedef struct {
  UINT32    PlatformDhm1     : 1;             ///< BIT_0 DHM1 package
  UINT32    PlatformDm1      : 1;             ///< BIT_1 DM1 package
  UINT32    PlatformX2Apic   : 1;             ///< BIT_2 x2APIC mode desired
  UINT32    PlatformApic     : 1;             ///< BIT_3 APIC mode desired
  UINT32                     : (31 - 4);      ///< The possibilities are (not quite) endless.
...
#define MAKE_SOC_LOGICAL_ID(Family, Revision)  BSU32 (Family), BSU32 (Revision)
