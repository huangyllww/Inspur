...
#define HDA_WAKE_ENABLE                       0xc
#define HDA_IMM_COMMAND_OUTPUT_INTERFACE      0x60
#define HDA_IMM_RESPONSE_INPUT_INTERFACE      0x64
#define HDA_IMM_COMMAND_STATUS                0x68
#define HDA_REGBANK_CHECK                     0x190
