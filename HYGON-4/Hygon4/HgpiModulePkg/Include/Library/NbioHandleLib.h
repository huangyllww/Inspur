...
NbioGetHostPciAddress (
  ...
  #define PcieConfigGetNextTopologyDescriptor(Descriptor, Termination) \
    (Descriptor != NULL ? (((((PCIe_DESCRIPTOR_HEADER *)Descriptor)->DescriptorFlags & Termination) != 0) ? \
                           NULL : ((UINT8 *)Descriptor + ((PCIe_DESCRIPTOR_HEADER *)Descriptor)->Peer)) : NULL)
#endif
...
#define GnbGetDieNumber(Handle)  (Handle != NULL ? (Handle)->PhysicalDieId : NULL)
#define GnbGetRBIndex(Handle)    (Handle != NULL ? (Handle)->RbId : NULL)
