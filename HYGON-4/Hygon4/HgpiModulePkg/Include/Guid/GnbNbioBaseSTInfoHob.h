 ...
 * @file
 *
 * Gnb Nbio Base ST Hob GUID definition
 *
 *
...
#ifndef _GNB_NBIO_BASE_ST_HOB_INFO_H_
#define _GNB_NBIO_BASE_ST_HOB_INFO_H_

#define _GNB_NBIO_BASE_ST_HOB_INFO_GUID \
  { \
    0xce3e2c94, 0x82e2, 0x4429, 0xba, 0x69, 0xcc, 0xf6, 0xb9, 0xba, 0x1, 0x4c \
  }
extern EFI_GUID  gGnbNbioBaseSTHobInfoGuid;
...
typedef union {
  ...
  UINT32    Value;                                                      ///<
} SMU_SERVICE_ENABLEMENT_BITMAP_ST_HOB;

/// The Build time options configuration for ST-specific options
typedef struct _GNB_BUILD_OPTIONS_ST_DATA_HOB {
  EFI_HOB_GUID_TYPE                       EfiHobGuidType;                          ///< GUID Hob type structure
  SMU_SERVICE_ENABLEMENT_BITMAP_ST_HOB    CfgSMUServiceEnablementBitMap;           ///< Bit map for SMU service enablement (1 means the service is enabled)
  ...
  UINT16                                  CfgNTBBAR1Size;                          ///< NTB Bar1 size
  UINT16                                  CfgNTBBAR23Size;                         ///< NTB Bar23 size
  UINT16                                  CfgNTBBAR45Size;                         ///< NTB Bar45 size
  BOOLEAN                                 CfgX2APICSupport;                        ///< X2APIC Support Status
  GNB_BUILD_OPTIONS_COMMON_HOB            GnbCommonOptions;                        ///< GNB Options for multi-family libraries
} GNB_BUILD_OPTIONS_ST_DATA_HOB;
