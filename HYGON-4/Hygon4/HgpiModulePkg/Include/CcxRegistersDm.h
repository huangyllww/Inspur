...
#ifndef _CCX_REGISTERS_DHARMA_H_
#define _CCX_REGISTERS_DHARMA_H_
#pragma pack (push, 1)
...
#define PS_MAX_REG   MSR_PSTATE_2    /* Maximum P-State Register */
...
#define MSR_PSTATE_DEF  0xC0010064ul
...
typedef union {
  struct {
    ///< Bitfields of CPU Watchdog Timer MSR Register
...
typedef union {
  struct {
    ...
    UINT64    RAMPSPINE_TMRLEN : 3;    ///< Control the CC1 exit/entry RampSpine length
    UINT64                     : 8;    ///< Reserved
...
#define MSR_MCA_INTR_CFG  0xC0000410ul
/* MCA MISC0 Register 0xC0002xx3 */
#define MSR_MCA_MISC0_BANK0  0xC0002003ul
/* MCA MISC1 Register 0xC0002xxA */
#define MSR_MCA_MISC1_BANK0  0xC000200Aul
...
#pragma pack (pop)
#endif // _CCX_REGISTERS_DHARMA_H_
