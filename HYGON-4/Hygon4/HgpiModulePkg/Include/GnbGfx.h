...
// common eDP->LVDS translator chip without HYGON SW init
#define eDP_TO_LVDS_COMMON_ID  0x01
// Third party translator which requires HYGON SW init
...
typedef struct {
  UINT32    HygonPcieGfxCardBitmap;               ///< HYGON PCIE graphics card information
...
typedef struct {
  ...
  UINT32                      HygonPlatformType;        ///< Platform type
...
typedef  struct _ATOM_EXTERNAL_DISPLAY_CONNECTION_INFO {
  ...
  UCHAR                       uceDPToLVDSRxId;       ///< 3rd party eDP to LVDS translator chip presented. 0:no, 1:chip without HYGON SW init, 2:Third party translator which require HYGON SW init
