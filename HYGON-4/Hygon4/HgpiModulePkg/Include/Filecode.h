...
#define LIBRARY_HYGONBASELIB_HYGONBASELIB_FILECODE                 (0x0001)
#define LIBRARY_HYGONTABLELIB_HYGONTABLELIB_FILECODE               (0x0002)
#define LIBRARY_HYGONTABLELIB_PEI_HYGONTABLESMNPEILIB_FILECODE     (0x0003)
#define LIBRARY_HYGONTABLELIB_DXE_HYGONTABLESMNDXELIB_FILECODE     (0x0004)
#define LIBRARY_HYGONTABLELIB_NULL_HYGONTABLESMNNULLLIB_FILECODE   (0x0005)
#define LIBRARY_HYGONHEAPPEILIB_HYGONHEAPPEILIB_FILECODE           (0x0006)
#define LIBRARY_HYGONHEAPDXELIB_HYGONHEAPDXELIB_FILECODE           (0x0007)
#define LIBRARY_HYGONS3SAVELIB_WOS3SAVE_HYGONWOS3SAVELIB_FILECODE  (0x0008)
#define LIBRARY_HYGONS3SAVELIB_S3SAVE_HYGONS3SAVELIB_FILECODE      (0x0009)
...
#define MEM_HYGONMEMCSATEI_HYGONMEMCSATEI_FILECODE    (0x1001)
#define MEM_HYGONMEMFEATPEI_HYGONMEMFEATPEI_FILECODE  (0x1002)
#define MEM_HYGONMEMS3CZDXE_HYGONMEMS3CZDXE_FILECODE  (0x1003)

#define MEM_HYGONMEMHyExDXE_HYGONMEMHyExDXE_FILECODE                  (0x1005)
#define MEM_HYGONMEMHyExPEI_HYGONMEMHyExPEI_FILECODE                  (0x1006)
#define MEM_HYGONMEMDDR4PEI_HYGONMEMDDR4PEI_FILECODE                (0x1007)
#define MEM_HYGONMEMFP4PEI_HYGONMEMFP4PEI_FILECODE                  (0x1008)
#define MEM_HYGONMEMPEI_HYGONMEMPEI_FILECODE                        (0x1009)
#define MEM_HYGONMEMSMPEI_HYGONMEMSMPEI_FILECODE                    (0x100A)
#define MEM_HYGONMEMSMBIOSPEI_MEMSMBIOSPEI_FILECODE                 (0x100C)
#define MEM_HYGONMEMCHANXLATHyExPEI_MEMCHANXLATHyExPEI_FILECODE       (0x100D)
#define MEM_HYGONMEMSMBIOSDXE_HYGONMEMSMBIOSDXE_FILECODE            (0x100F)
#define MEM_HYGONMBISTPEI_HYGONMBISTPEI_FILECODE                    (0x1010)
#define MEM_HYGONMEMPPRSMMDRIVER_MEM_HYGONMEMPPRSMMDRIVER_FILECODE  (0x1011)
#define MEM_HYGONMEMPEI_HGPIPEI_FILECODE                            (0x1012)

#define MEM_HYGONMEMHyGxPEI_HYGONMEMHyGxPEI_FILECODE                  (0x1020)
#define MEM_HYGONMEMCHANXLATHyGxPEI_MEMCHANXLATHyGxPEI_FILECODE       (0x1021)

// Psp
#define PSP_HYGONPSPSMM_HYGONPSPSMM_FILECODE  (0x2003)
// 0x2020 ~ 0x202F for PSP drivers
#define PSP_HYGONPSPPEI_HYGONPSPPEI_FILECODE                  (0x2020)
#define PSP_HYGONPSPDXE_HYGONPSPDXE_FILECODE                  (0x2021)
#define PSP_HYGONPSPP2CMBOX_HYGONPSPP2CMBOX_FILECODE          (0x2022)
#define PSP_HYGONPSPSMMV2_HYGONPSPSMMV2_FILECODE              (0x2023)
#define PSP_HYGONPSPP2CMBOX_HYGONPSPFLASHACCSMMHDLR_FILECODE  (0x2024)
#define PSP_HYGONPSPDXE_HYGONFLASHACCDXE_FILECODE             (0x2025)
#define PSP_HYGONPSPP2CMBOX_HYGONPSPP2CMBOXCMD_FILECODE       (0x2026)
#define PSP_HYGONPSPSMM_HYGONPSPRESUMEHANDLING_FILECODE       (0x2027)
#define PSP_HYGONPSPSMM_HYGONPSPRESUMESERVICES_FILECODE       (0x2028)
// 0x2030 ~ 0x203F for PSP Libs
#define LIBRARY_HYGONPSPBASELIB_HYGONPSPBASELIB_FILECODE  (0x2030)
#define LIBRARY_HYGONPSPMBOXLIB_HYGONPSPMBOXLIB_FILECODE  (0x2031)
#define LIBRARY_HYGONPSPHPOBLIB_HYGONPSPHPOBLIB_FILECODE  (0x2032)
// 0x2040 ~ 0x204F for PSP common Libs
#define LIBRARY_HYGONPSPCOMMONLIBPEI_HYGONPSPCOMMONLIBPEI_FILECODE        (0x2040)
#define LIBRARY_HYGONPSPCOMMONLIBDXE_HYGONPSPCOMMONLIBDXE_FILECODE        (0x2041)
#define LIBRARY_HYGONPSPFLASHACCLIBDXE_HYGONPSPFLASHACCLIBDXE_FILECODE    (0x2043)
#define LIBRARY_HYGONPSPFLASHUPDATELIB_HYGONPSPFLASHUPDATELIB_FILECODE    (0x2044)
#define LIBRARY_HYGONPSPFLASHACCLIBNULL_HYGONPSPFLASHACCLIBNULL_FILECODE  (0x2045)

// 0x2080~0x20FF for IDS
#define LIBRARY_HYGONIDSHOOKLIB_HYGONIDSHOOKLIB_FILECODE              (0x2080)
#define LIBRARY_HYGONIDSDEBUGPRINTLIB_HYGONIDSDEBUGPRINTLIB_FILECODE  (0x2081)
#define DEBUG_HYGONIDSDEBUGPRINTDXE_HYGONIDSDEBUGPRINTDXE_FILECODE    (0x2082)
#define DEBUG_HYGONIDSDEBUGPRINTPEI_HYGONIDSDEBUGPRINTPEI_FILECODE    (0x2083)
#define LIBRARY_HYGONIDSDEBUGPRINTLIB_HYGONIDSDPHDTOUTLIB_FILECODE    (0x2084)
#define LIBRARY_HYGONIDSDEBUGPRINTLIB_HYGONIDSDPRAM_FILECODE          (0x2085)
#define LIBRARY_HYGONIDSDEBUGPRINTLIB_HYGONIDSDPREDIRECTIO_FILECODE   (0x2086)
#define LIBRARY_HYGONIDSDEBUGPRINTLIB_HYGONIDSDPSERIAL_FILECODE       (0x2087)
...
#define LIBRARY_HYGONIDSHOOKLIBNULL_HYGONIDSHOOKLIBNULL_FILECODE      (0x208C)
#define LIBRARY_HYGONIDSEXTLIBNULL_HYGONIDSHOOKEXTLIBNULL_FILECODE    (0x208D)
...
#define LIBRARY_CCXRESETTABLESDMLIB_CCXRESETTABLESDMLIB_FILECODE                    (0x3006)
#define CCX_DHARMA_CCXDHARMASATPEI_CCXDHARMASATCACHEINIT_FILECODE                   (0x3007)
#define CCX_DHARMA_CCXDHARMASATDXE_HYGONCCXDHARMASATDXE_FILECODE                    (0x3008)
#define CCX_DHARMA_CCXDHARMASATPEI_HYGONCCXDHARMASATPEI_FILECODE                    (0x3009)
#define CCX_DHARMA_CCXDHARMASATDXE_CCXDHARMASATMICROCODEPATCH_FILECODE              (0x300A)
#define LIBRARY_CCXDHARMASATIDSHOOKLIB_DXE_CCXDHARMASATIDSHOOKLIBDXE_FILECODE       (0x300B)
#define LIBRARY_CCXDHARMASATIDSHOOKLIB_DXE_CCXDHARMASATIDSCUSTOMPSTATES_FILECODE    (0x300C)
#define LIBRARY_CCXDHARMASATIDSHOOKLIB_PEI_CCXDHARMASATIDSHOOKLIBPEI_FILECODE       (0x300D)
#define LIBRARY_CCXPSTATESDHARMASATLIB_CCXPSTATESDHARMASATLIB_FILECODE              (0x300E)
#define CCX_DHARMA_CCXDHARMASATDXE_CCXDHARMASATACPISERVICESDXE_FILECODE             (0x300F)
#define CCX_DHARMA_CCXDHARMASATDXE_CCXDHARMASATC6_FILECODE                          (0x3010)
#define CCX_DHARMA_CCXDHARMASATDXE_CCXDHARMASATCPB_FILECODE                         (0x3011)
#define CCX_DHARMA_CCXDHARMASATDXE_CCXDHARMASATPREFETCH_FILECODE                    (0x3012)
#define CCX_DHARMA_CCXDHARMASATDXE_CCXDHARMASATSMBIOSDXE_FILECODE                   (0x3013)
#define CCX_DHARMA_CCXDHARMASATPEI_CCXDHARMASATDOWNCOREINIT_FILECODE                (0x3014)
#define LIBRARY_CCXSMBIOSDHARMASATLIB_CCXSMBIOSDHARMASATLIB_FILECODE                (0x3015)
#define LIBRARY_CCXSMBIOSDHARMASATLIB_CCXSMBIOSDHARMASATCOMMONLIB_FILECODE          (0x3016)
#define CCX_DHARMA_CCXDHARMASATPEI_CCXDHARMASATBRANDSTRING_FILECODE                 (0x3017)
#define CCX_DHARMA_CCXDHARMASATSMM_HYGONCCXDHARMASATSMM_FILECODE                    (0x3018)
#define LIBRARY_CCXDHARMASATIDSHOOKLIB_SMM_CCXDHARMASATIDSHOOKLIBSMM_FILECODE       (0x3019)
#define LIBRARY_CCXPSPLIB_CCXPSPLIB_FILECODE                                        (0x301A)
#define LIBRARY_CCXDHARMASATIDSHOOKLIB_SMM_CCXDHARMASATIDSSYNCMSRSMM_FILECODE       (0x301B)
...
#define LIBRARY_CCXDHARMARVIDSHOOKLIB_DXE_CCXDHARMARVIDSHOOKLIBDXE_FILECODE         (0x301E)
#define LIBRARY_CCXDHARMARVIDSHOOKLIB_DXE_CCXDHARMARVIDSCUSTOMPSTATES_FILECODE      (0x301F)
#define LIBRARY_CCXDHARMARVIDSHOOKLIB_PEI_CCXDHARMARVIDSHOOKLIBPEI_FILECODE         (0x3020)
#define LIBRARY_CCXDHARMARVIDSHOOKLIB_SMM_CCXDHARMARVIDSSYNCMSRSMM_FILECODE         (0x3021)
#define LIBRARY_CCXDHARMARVIDSHOOKLIB_SMM_CCXDHARMARVIDSHOOKLIBSMM_FILECODE         (0x3022)
#define LIBRARY_CCXSETMCASATLIB_CCXSETMCASATLIB_FILECODE                            (0x3023)
#define CCX_DHARMA_CCXDHARMASATDXE_CCXDHARMASATACPIRAS_FILECODE                     (0x3024)
#define LIBRARY_CCXIDSCUSTOMPSTATESDHARMALIB_CCXIDSCUSTOMPSTATESDHARMALIB_FILECODE  (0x3025)
...
#define LIBRARY_CCXIDSCUSTOMPSTATESDHARMLIB_CCXIDSCUSTOMPSTATESDHARMLIB_FILECODE    (0x3029)

#define CCX_DHARMA_CCXDHARMAPEI_CCXDHARMACACHEINIT_FILECODE        (0x3037)
#define CCX_DHARMA_CCXDHARMADXE_HYGONCCXDHARMADXE_FILECODE         (0x3038)
#define CCX_DHARMA_CCXDHARMAPEI_HYGONCCXDHARMAPEI_FILECODE         (0x3039)
#define CCX_DHARMA_CCXDHARMADXE_CCXDHARMAMICROCODEPATCH_FILECODE   (0x303A)
#define CCX_DHARMA_CCXDHARMADXE_CCXDHARMAACPISERVICESDXE_FILECODE  (0x303F)
#define CCX_DHARMA_CCXDHARMADXE_CCXDHARMAC6_FILECODE               (0x3040)
#define CCX_DHARMA_CCXDHARMADXE_CCXDHARMACPB_FILECODE              (0x3041)
#define CCX_DHARMA_CCXDHARMADXE_CCXDHARMAPREFETCH_FILECODE         (0x3042)
#define CCX_DHARMA_CCXDHARMADXE_CCXDHARMASMBIOSDXE_FILECODE        (0x3043)
#define CCX_DHARMA_CCXDHARMAPEI_CCXDHARMADOWNCOREINIT_FILECODE     (0x3044)
#define CCX_DHARMA_CCXDHARMAPEI_CCXDHARMABRANDSTRING_FILECODE      (0x3047)
#define CCX_DHARMA_CCXDHARMASMM_HYGONCCXDHARMASMM_FILECODE         (0x3048)
#define CCX_DHARMA_CCXDHARMADXE_CCXDHARMAACPIRAS_FILECODE          (0x3054)
...
#define CCX_XV_CCXXVPEI_HYGONCCXXVPEI_FILECODE           (0x30DA)
...
#define CCX_XV_CCXXVDXE_HYGONCCXXVDXE_FILECODE            (0x30E6)
...
#define CCX_XV_CCXXVSMM_HYGONCCXXVSMM_FILECODE  (0x30F0)

// Universal
#define UNIVERSAL_SMBIOS_HYGONSMBIOSDXE_FILECODE                          (0x8000)
#define UNIVERSAL_SMBIOS_HYGONSMBIOSTYPE4_FILECODE                        (0x8001)
#define UNIVERSAL_SMBIOS_HYGONSMBIOSTYPE7_FILECODE                        (0x8002)
#define UNIVERSAL_SMBIOS_HYGONSMBIOSTYPE16_FILECODE                       (0x8003)
#define UNIVERSAL_SMBIOS_HYGONSMBIOSTYPE17_FILECODE                       (0x8004)
#define UNIVERSAL_SMBIOS_HYGONSMBIOSTYPE18_FILECODE                       (0x8005)
#define UNIVERSAL_SMBIOS_HYGONSMBIOSTYPE19_FILECODE                       (0x8006)
#define UNIVERSAL_SMBIOS_HYGONSMBIOSTYPE20_FILECODE                       (0x8007)
#define UNIVERSAL_ACPI_HYGONACPIDXE_FILECODE                              (0x8010)
#define UNIVERSAL_ACPI_HYGONACPICPUSSDT_FILECODE                          (0x8011)
#define UNIVERSAL_ACPI_HYGONACPICRAT_FILECODE                             (0x8012)
#define UNIVERSAL_ACPI_HYGONACPICDIT_FILECODE                             (0x8013)
#define UNIVERSAL_ACPI_HYGONACPISRAT_FILECODE                             (0x8014)
#define UNIVERSAL_ACPI_HYGONACPISLIT_FILECODE                             (0x8015)
#define UNIVERSAL_ACPI_HYGONACPIMSCT_FILECODE                             (0x8016)
#define UNIVERSAL_HYGONMEMORYHOBINFOPEIM_HYGONMEMORYHOBINFOPEIM_FILECODE  (0x8017)
#define UNIVERSAL_ACPI_HYGONACPIHMATSERVICE_FILECODE                      (0x8018)
#define UNIVERSAL_ACPI_HYGONACPIHMAT_FILECODE                             (0x8019)

// Fabric
#define FABRIC_SAT_FABRICSATPEI_HYGONFABRICSATPEI_FILECODE                                      (0xDF00)
#define FABRIC_SAT_FABRICSATPEI_FABRICPSTATESERVICESPEI_FILECODE                                (0xDF01)
#define FABRIC_SAT_FABRICSATDXE_HYGONFABRICSATDXE_FILECODE                                      (0xDF02)
#define LIBRARY_FABRICREGISTERACCSOC18LIB_FABRICREGISTERACCSOC18LIB_FILECODE                    (0xDF03)
#define FABRIC_SAT_FABRICSATPEI_FABRICCCMINIT_FILECODE                                          (0xDF04)
#define FABRIC_SAT_FABRICSATPEI_FABRICCSINIT_FILECODE                                           (0xDF05)
#define FABRIC_SAT_FABRICSATPEI_FABRICDFCLKGATINGINIT_FILECODE                                  (0xDF06)
#define FABRIC_SAT_FABRICSATPEI_FABRICPIERASINIT_FILECODE                                       (0xDF07)
#define FABRIC_SAT_FABRICSATDXE_FABRICPIEPWRMGMT_FILECODE                                       (0xDF08)
#define LIBRARY_FABRICIDSHOOKSATLIB_PEI_FABRICIDSHOOKSATLIBPEI_FILECODE                         (0xDF09)
#define LIBRARY_FABRICIDSHOOKSATLIB_DXE_FABRICIDSHOOKSATLIBDXE_FILECODE                         (0xDF0A)
#define FABRIC_SAT_FABRICSATPEI_FABRICSCRUBINIT_FILECODE                                        (0xDF0B)
#define FABRIC_SAT_FABRICSATPEI_FABRICIOMSINIT_FILECODE                                         (0xDF0C)
#define LIBRARY_FABRICRESOURCEMANAGERDHARMASATLIB_FABRICRESOURCEMANAGERDHARMASATLIB_FILECODE    (0xDF0D)
#define FABRIC_SAT_FABRICSATDXE_FABRICACPISLIT_FILECODE                                         (0xDF0E)
#define FABRIC_SAT_FABRICSATDXE_FABRICACPICDIT_FILECODE                                         (0xDF0F)
#define FABRIC_SAT_FABRICSATDXE_FABRICACPIDISTANCEINFO_FILECODE                                 (0xDF10)
#define FABRIC_SAT_FABRICSATDXE_FABRICACPISRAT_FILECODE                                         (0xDF11)
#define FABRIC_SAT_FABRICSATDXE_FABRICACPICRAT_FILECODE                                         (0xDF12)
#define FABRIC_SAT_FABRICSATDXE_FABRICREADYTOBOOT_FILECODE                                      (0xDF13)
#define LIBRARY_BASESOCKETLOGICALIDRVDIELIB_BASESOCKETLOGICALIDRVDIELIB_FILECODE                (0xDF14)
#define LIBRARY_BASESOCKETLOGICALIDSATDIELIB_BASESOCKETLOGICALIDSATDIELIB_FILECODE              (0xDF15)
#define FABRIC_SAT_FABRICSATDXE_FABRICACPIDOMAININFO_FILECODE                                   (0xDF16)
#define LIBRARY_PEIFABRICRESOURCESIZEFOREACHRBLIB_PEIFABRICRESOURCESIZEFOREACHRBLIB_FILECODE    (0xDF17)
#define LIBRARY_DXEFABRICRESOURCESIZEFOREACHRBLIB_DXEFABRICRESOURCESIZEFOREACHRBLIB_FILECODE    (0xDF18)
#define LIBRARY_FABRICRESOURCEMANAGERDHARMASATLIB_FABRICRESOURCEINITBASEONNVDHARMASAT_FILECODE  (0xDF19)
#define LIBRARY_FABRICRESOURCEMANAGERDHARMASATLIB_FABRICRESOURCEINITDHARMASATLIB_FILECODE       (0xDF1A)
#define FABRIC_SAT_FABRICSATSMM_HYGONFABRICSATSMM_FILECODE                                      (0xDF1B)
...
#define FABRIC_SAT_FABRICSATDXE_FABRICACPIMSCT_FILECODE                                         (0xDF1F)
// Fabric ST
#define FABRIC_HYEX_FABRICPEI_HYGONFABRICSTPEI_FILECODE                           (0xDF30)
#define FABRIC_HYEX_FABRICPEI_FABRICPSTATESERVICESPEI_FILECODE                    (0xDF31)
#define FABRIC_HYEX_FABRICDXE_HYGONFABRICSTDXE_FILECODE                           (0xDF32)
#define LIBRARY_FABRICREGISTERACCSTLIB_FABRICREGISTERACCSTLIB_FILECODE           (0xDF33)
#define FABRIC_HYEX_FABRICPEI_FABRICCCMINIT_FILECODE                              (0xDF34)
#define FABRIC_HYEX_FABRICPEI_FABRICCSINIT_FILECODE                               (0xDF35)
#define FABRIC_HYEX_FABRICPEI_FABRICDFCLKGATINGINIT_FILECODE                      (0xDF36)
#define FABRIC_HYEX_FABRICPEI_FABRICPIERASINIT_FILECODE                           (0xDF37)
#define FABRIC_HYEX_FABRICDXE_FABRICPIEPWRMGMT_FILECODE                           (0xDF38)
#define LIBRARY_FABRICIDSHOOKSTLIB_PEI_FABRICIDSHOOKSTLIBPEI_FILECODE            (0xDF39)
#define LIBRARY_FABRICIDSHOOKSTLIB_DXE_FABRICIDSHOOKSTLIBDXE_FILECODE            (0xDF3A)
#define FABRIC_HYEX_FABRICPEI_FABRICSCRUBINIT_FILECODE                            (0xDF3B)
#define FABRIC_HYEX_FABRICPEI_FABRICIOMSINIT_FILECODE                             (0xDF3C)
#define LIBRARY_FABRICRESOURCEMANAGERSTLIB_FABRICRESOURCEMANAGERSTLIB_FILECODE   (0xDF3D)
#define FABRIC_HYEX_FABRICDXE_FABRICACPISLIT_FILECODE                             (0xDF3E)
#define FABRIC_HYEX_FABRICDXE_FABRICACPICDIT_FILECODE                             (0xDF3F)
#define FABRIC_HYEX_FABRICDXE_FABRICACPIDISTANCEINFO_FILECODE                     (0xDF40)
#define FABRIC_HYEX_FABRICDXE_FABRICACPISRAT_FILECODE                             (0xDF41)
#define FABRIC_HYEX_FABRICDXE_FABRICACPICRAT_FILECODE                             (0xDF42)
#define FABRIC_HYEX_FABRICDXE_FABRICREADYTOBOOT_FILECODE                          (0xDF43)
#define LIBRARY_BASESOCKETLOGICALIDDMLIB_BASESOCKETLOGICALIDDMLIB_FILECODE       (0xDF45)
#define FABRIC_HYEX_FABRICDXE_FABRICACPIDOMAININFO_FILECODE                       (0xDF46)
#define LIBRARY_FABRICRESOURCEMANAGERSTLIB_FABRICRESOURCEINITBASEONNVST_FILECODE (0xDF49)
#define LIBRARY_FABRICRESOURCEMANAGERSTLIB_FABRICRESOURCEINITSTLIB_FILECODE      (0xDF4A)
#define FABRIC_HYEX_FABRICSMM_HYGONFABRICSTSMM_FILECODE                           (0xDF4B)
#define FABRIC_HYEX_FABRICDXE_FABRICACPIMSCT_FILECODE                             (0xDF4F)
#define FABRIC_HYEX_FABRICPEI_FABRICPCIBUSMAP_FILECODE                            (0xDF50)
//HyGx DF
#define FABRIC_HYGX_FABRICPEI_HYGONFABRICSTPEI_FILECODE                           (0xDF80)
#define FABRIC_HYGX_FABRICPEI_FABRICPSTATESERVICESPEI_FILECODE                    (0xDF81)
#define FABRIC_HYGX_FABRICDXE_HYGONFABRICSTDXE_FILECODE                           (0xDF82)
#define FABRIC_HYGX_FABRICPEI_FABRICCCMINIT_FILECODE                              (0xDF84)
#define FABRIC_HYGX_FABRICPEI_FABRICCSINIT_FILECODE                               (0xDF85)
#define FABRIC_HYGX_FABRICPEI_FABRICDFCLKGATINGINIT_FILECODE                      (0xDF86)
#define FABRIC_HYGX_FABRICPEI_FABRICPIERASINIT_FILECODE                           (0xDF87)
#define FABRIC_HYGX_FABRICDXE_FABRICPIEPWRMGMT_FILECODE                           (0xDF88)
#define FABRIC_HYGX_FABRICPEI_FABRICSCRUBINIT_FILECODE                            (0xDF89)
#define FABRIC_HYGX_FABRICPEI_FABRICIOMSINIT_FILECODE                             (0xDF8A)
#define FABRIC_HYGX_FABRICDXE_FABRICACPISLIT_FILECODE                             (0xDF8B)
#define FABRIC_HYGX_FABRICDXE_FABRICACPICDIT_FILECODE                             (0xDF8C)
#define FABRIC_HYGX_FABRICDXE_FABRICACPIDISTANCEINFO_FILECODE                     (0xDF8D)
#define FABRIC_HYGX_FABRICDXE_FABRICACPISRAT_FILECODE                             (0xDF8E)
#define FABRIC_HYGX_FABRICDXE_FABRICACPICRAT_FILECODE                             (0xDF8F)
#define FABRIC_HYGX_FABRICDXE_FABRICREADYTOBOOT_FILECODE                          (0xDF90)
#define FABRIC_HYGX_FABRICDXE_FABRICACPIDOMAININFO_FILECODE                       (0xDF91)
#define FABRIC_HYGX_FABRICSMM_HYGONFABRICSTSMM_FILECODE                           (0xDF92)
#define FABRIC_HYGX_FABRICDXE_FABRICACPIMSCT_FILECODE                             (0xDF93)
#define FABRIC_HYGX_FABRICPEI_FABRICPCIBUSMAP_FILECODE                            (0xDF94)
#define FABRIC_FABRICDXE_FABRICACPIHMAT_FILECODE                                  (0xDF95)

// 0xDFE0 ~ 0xDFFF for Excavator
#define FABRIC_XV_UNBXVPEI_HYGONUNBXVPEI_FILECODE                                 (0xDFE0)
...
#define FABRIC_XV_UNBXVDXE_HYGONUNBXVDXE_FILECODE                                 (0xDFE3)
...
#define LIBRARY_FABRICPSTATESSTLIB_FABRICPSTATESSTLIB_FILECODE                    (0xDFE7)
#define LIBRARY_BASESOCKETLOGICALIDUNBLIB_BASESOCKETLOGICALIDUNBLIB_FILECODE      (0xDFE8)
#define LIBRARY_BASEFABRICTOPOLOGYSTLIB_BASEFABRICTOPOLOGYSTLIB_FILECODE          (0xDFE9)
#define FABRIC_XV_UNBXVDXE_UNBACPICDIT_FILECODE                                   (0xDFEA)
#define LIBRARY_FABRICWDTSTLIB_FABRICWDTSTLIB_FILECODE                            (0xDFEB)
...
#define LIBRARY_GNBREGISTERACCSATLIB_GNBREGISTERACCSATLIB_FILECODE  (0xA103)
...
#define LIBRARY_NBIOSMULIB_NBIOSMULIB_FILECODE                      (0xA11A)
...
#define LIBRARY_HSIOLIB_HSIOLIB_FILECODE                            (0xA127)
#define LIBRARY_NBIOIDSHOOKSTLIB_NBIOIDSHOOKSTLIB_FILECODE          (0xA128)
...
#define LIBRARY_HSIOLIB_HSIOANCDATA_FILECODE                        (0xA12C)
...
#define LIBRARY_PCIEMISCCOMMLIB_PCIEEXTENDEDSYNC_FILECODE           (0xA130)

#define NBIO_NBIOBASE_HYGONNBIOBASECSATEI_HYGONNBIOBASECSATEI_FILECODE  (0xA150)
#define NBIO_NBIOBASE_HYGONNBIOBASECZDXE_HYGONNBIOBASECZDXE_FILECODE    (0xA151)
//HyEx NBIO Base
#define NBIO_NBIOBASE_HYEX_HYGONNBIOBASEDXE_HYGONNBIOBASEDXE_FILECODE   (0xA200)
#define NBIO_NBIOBASE_HYEX_HYGONNBIOBASEPEI_HYGONNBIOBASEPEI_FILECODE   (0xA201)
#define NBIO_NBIOBASE_HYEX_HYGONNBIOBASEPEI_NBIOTABLES_FILECODE         (0xA202)
#define NBIO_NBIOBASE_HYEX_HYGONNBIOBASEPEI_NBIOTOPMEM_FILECODE         (0xA203)
#define NBIO_NBIOBASE_HYEX_HYGONNBIOBASEPEI_PCIECOMPLEXDATA_FILECODE    (0xA204)
#define NBIO_NBIOBASE_HYEX_HYGONNBIOBASEPEI_NBIORASCONTROL_FILECODE     (0xA205)
#define NBIO_NBIOBASE_HYEX_HYGONNBIOBASEPEI_NBIORASWORKAROUND_FILECODE  (0xA206)
//HyGx NBIO Base
#define NBIO_NBIOBASE_HYGX_HYGONNBIOBASEDXE_HYGONNBIOBASEDXE_FILECODE   (0xA210)
#define NBIO_NBIOBASE_HYGX_HYGONNBIOBASEPEI_HYGONNBIOBASEPEI_FILECODE   (0xA211)
#define NBIO_NBIOBASE_HYGX_HYGONNBIOBASEPEI_NBIOTABLES_FILECODE         (0xA212)
#define NBIO_NBIOBASE_HYGX_HYGONNBIOBASEPEI_NBIOTOPMEM_FILECODE         (0xA213)
#define NBIO_NBIOBASE_HYGX_HYGONNBIOBASEPEI_PCIECOMPLEXDATA_FILECODE    (0xA214)
#define NBIO_NBIOBASE_HYGX_HYGONNBIOBASEPEI_NBIORASCONTROL_FILECODE     (0xA215)
#define NBIO_NBIOBASE_HYGX_HYGONNBIOBASEPEI_NBIORASWORKAROUND_FILECODE  (0xA216)

#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTPEI_HYGONNBIOPCIESTPEI_FILECODE  (0xA21F)
#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTPEI_HSIOINITST_FILECODE          (0xA220)
#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTPEI_HIDEPORTSST_FILECODE         (0xA221)
#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTPEI_PCIEREMAPST_FILECODE         (0xA222)
#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTPEI_DEVICECONTROLST_FILECODE     (0xA223)
#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTPEI_PCIEHOTPLUGST_FILECODE       (0xA224)
#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTPEI_HSIOCFGPOINTSST_FILECODE     (0xA225)

#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTPEI_HYGONNBIOPCIESTPEI_FILECODE  (0xA226)
#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTPEI_HSIOINITST_FILECODE          (0xA227)
#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTPEI_HIDEPORTSST_FILECODE         (0xA228)
#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTPEI_PCIEREMAPST_FILECODE         (0xA229)
#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTPEI_DEVICECONTROLST_FILECODE     (0xA22A)
#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTPEI_PCIEHOTPLUGST_FILECODE       (0xA22B)
#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTPEI_HSIOCFGPOINTSST_FILECODE     (0xA22C)

#define NBIO_IOMMU_HYGONNBIOIOMMUSTPEI_HYGONNBIOIOMMUSTPEI_FILECODE      (0xA22D)

#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTPEI_DPCSTATUSREPORT_FILECODE        (0xA22E)
#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTPEI_DPCSTATUSREPORT_FILECODE        (0xA22F)

#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTDXE_HYGONNBIOPCIESTDXE_FILECODE     (0xA230)
#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTDXE_HYGONNBIOPCIEAERST_FILECODE     (0xA231)
#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTDXE_HYGONNBIOPCIESRISST_FILECODE    (0xA232)
#define NBIO_PCIE_HYEX_HYGONNBIOPCIESTDXE_HYGONNBIOPCIECLKREQST_FILECODE  (0xA233)

#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTDXE_HYGONNBIOPCIESTDXE_FILECODE     (0xA235)
#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTDXE_HYGONNBIOPCIEAERST_FILECODE     (0xA236)
#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTDXE_HYGONNBIOPCIESRISST_FILECODE    (0xA237)
#define NBIO_PCIE_HYGX_HYGONNBIOPCIESTDXE_HYGONNBIOPCIECLKREQST_FILECODE  (0xA238)

#define NBIO_IOMMU_HYGONNBIOIOMMUSTDXE_HYGONNBIOIOMMUSTDXE_FILECODE  (0xA240)

#define NBIO_SMU_HYEX_HYGONNBIOSMUDXE_HYGONNBIOSMUDXE_FILECODE            (0xA250)
#define NBIO_SMU_HYEX_HYGONNBIOSMUDXE_PCIEHOTPLUG_FILECODE                (0xA251)
#define NBIO_SMU_HYEX_HYGONNBIOSMUPEI_HYGONNBIOSMUPEI_FILECODE            (0xA252)
#define NBIO_SMU_HYEX_HYGONNBIOSMUPEI_SMUEARLYINIT_FILECODE               (0xA253)
#define NBIO_SMU_HYEX_HYGONNBIOSMUPEI_HYGONSMUSERVICESPPI_FILECODE        (0xA254)
#define NBIO_SMU_HYEX_HYGONNBIOSMUPEI_HYGONCORELAUNCHSERVICEPPI_FILECODE  (0xA255)
#define NBIO_SMU_HYEX_HYGONNBIOSMUDXE_ACBTC_FILECODE                      (0xA256)

#define NBIO_SMU_HYGX_HYGONNBIOSMUDXE_HYGONNBIOSMUDXE_FILECODE            (0xA260)
#define NBIO_SMU_HYGX_HYGONNBIOSMUDXE_PCIEHOTPLUG_FILECODE                (0xA261)
#define NBIO_SMU_HYGX_HYGONNBIOSMUPEI_HYGONNBIOSMUPEI_FILECODE            (0xA262)
#define NBIO_SMU_HYGX_HYGONNBIOSMUPEI_SMUEARLYINIT_FILECODE               (0xA263)
#define NBIO_SMU_HYGX_HYGONNBIOSMUPEI_HYGONSMUSERVICESPPI_FILECODE        (0xA264)
#define NBIO_SMU_HYGX_HYGONNBIOSMUPEI_HYGONCORELAUNCHSERVICEPPI_FILECODE  (0xA265)
#define NBIO_SMU_HYGX_HYGONNBIOSMUDXE_ACBTC_FILECODE                      (0xA266)

#define NBIO_CXL_HYGONCXLPEI_HYGONCXLPEI_FILECODE                     (0xA270)
#define NBIO_CXL_HYGONCXLPEI_INITCXL11PEI_FILECODE                    (0xA271)
#define NBIO_CXL_HYGONCXLPEI_CXLEQ_FILECODE                           (0xA272)
#define NBIO_CXL_HYGONCXLDXE_HYGONCXLDXE_FILECODE                     (0xA273)
#define NBIO_CXL_HYGONCXLDXE_CXLHPCB_FILECODE                         (0xA274)
#define NBIO_CXL_HYGONCXLDXE_CXLCEDT_FILECODE                         (0xA275)
#define NBIO_CXL_HYGONCXLDXE_CXLHMAT_FILECODE                         (0xA276)
#define NBIO_CXL_HYGONCXLDXE_CXLMISCINIT_FILECODE                     (0xA277)
#define NBIO_CXL_HYGONCXLDXE_CXLCDAT_FILECODE                         (0xA278)
#define NBIO_CXL_HYGONCXLDXE_CXLMANAGER_FILECODE                      (0xA279)

#define NBIO_NBIOBASE_HYGONNBIOBASERVDXE_HYGONNBIOBASERVDXE_FILECODE  (0xA280)

#define NBIO_NBIOBASE_HYGONNBIOBASERVPEI_HYGONNBIOBASERVPEI_FILECODE  (0xA290)
#define NBIO_NBIOBASE_HYGONNBIOBASERVPEI_GNBIOMMUTABLESRV_FILECODE    (0xA291)
#define NBIO_NBIOBASE_HYGONNBIOBASERVPEI_NBIOTABLESRV_FILECODE        (0xA292)
#define NBIO_NBIOBASE_HYGONNBIOBASERVPEI_NBIOTOPMEMRV_FILECODE        (0xA293)
#define NBIO_NBIOBASE_HYGONNBIOBASERVPEI_PCIECOMPLEXDATARV_FILECODE   (0xA294)
#define NBIO_NBIOBASE_HYGONNBIOBASERVPEI_NBIORASCONTROLRV_FILECODE    (0xA295)

#define NBIO_GFX_HYGONNBIOGFXRVPEI_HYGONNBIOGFXRVPEI_FILECODE  (0xA2C0)
#define NBIO_GFX_HYGONNBIOGFXRVPEI_GFXTABLESRV_FILECODE        (0xA2C1)

#define NBIO_GFX_HYGONNBIOGFXRVDXE_HYGONNBIOGFXRVDXE_FILECODE  (0xA2D0)

#define NBIO_NBIOALIB_HYGONNBIOALIBSTDXE_HYGONNBIOALIBSTDXE_FILECODE     (0xA2E0)
#define NBIO_NBIOALIB_HYGONNBIOALIBSTDXE_HYGONNBIOALIBCALLBACK_FILECODE  (0xA2E1)

#define LIBRARY_GNBCXLLIB_GNBCXLLIB_FILECODE                             (0xA2F0)
...
// MEMORY
#define LIBRARY_MEM_FEATDMICOLLECTLIB_HYGONMEMDMILIB_FILECODE     (0xF104)
#define LIBRARY_MEM_FEATDMICOLLECTLIB_HYGONMEMDMID4LIB_FILECODE   (0xF105)
#define LIBRARY_MEM_FEATDMICOLLECTLIB_HYGONMEMDMID34LIB_FILECODE  (0xF106)
...
#define LIBRARY_MEM_FEATCRATLIB_HYGONMEMCRATLIB_FILECODE       (0xF095)
...
#define LIBRARY_MEM_FEATUMALIB_HYGONMEMFEATUMALIB_FILECODE     (0xF094)
...
#define LIBRARY_MEM_PSCZDHM1LIB_MPUCZDHM1D3_FILECODE  (0xF458)
#define LIBRARY_MEM_PSCZDHM1LIB_MPUCZDHM1D4_FILECODE  (0xF459)
#define LIBRARY_MEM_PSCZLIB_MPUCZ4_FILECODE           (0xF45A)
#define LIBRARY_MEM_PSCZDHM1LIB_MPSCZDHM1D4_FILECODE  (0xF45B)
...
#define LIBRARY_MEM_REPORTINFOLIB_HYGONMEMREPORTINFOLIB_FILECODE  (0xF441)

#define LIBRARY_MEM_S3INITLIB_S3INIT_FILECODE  (0xF451)

#define LIBRARY_MEM_SERVICESCZLIB_HYGONMEMSERVICESCZLIB_FILECODE  (0xF461)

#define LIBRARY_MEM_SERVICESLIB_HYGONMEMSERVICESLIB_FILECODE  (0xF471)

#define LIBRARY_MEM_SERVICESSMLIB_HYGONMEMSERVICESSMLIB_FILECODE  (0xF481)
...
#define LIBRARY_HYGONCALLOUTLIB_HGPIREADSPD_FILECODE                      (0xF305)
#define LIBRARY_HYGONCALLOUTLIB_HGPIHOOKBEFOREEXITSELFREFRESH_FILECODE    (0xF306)
...
#define LIBRARY_MEM_NULL_FEATCRATLIBNULL_HYGONMEMCRATLIB_FILECODE       (0xF605)
#define LIBRARY_MEM_NULL_FEATCSINTLVLIBNULL_MFCSI_FILECODE              (0xF606)
#define LIBRARY_MEM_NULL_FEATDMICOLLECTLIBNULL_HYGONMEMDMILIB_FILECODE  (0xF609)
...
#define LIBRARY_MEM_NULL_FEATUMALIBNULL_HYGONMEMFEATUMALIB_FILECODE     (0xF616)
...
#define LIBRARY_MEM_NULL_MAINLIBNULL_HYGONMEMMAINLIB_FILECODE           (0xF61A)
...
#define LIBRARY_MEM_NULL_PSCZDHM1LIBNULL_MPUCZDHM1D3_FILECODE           (0xF64C)
#define LIBRARY_MEM_NULL_PSCZDHM1LIBNULL_MPUCZDHM1D4_FILECODE           (0xF64D)
...
#define LIBRARY_MEMSMBIOSLIB_MEMSMBIOSV2LIB_FILECODE  (0xF67D)

#define LIBRARY_MEM_NULL_FEATDMICOLLECTLIBNULL_HYGONMEMDMID34LIB_FILECODE  (0xF67E)
#define LIBRARY_MEM_NULL_FEATDMICOLLECTLIBNULL_HYGONMEMDMID4LIB_FILECODE   (0xF680)
// add smbios 3.2 support--->
#define LIBRARY_MEMSMBIOSLIB_MEMSMBIOS_320LIB_FILECODE  (0xF690)
// add smbios 3.2 support
#define LIBRARY_MEMSMBIOSLIB_MEMDDR4SPD_FILECODE  (0xF691)
#define LIBRARY_MEMSMBIOSLIB_MEMDDR5SPD_FILECODE  (0xF692)

#define LIBRARY_OPTIONMEMORYINSTALLCZLIB_OPTIONMEMORYINSTALLCZ_FILECODE  (0xF700)

// SOC Drivers
#define LIBRARY_HYGONSOCBASELIB_HYGONSOCBASELIB_FILECODE  (0xD001)
#define SOC_HYGONSOCDHM1BRPEI_HYGONSOCDHM1BRPEI_FILECODE  (0xD002)
#define SOC_HYGONSOCDHM1BRDXE_HYGONSOCDHM1BRDXE_FILECODE  (0xD003)
#define SOC_HYGONSOCDHM1SMPEI_HYGONSOCDHM1SMPEI_FILECODE  (0xD004)
#define SOC_HYGONSOCDHM1SMDXE_HYGONSOCDHM1SMDXE_FILECODE  (0xD005)
#define SOC_HYGONSOCFP5RVPEI_HYGONSOCFP5RVPEI_FILECODE    (0xD006)
#define SOC_HYGONSOCFP5RVDXE_HYGONSOCFP5RVDXE_FILECODE    (0xD007)
...
#define LIBRARY_BASESOCLOGICALIDXLATSATDIELIB_BASESOCLOGICALIDXLATSATDIELIB_FILECODE  (0xD015)
...
#define LIBRARY_PEISOCBISTSATLIB_PEISOCBISTSATLIB_FILECODE                            (0xD018)

#define SOC_HYGONSOCSL2STPEI_HYGONSOCSL2STPEI_FILECODE                        (0xD038)
#define SOC_HYGONSOCSL2STDXE_HYGONSOCSL2STDXE_FILECODE                        (0xD039)
#define LIBRARY_BASESOCLOGICALIDXLATDMLIB_BASESOCLOGICALIDXLATDMLIB_FILECODE  (0xD045)
#define LIBRARY_PEISOCBISTSTLIB_PEISOCBISTSTLIB_FILECODE                      (0xD048)

// Event Log Drivers
#define LIBRARY_HYGONERRORLOGLIB_HYGONERRORLOGLIB_FILECODE   (0xE001)
#define ERRORLOG_HYGONERRORLOGPEI_HYGONERRORLOGPEI_FILECODE  (0xE002)
#define ERRORLOG_HYGONERRORLOGDXE_HYGONERRORLOGDXE_FILECODE  (0xE003)

// Version String Drivers
#define UNIVERSAL_VERISION_HYGONVERSIONPEI_HYGONVERSIONPEI_FILECODE  (0xE004)
#define UNIVERSAL_VERISION_HYGONVERSIONDXE_HYGONVERSIONDXE_FILECODE  (0xE005)

// RAS
#define LIBRARY_RASSMMLIB_RASSMMLIB_FILECODE    (0xC001)
#define LIBRARY_RASBASELIB_RASBASELIB_FILECODE  (0xC002)

#define RAS_HYGONRASAPEIDXE_HYGONRASAPEIDXE_FILECODE  (0xC101)
#define RAS_HYGONRASDXE_HYGONRASDXE_FILECODE          (0xC102)
#define RAS_HYGONRASSMM_HYGONRASSMM_FILECODE          (0xC103)

// HPCB
#define PSP_HPCB_HPCBSATDXE_HPCBSATDXE_FILECODE  (0xC200)
#define PSP_HPCB_HPCBSATSMM_HPCBSATSMM_FILECODE  (0xC201)
#define PSP_HPCB_TOKENS_CBS_EXT_TOKENS_FILECODE  (0xC202)
#define PSP_HPCB_TOKENS_CONFIG_TOKENS_FILECODE   (0xC203)

#define LIBRARY_HPCBPEILIB_HPCBLIB_FILECODE             (0xC210)
#define LIBRARY_HPCBDXELIB_HPCBLIB_FILECODE             (0xC211)
#define LIBRARY_HPCBLIB_HPCBREPLACETYPE_FILECODE        (0xC212)
#define LIBRARY_HPCBLIB_DRAMPOSTPACKAGEREPAIR_FILECODE  (0xC213)
#define LIBRARY_HPCBPEILIB_GETSETPARAMS_FILECODE        (0xC214)
#define LIBRARY_HPCBDXELIB_GETSETPARAMS_FILECODE        (0xC215)

// RTCIntrDet
#define LIBRARY_RTCINTRDETLIB_RTCINTRDETLIB_FILECODE  (0xC300)
