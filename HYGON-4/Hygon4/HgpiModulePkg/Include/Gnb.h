...
#define GnbLibGetHeader(x)  ((HYGON_CONFIG_PARAMS *)(x)->StdHeader)

#define HGPI_STATUS_UPDATE(Current, Aggregated) \
...
#define TABLE_PROPERTY_MASTER_NBIO                0x00000100ul
#define TABLE_PROPERTY_EMEI_FULL_NBIO             0x00000200ul
#define TABLE_PROPERTY_DISABLE_NBIO23             0x00000400ul
#define TABLE_PROPERTY_NMI_SYNCFLOOD              0x00000800ul
// #define TABLE_PROPERTY_PACKAGE_SL2                 0x00000800ul
...
#define TABLE_PROPERTY_IOMMU_X2APIC_SUPPORT       0x80000000ul
