...
#ifndef _HYGON_PSP_DIR_H_
#define _HYGON_PSP_DIR_H_
...
enum _PSP_DIRECTORY_ENTRY_TYPE {
  HYGON_PUBLIC_KEY             = 0x00,             ///< PSP entry pointer to HYGON public key
  ...
  HYGON_SEC_DBG_PUBLIC_KEY     = 0x09,             ///< PSP entry pointer to Secure Unlock Public key
  OEM_PSP_FW_PUBLIC_KEY        = 0x0A,             ///< PSP entry pointer to an optional public part of the OEM PSP Firmware Signing Key Token
  HYGON_SOFT_FUSE_CHAIN_01     = 0x0B,             ///< PSP entry pointer to 64bit PSP Soft Fuse Chain
  ...
  PSP_HGPI_RESUME_FW           = 0x10,             ///< PSP Entry points to PSP Hgpi-Resume-Firmware
  ...
  HGPI_BOOT_LOADER_0           = 0x30,             ///< PSP entry points to PSP HGPI Binary 0
  HGPI_BOOT_LOADER_1           = 0x31,             ///< PSP entry points to PSP HGPI Binary 1
  HGPI_BOOT_LOADER_2           = 0x32,             ///< PSP entry points to PSP HGPI Binary 2
  HGPI_BOOT_LOADER_3           = 0x33,             ///< PSP entry points to PSP HGPI Binary 3
  HGPI_BOOT_LOADER_4           = 0x34,             ///< PSP entry points to PSP HGPI Binary 4
  HGPI_BOOT_LOADER_5           = 0x35,             ///< PSP entry points to PSP HGPI Binary 5
  HGPI_BOOT_LOADER_6           = 0x36,             ///< PSP entry points to PSP HGPI Binary 6
  HGPI_BOOT_LOADER_7           = 0x37,             ///< PSP entry points to PSP HGPI Binary 7
  ...
  HYGON_SCS_BINARY             = 0x5F,             ///< Software Configuration Settings Data Block
