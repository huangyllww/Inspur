...
#ifndef _HYGON_PSP_RESUME_SERVICE_PROTOCOL_H_
#define _HYGON_PSP_RESUME_SERVICE_PROTOCOL_H_
...
extern EFI_GUID  gHygonPspResumeServiceProtocolGuid;
#endif //_HYGON_PSP_RESUME_SERVICE_PROTOCOL_H_
