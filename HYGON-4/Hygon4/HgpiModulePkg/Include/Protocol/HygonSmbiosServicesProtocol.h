 ...
 * @file
 *
 * HYGON SMBIOS Services Protocol prototype definition
 *
 *
...
#ifndef _HYGON_SMBIOS_SERVICES_PROTOCOL_H_
#define _HYGON_SMBIOS_SERVICES_PROTOCOL_H_
...
#define P_DHARMA_PROCESSOR_FAMILY       0x6B
#define P_CHARACTERISTICS               0xEC
#define P_CHARACTERISTICS_DHARMA        0xFC
...
#define P_UPGRADE_DM1                   0x31
#define P_UPGRADE_SL2                   0x37
#define P_UPGRADE_SL2r2                 0x38

#define PROC_VERSION_LENGTH  48
#define PROC_MANU_LENGTH     29

/// Structure for processor stepping and features
typedef struct _HYGON_PROCESSOR_ID {
...
typedef struct _HYGON_CCX_CORE_DMI_INFO {
  UINT8                 ProcessorType;                         ///< Processor type
  UINT16                ProcessorFamily;                       ///< Processor family
  HYGON_PROCESSOR_ID    ProcessorID;                           ///< Raw processor identification data
  ...
  CHAR8                 ProcessorVersion[PROC_VERSION_LENGTH+1]; ///< Cpu version       // byo230920 -
  CHAR8                 ProcessorManufacturer[PROC_MANU_LENGTH]; ///< Manufacturer
} HYGON_CCX_CORE_DMI_INFO;
...
typedef struct _HYGON_CACHE_EACH_LEVEL_DMI_INFO {
...
} HYGON_CACHE_EACH_LEVEL_DMI_INFO;

/// Structure for Cache DMI information
typedef struct _HYGON_CACHE_DMI_INFO {
  HYGON_CACHE_EACH_LEVEL_DMI_INFO    CacheEachLevelInfo[CpuLmaxCache];    ///< Cache info
} HYGON_CACHE_DMI_INFO;

///
/// Forward declaration for the HYGON_CCX_SMBIOS_SERVICES_PROTOCOL.
///
typedef struct _HYGON_CCX_SMBIOS_SERVICES_PROTOCOL HYGON_CCX_SMBIOS_SERVICES_PROTOCOL;

typedef
EFI_STATUS
(EFIAPI *HYGON_SMBIOS_SERVICES_GET_CORE_DMI_INFO)(
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SMBIOS_SERVICES_GET_CACHE_DMI_INFO)(
  IN       HYGON_CCX_SMBIOS_SERVICES_PROTOCOL       *This,
  IN       UINTN                                   Socket,
...
///
struct _HYGON_CCX_SMBIOS_SERVICES_PROTOCOL {
  UINTN                                       Revision;                    ///< Revision Number
  HYGON_SMBIOS_SERVICES_GET_CORE_DMI_INFO     GetCoreDmiInfo;              ///< Core info
  HYGON_SMBIOS_SERVICES_GET_CACHE_DMI_INFO    GetCacheDmiInfo;             ///< Cache info
};

///
/// Forward declaration for the HYGON_MEM_SMBIOS_SERVICES_PROTOCOL.
///
typedef struct _HYGON_MEM_SMBIOS_SERVICES_PROTOCOL HYGON_MEM_SMBIOS_SERVICES_PROTOCOL;

typedef
EFI_STATUS
(EFIAPI *HYGON_SMBIOS_SERVICES_GET_MEM_DMI_INFO)(
  IN       HYGON_MEM_SMBIOS_SERVICES_PROTOCOL       *This,
...
///
struct _HYGON_MEM_SMBIOS_SERVICES_PROTOCOL {
  UINTN                                     Revision;                      ///< Revision Number
  HYGON_SMBIOS_SERVICES_GET_MEM_DMI_INFO    GetMemDmiInfo;                 ///< Pointer to Memory DMI info
};

#define SMBIOS_3_0_0  300
#define SMBIOS_3_1_1  311

extern EFI_GUID  gHygonCcxSmbiosServicesProtocolGuid;
extern EFI_GUID  gHygonMemSmbiosServicesProtocolGuid;

#pragma pack (pop)
#endif // _HYGON_SMBIOS_SERVICES_PROTOCOL_H_
