 ...
 * @file
 *
 * HYGON SRAT Services Protocol prototype definition
 *
 *
...
#ifndef _HYGON_ACPI_SRAT_SERVICES_PROTOCOL_H_
#define _HYGON_ACPI_SRAT_SERVICES_PROTOCOL_H_
...
///
/// Forward declaration for the HYGON_CCX_ACPI_SRAT_SERVICES_PROTOCOL.
///
typedef struct _HYGON_CCX_ACPI_SRAT_SERVICES_PROTOCOL HYGON_CCX_ACPI_SRAT_SERVICES_PROTOCOL;

typedef
EFI_STATUS
(EFIAPI *HYGON_SRAT_SERVICES_CREATE_LAPIC)(
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SRAT_SERVICES_CREATE_X2APIC)(
  IN       HYGON_CCX_ACPI_SRAT_SERVICES_PROTOCOL    *This,
  IN       SRAT_HEADER                            *SratHeaderStructPtr,
  IN OUT   UINT8                                 **TableEnd
  );
...
///
struct _HYGON_CCX_ACPI_SRAT_SERVICES_PROTOCOL {
  UINTN                                Revision;       ///< Revision Number
  HYGON_SRAT_SERVICES_CREATE_LAPIC     CreateLapic;    ///< Create Processor Local APIC/SAPIC Affinity Structure
  HYGON_SRAT_SERVICES_CREATE_X2APIC    CreateX2Apic;   ///< Create Processor X2 APIC Affinity Structure
};
...
///
typedef struct _HYGON_FABRIC_ACPI_SRAT_SERVICES_PROTOCOL HYGON_FABRIC_ACPI_SRAT_SERVICES_PROTOCOL;

typedef
EFI_STATUS
(EFIAPI *HYGON_SRAT_SERVICES_CREATE_MEMORY)(
  IN       HYGON_FABRIC_ACPI_SRAT_SERVICES_PROTOCOL     *This,
  IN       SRAT_HEADER                                *SratHeaderStructPtr,
  IN OUT   UINT8                                     **TableEnd
  );
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SRAT_SERVICES_GET_MEMORY_INFO)(
  IN       HYGON_FABRIC_ACPI_SRAT_SERVICES_PROTOCOL     *This,
...
/// services that return various information to generate SRAT
///
struct _HYGON_FABRIC_ACPI_SRAT_SERVICES_PROTOCOL {
  UINTN                                  Revision;      ///< Revision Number
  HYGON_SRAT_SERVICES_CREATE_MEMORY      CreateMemory;  ///< Create Memory Affinity Structure
  HYGON_SRAT_SERVICES_GET_MEMORY_INFO    GetMemoryInfo; ///< Return Memory Affinity Information
};

extern EFI_GUID  gHygonCcxAcpiSratServicesProtocolGuid;
extern EFI_GUID  gHygonFabricAcpiSratServicesProtocolGuid;

#pragma pack (pop)
#endif // _HYGON_ACPI_SRAT_SERVICES_PROTOCOL_H_
