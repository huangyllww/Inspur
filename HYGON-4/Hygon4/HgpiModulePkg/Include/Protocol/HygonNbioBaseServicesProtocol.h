...
#define HYGON_NBIO_DEBUG_OPTION_SERVICES_DXE_REVISION  0x00

///
/// Forward declaration for the NBIO_BASE_SERVICES_PROTOCOL
///
typedef struct _DXE_HYGON_NBIO_DEBUG_SERVICES_PROTOCOL DXE_HYGON_NBIO_DEBUG_SERVICES_PROTOCOL;
...
///
struct _DXE_HYGON_NBIO_DEBUG_SERVICES_PROTOCOL {
  UINT32                               Revision;        ///< revision
  HYGON_NBIO_DEBUG_GET_DEBUG_CONFIG    DebugGetConfig;  ///<
};

extern EFI_GUID  gHygonNbioDebugServicesProtocolGuid;
