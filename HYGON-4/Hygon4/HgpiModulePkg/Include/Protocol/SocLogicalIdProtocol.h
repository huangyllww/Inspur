...
///
/// Forward declaration for the HYGON_SOC_LOGICAL_ID_PROTOCOL.
///
typedef struct _HYGON_SOC_LOGICAL_ID_PROTOCOL HYGON_SOC_LOGICAL_ID_PROTOCOL;
 ...
 *
 * @param[in]  This                           A pointer to the HYGON_SOC_LOGICAL_ID_PROTOCOL instance.
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SOC_LOGICAL_ID_GET_LOGICAL_ID_ON_CURRENT_CORE)(
  IN    HYGON_SOC_LOGICAL_ID_PROTOCOL                     *This,
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SOC_LOGICAL_ID_GET_LOGICAL_ID_ON_GIVEN_SOCKET)(
  IN    HYGON_SOC_LOGICAL_ID_PROTOCOL                     *This,
  IN    UINTN                                           Socket,
  OUT   SOC_LOGICAL_ID                                  *LogicalId
  );
...
/// processors.
///
typedef struct _HYGON_SOC_LOGICAL_ID_PROTOCOL {
  UINTN                                                  Revision;                  ///< Revision Number
  HYGON_SOC_LOGICAL_ID_GET_LOGICAL_ID_ON_CURRENT_CORE    GetLogicalIdOnCurrentCore; ///< Get logical revision of the executing core
  HYGON_SOC_LOGICAL_ID_GET_LOGICAL_ID_ON_GIVEN_SOCKET    GetLogicalIdOnGivenSocket; ///< Get logical revision of the given socket
} HYGON_SOC_LOGICAL_ID_PROTOCOL;

extern EFI_GUID  gHygonSocLogicalIdProtocolGuid;
