 ...
 * @file
 *
 * HYGON CRAT Services Protocol prototype definition
 *
 *
...
#ifndef _HYGON_ACPI_CRAT_SERVICES_PROTOCOL_H_
#define _HYGON_ACPI_CRAT_SERVICES_PROTOCOL_H_
...
///
/// Forward declaration for the HYGON_CCX_ACPI_CRAT_SERVICES_PROTOCOL.
///
typedef struct _HYGON_CCX_ACPI_CRAT_SERVICES_PROTOCOL HYGON_CCX_ACPI_CRAT_SERVICES_PROTOCOL;

typedef
EFI_STATUS
(EFIAPI *HYGON_CRAT_SERVICES_GET_HSA_PROC_CCX_ENTRY)(
...
typedef
EFI_STATUS
(EFIAPI *HYGON_CRAT_SERVICES_GET_CACHE_ENTRY)(
  IN       HYGON_CCX_ACPI_CRAT_SERVICES_PROTOCOL    *This,
  IN       CRAT_HEADER                            *CratHeaderStructPtr,
  IN OUT   UINT8                                 **TableEnd
  );
...
typedef
EFI_STATUS
(EFIAPI *HYGON_CRAT_SERVICES_GET_TLB_ENTRY)(
  IN       HYGON_CCX_ACPI_CRAT_SERVICES_PROTOCOL    *This,
  IN       CRAT_HEADER                            *CratHeaderStructPtr,
  IN OUT   UINT8                                 **TableEnd
  );
...
///
struct _HYGON_CCX_ACPI_CRAT_SERVICES_PROTOCOL {
  UINTN                                         Revision;                   ///< Revision Number
  HYGON_CRAT_SERVICES_GET_HSA_PROC_CCX_ENTRY    GetCratHsaProcCcxEntry;     ///< HSA processor info --- Ccx part
  HYGON_CRAT_SERVICES_GET_CACHE_ENTRY           GetCratCacheEntry;          ///< Cache info
  HYGON_CRAT_SERVICES_GET_TLB_ENTRY             GetCratTlbEntry;            ///< TLB info
};
...
///
/// Forward declaration for the HYGON_FABRIC_ACPI_CRAT_SERVICES_PROTOCOL.
///
typedef struct _HYGON_FABRIC_ACPI_CRAT_SERVICES_PROTOCOL HYGON_FABRIC_ACPI_CRAT_SERVICES_PROTOCOL;

typedef
EFI_STATUS
(EFIAPI *HYGON_CRAT_SERVICES_CREATE_MEMORY)(
  IN       HYGON_FABRIC_ACPI_CRAT_SERVICES_PROTOCOL     *This,
  IN       CRAT_HEADER                                *CratHeaderStructPtr,
  IN OUT   UINT8                                     **TableEnd
  );
...
/// services that return various information to generate CRAT
///
struct _HYGON_FABRIC_ACPI_CRAT_SERVICES_PROTOCOL {
  UINTN                                Revision;       ///< Revision Number
  HYGON_CRAT_SERVICES_CREATE_MEMORY    CreateMemory;   ///< Create Memory Affinity Structure
};
...
///
/// Forward declaration for the HYGON_IGPU_ACPI_CRAT_SERVICES_PROTOCOL.
///
typedef struct _HYGON_IGPU_ACPI_CRAT_SERVICES_PROTOCOL HYGON_IGPU_ACPI_CRAT_SERVICES_PROTOCOL;

typedef
EFI_STATUS
(EFIAPI *HYGON_CRAT_SERVICES_GET_HSA_PROC_IGPU_ENTRY)(
  IN       HYGON_IGPU_ACPI_CRAT_SERVICES_PROTOCOL    *This,
...
/// services that return various information to generate CRAT
///
struct _HYGON_IGPU_ACPI_CRAT_SERVICES_PROTOCOL {
  UINTN                                          Revision;                  ///< Revision Number
  HYGON_CRAT_SERVICES_GET_HSA_PROC_IGPU_ENTRY    GetCratHsaProcIGpuEntry;   ///< HSA processor info --- IGPU part
};

extern EFI_GUID  gHygonCcxAcpiCratServicesProtocolGuid;
extern EFI_GUID  gHygonFabricAcpiCratServicesProtocolGuid;
extern EFI_GUID  gHygonIGpuAcpiCratServicesProtocolGuid;

#pragma pack (pop)
#endif // _HYGON_ACPI_CRAT_SERVICES_PROTOCOL_H_
