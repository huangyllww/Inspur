 ...
 * @file
 *
 * HYGON MSCT Services Protocol prototype definition
 *
 *
...
#ifndef _HYGON_ACPI_MSCT_SERVICES_PROTOCOL_H_
#define _HYGON_ACPI_MSCT_SERVICES_PROTOCOL_H_
...
/// Forward declaration for HYGON_FABRIC_ACPI_MSCT_SERVICES_PROTOCOL
typedef struct _HYGON_FABRIC_ACPI_MSCT_SERVICES_PROTOCOL HYGON_FABRIC_ACPI_MSCT_SERVICES_PROTOCOL;

typedef
EFI_STATUS
(EFIAPI *HYGON_MSCT_SERVICES_GET_MSCT_INFO)(
...
struct _HYGON_FABRIC_ACPI_MSCT_SERVICES_PROTOCOL {
  UINTN                                Revision;                                    ///< Revision Number
  HYGON_MSCT_SERVICES_GET_MSCT_INFO    GetMsctInfo;                                 ///< Returns information to populate MSCT maximum proximity structures
};

extern EFI_GUID  gHygonFabricAcpiMsctServicesProtocolGuid;

#pragma pack (pop)
#endif // _HYGON_ACPI_MSCT_SERVICES_PROTOCOL_H_
