...
#ifndef _HYGON_ACPI_CPU_SSDT_SERVICES_PROTOCOL_H_
#define _HYGON_ACPI_CPU_SSDT_SERVICES_PROTOCOL_H_
#pragma pack (push, 1)
...
typedef struct {
  ...
  IN OUT   UINT32             TotalLogicalCores;                       ///< Logical core number in this socket
  IN OUT   BOOLEAN            CreateAcpiTables;                        ///< Create table flag
  IN OUT   UINT32             LocalApicId[MAX_CORE_NUMBER_PER_SOCKET]; ///< Local Apic Id
...
typedef struct {
  ...
  IN OUT   HYGON_PSTATE_SOCKET_INFO    PStateSocketStruct[1]; ///< P state structure for socket
} HYGON_PSTATE_SYS_INFO;
...
///
typedef struct _HYGON_ACPI_CPU_SSDT_SERVICES_PROTOCOL HYGON_ACPI_CPU_SSDT_SERVICES_PROTOCOL;

typedef
EFI_STATUS
(EFIAPI *HYGON_SSDT_SERVICES_GET_PSTATE_INFO)(
...
typedef
EFI_STATUS
(EFIAPI *HYGON_SSDT_SERVICES_GET_CSTATE_INFO)(
  IN       HYGON_ACPI_CPU_SSDT_SERVICES_PROTOCOL    *This,
...
typedef
UINT32
(EFIAPI *HYGON_SSDT_SERVICES_GET_PSD_DOMAIN_FOR_INDEP)(
  IN       HYGON_ACPI_CPU_SSDT_SERVICES_PROTOCOL    *This,
...
///
struct _HYGON_ACPI_CPU_SSDT_SERVICES_PROTOCOL {
  UINTN                                           Revision;                ///< Revision Number
  HYGON_SSDT_SERVICES_GET_PSTATE_INFO             GetPstateInfo;           ///< Get Pstate information for whole system
  HYGON_SSDT_SERVICES_GET_CSTATE_INFO             GetCstateInfo;           ///< Get Cstate information
  HYGON_SSDT_SERVICES_GET_PSD_DOMAIN_FOR_INDEP    GetPsdDomain;            ///< Get PDS domain for independency
};

extern EFI_GUID  gHygonAcpiCpuSsdtServicesProtocolGuid;

#pragma pack (pop)
#endif // _HYGON_ACPI_CPU_SSDT_SERVICES_PROTOCOL_H_
