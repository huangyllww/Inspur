...
#ifndef _HYGON_PSP_COMMONSERVICE_PROTOCOL_H_
#define _HYGON_PSP_COMMONSERVICE_PROTOCOL_H_
...
// PROTOCOL prototype
//
// Defines HYGON_PSP_COMMON_SERVICE_PROTOCOL, which public the common PSP service across all programs
//

/// Define PSP_FTPM_PROTOCOL
typedef struct _HYGON_PSP_COMMON_SERVICE_PROTOCOL {
...
} HYGON_PSP_COMMON_SERVICE_PROTOCOL;

extern EFI_GUID  gHygonPspCommonServiceProtocolGuid;

#endif //_HYGON_PSP_COMMONSERVICE_PROTOCOL_H_
