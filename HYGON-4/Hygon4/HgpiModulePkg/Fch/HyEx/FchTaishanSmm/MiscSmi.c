...
//  UINT8          *pData;
  ...
  bData = 0xff;
  LibHygonIoWrite (AccessWidth8, 0xb00, &bData, NULL);
  LibHygonIoRead (AccessWidth8, 0xb04, &bData, NULL);

  LibHygonIoWrite (AccessWidth8, 0xb04, &bData, NULL);
  //LibHygonIoWrite (AccessWidth8, 0x80, &bData, NULL);
