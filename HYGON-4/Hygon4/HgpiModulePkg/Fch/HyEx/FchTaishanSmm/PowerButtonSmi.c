...
{
  EFI_STATUS                         Status;
  FCH_SMM_PWRBTN_DISPATCH2_PROTOCOL  *HygonPwrBtnDispatch;
  FCH_SMM_PWRBTN_REGISTER_CONTEXT    HygonPowerButtonContext;
  ...
  HygonPowerButtonContext.Phase = EfiPowerButtonExit;
  HygonPowerButtonContext.Order = 0xFF;
  Status = HygonPwrBtnDispatch->Register (
                                  HygonPwrBtnDispatch,
                                  HygonSmiPowerButtonCallback,
                                  &HygonPowerButtonContext,
                                  &PowerButtonHandle
                                  );

  HygonPowerButtonContext.Phase = EfiPowerButtonEntry;
  HygonPowerButtonContext.Order = 0x89;
  Status = HygonPwrBtnDispatch->Register (
                                  HygonPwrBtnDispatch,
