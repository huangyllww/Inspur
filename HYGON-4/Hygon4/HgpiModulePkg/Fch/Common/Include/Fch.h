...
/**
 * @page fchinitguide FCH implement phase in HGPI
 *
 ...
 *  @par
 *     HGPI_STATUS FchInitReset (IN HYGON_RESET_PARAMS *ResetParams);
 ...
 *  @par
 *     HGPI_STATUS FchInitEnv (IN HYGON_ENV_PARAMS *EnvParams);
 ...
 *  @par
 *     HGPI_STATUS FchInitMid (IN HYGON_MID_PARAMS *MidParams);
 ...
 *  @par
 *     HGPI_STATUS FchInitLate (IN FCH_DATA_BLOCK *LateParams);
...
#define FCH_SATA_HYGONAHCI_DID      0x7904
...
#define R_FCH_ACPI_EVENT_STATUS       0x14
#define R_FCH_ACPI_EVENT_ENABLE       0x18
...
#define SMBUS_BUS_DEV_FUN  ((0x0B << 3) + 0)
#define FCH_ISA_BUS        0
#define FCH_ISA_DEV        11
#define FCH_ISA_FUNC       0
#define IDE_BUS_DEV_FUN    ((0x0B << 3) + 1)
#define FCH_IDE_BUS        0
#define FCH_IDE_DEV        11
#define FCH_IDE_FUNC       1
#define LPC_BUS_DEV_FUN    ((0x0B << 3) + 3)
#define FCH_LPC_BUS        0
#define FCH_LPC_DEV        11
#define FCH_LPC_FUNC       3
#define PCIB_BUS_DEV_FUN   ((0x0B << 3) + 4)             // P2P in SB700
#define FCH_PCI_BUS        0
#define FCH_PCI_DEV        11
...
#define REMOTE_GPIO_BANK0_BASE  0x1200
...
#define FCH_PMIOA_REG70  0x70                 // WarmResetControl
...
#define FCH_GPIO_REG29   0x1D
#define FCH_GPIO_REG30   0x1E
#define FCH_GPIO_REG31   0x1F
...
#define FCH_GPIO_REG256  0xC0
#define FCH_GPIO_REG257  0xC1
#define FCH_GPIO_REG258  0xC2
#define FCH_GPIO_REG259  0xC3
#define FCH_GPIO_REG260  0xC4
#define FCH_GPIO_REG261  0xC5
#define FCH_GPIO_REG262  0xC6
#define FCH_GPIO_REG263  0xC7
#define FCH_GPIO_REG264  0xC8
#define FCH_GPIO_REG265  0xC9
#define FCH_GPIO_REG266  0xCA
#define FCH_GPIO_REG267  0xCB
#define FCH_GPIO_REG272  0xD0
#define FCH_GPIO_REG273  0xD1
...
#define FCH_MISC_REG80  0x80                 /**< FCH_MISC_REG80
                                   ...
                                   *    @li <b>0001</b> - SVI2_Function
                                   *    @li <b>0002</b> - UseLpcRomStrap
                                   *    @li <b>0004</b> - Refclk_Bypass_CGPLL
                                   *    @li <b>0008</b> - USE_EXTERNAL_REFCLK
                                   *    @li <b>0010</b> - LPC_Pad_Function
                                   */
...
#define FCH_SPI_MMIO_REG50_ADDR32_CTRL1  0x54            //
#define FCH_SPI_MMIO_REG50_ADDR32_CTRL2  0x58            //
...
#define HYGON_NB_REG78    0x78
#define HYGON_NB_SCRATCH  HYGON_NB_REG78
...
#define XHCI_ACPI_MMIO_HYGON_REG00  0x00
#define XHCI_ACPI_MMIO_HYGON_REG04  0x04
#define XHCI_ACPI_MMIO_HYGON_REG08  0x08
#define XHCI_ACPI_MMIO_HYGON_REG10  0x10
#define XHCI_ACPI_MMIO_HYGON_REG14  0x14
#define XHCI_ACPI_MMIO_HYGON_REG18  0x18
#define XHCI_ACPI_MMIO_HYGON_REG20  0x20
#define XHCI_ACPI_MMIO_HYGON_REG24  0x24
#define XHCI_ACPI_MMIO_HYGON_REG28  0x28
#define XHCI_ACPI_MMIO_HYGON_REG2C  0x2C
#define XHCI_ACPI_MMIO_HYGON_REG30  0x30
#define XHCI_ACPI_MMIO_HYGON_REG40  0x40
#define XHCI_ACPI_MMIO_HYGON_REG48  0x48    // USB3.0_Ind_REG Index
#define XHCI_ACPI_MMIO_HYGON_REG4C  0x4C    // USB2.0_Ind_REG Data
#define XHCI_ACPI_MMIO_HYGON_REG8C  0x8C
#define XHCI_ACPI_MMIO_HYGON_REG90  0x90    // adaptation timer settings
#define XHCI_ACPI_MMIO_HYGON_REG98  0x98
#define XHCI_ACPI_MMIO_HYGON_REGA0  0xA0    // BAR 0
#define XHCI_ACPI_MMIO_HYGON_REGA4  0xA4    // BAR 1
#define XHCI_ACPI_MMIO_HYGON_REGA8  0xA8    // BAR 2
#define XHCI_ACPI_MMIO_HYGON_REGB0  0xB0    // SPI_Valid_Base.
#define XHCI_ACPI_MMIO_HYGON_REGC0  0xC0    // Firmware starting offset for coping
#define XHCI_ACPI_MMIO_HYGON_REGB4  0xB4
#define XHCI_ACPI_MMIO_HYGON_REGD0  0xD0
