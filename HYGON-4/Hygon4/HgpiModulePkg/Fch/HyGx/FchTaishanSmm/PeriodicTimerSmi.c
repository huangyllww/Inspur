...
{
  EFI_STATUS                             Status;
  FCH_SMM_PERIODICAL_DISPATCH2_PROTOCOL  *HygonPeriodicalDispatch;
  ...
  if (FchMisc->LongTimer.Enable) {
    ...
    mLongTimerCounter = 0;
    Status = HygonPeriodicalDispatch->Register (
                                        HygonPeriodicalDispatch,
                                        HygonSmiLongTimerCallback,
