...
typedef struct {
  ...
  UINT32          SataSgpio;                            /// SataSgpio - Reserved
...
typedef struct {
  ...
  UINT64     XhciEnable;                                ///< XHCI controller enable
...
typedef struct {
  ...
  IN       UINT64     XhciEnable;            ///< XHCI controller function
                                             ///< bit0~bit7  - Socket0 DJ0~3 USB[1:0]
                                             ///< bit8~bit15 - Socket1 DJ0~3 USB[1:0]
                                             ///< bit23~bit16- Socket2 DJ0~3 USB[1:0]
                                             ///< bit31~bit24- Socket3 DJ0~3 USB[1:0]
                                             ///< bit39~bit32- Socket4 DJ0~3 USB[1:0]
                                             ///< bit47~bit40- Socket5 DJ0~3 USB[1:0]
                                             ///< bit55~bit48- Socket6 DJ0~3 USB[1:0]
                                             ///< bit63~bit56- Socket7 DJ0~3 USB[1:0]
...
typedef struct _HYGON_USB_DISABLE_MAP {
  UINT8    SocketNum;
  UINT8    PhysicalDieId;
  UINT8    UsbDisableMap[USB_NUMBER_PER_DUJIANG];
