...
{
  FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_CLK_GATE_HYGX + Port * 4), ~(UINT32)BIT0, BIT0, NULL);
}
  ...
  )
{
  ...
  SystemPort &= 0xFF;
  FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_PROPERTY0_HYGX + PortNum * 0x20), 0xFFFFFF00, SystemPort, NULL);
  ...
  FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_PROPERTY0_HYGX + PortNum * 0x20), 0x0870F0FF, XgbePortProperty, NULL);
  ...
  if (FchXgbePort->XgbePortConnectedType == 1) {
    ...
    FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_PROPERTY3_HYGX + PortNum * 0x20), 0x000008FF, XgbePortProperty, NULL);
    ...
    FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_PROPERTY4_HYGX + PortNum * 0x20), 0x000008FF, XgbePortProperty, NULL);
    ...
    FchSmnRW (
      DieBusNum,
      NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PAD_MUX0_HYGX),
    ...
    FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_PROPERTY0_HYGX + PortNum * 0x20), 0xFFF0FFFF, XgbePortProperty, NULL);
    ...
    if (FchXgbePort->XgbePortMdioResetType == 1) {
      ...
      FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_PROPERTY3_HYGX + PortNum * 0x20), 0xFFFF08FC, XgbePortProperty, NULL);
      ...
      FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_PROPERTY3_HYGX + PortNum * 0x20), 0xFFFFFFCC, XgbePortProperty, NULL);

      // GPIO PAD
      FchSmnRW (
        DieBusNum,
        NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PAD_MUX1_HYGX),
        ~(UINT32)(0x0F << (PortNum * 8)),
  ...
  if (FchXgbePort->XgbaPortRedriverPresent) {
    ...
    FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_PROPERTY4_HYGX + PortNum * 0x20), 0x0000FFFF, XgbePortProperty, NULL);
  }
}
  ...
  )
{
  ...
  FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_MAC_ADDR_LOW_HYGX + PortNum * 0x8), 0x00, FchXgbeMacAddress, NULL);

  FchXgbeMacAddress  = FchXgbePortMac->XgbePortMacAddressHigh;
  FchXgbeMacAddress &= 0xFFFF;
  FchXgbeMacAddress |= BIT31;
  FchSmnRW (DieBusNum, NBIO_SPACE2 (PhysicalDieId, 0, FCH_TS_XGBE_PORT0_MAC_ADDR_HIGH_HYGX + PortNum * 0x8), 0x00, FchXgbeMacAddress, NULL);
}
