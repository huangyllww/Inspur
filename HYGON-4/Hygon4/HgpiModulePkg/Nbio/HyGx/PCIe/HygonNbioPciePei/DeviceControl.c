...
#define FILECODE  NBIO_PCIE_HYGX_HYGONNBIOPCIESTPEI_DEVICECONTROLST_FILECODE
    ...
    switch (DeviceType) {
      case HsioNTBDevice:
        NbioRegisterRMW (
          GnbHandle,
          TYPE_SMN,
          NBIO_SPACE (GnbHandle, NBIF0_NTB_STRAP0_ADDRESS_HYGX),
      ...
      case HsioSATAEngine:
        if (LaneIndex <= 7) {
          NbioRegisterRMW (
            GnbHandle,
            TYPE_SMN,
            NBIO_SPACE (GnbHandle, NBIF2_SATA_STRAP0_ADDRESS_HYGX),
            (UINT32) ~(NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK),
            (1 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET),
            0
            );
          NbioRegisterRMW (
            GnbHandle,
            NBIFMISC_INTR_LINE_ENABLE_TYPE,
            NBIO_SPACE (GnbHandle, NBIFMISC2_INTR_LINE_ENABLE_ADDRESS_HYGX),
            (UINT32) ~(1 << 2),
            (1 << 2),
            0
            );
        ...
        switch (LaneIndex) {
          case 4:
            NbioRegisterRMW (
              GnbHandle,
              TYPE_SMN,
              NBIO_SPACE (GnbHandle, NBIF2_XGBE0_STRAP0_ADDRESS_HYGX),
              (UINT32) ~(NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK),
              (1 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET),
              0
              );
          ...
          case 6:
            NbioRegisterRMW (
              GnbHandle,
              TYPE_SMN,
              NBIO_SPACE (GnbHandle, NBIF2_XGBE2_STRAP0_ADDRESS_HYGX),
              (UINT32) ~(NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK),
              (1 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET),
              0
              );
          ...
          case 7:
            NbioRegisterRMW (
              GnbHandle,
              TYPE_SMN,
              NBIO_SPACE (GnbHandle, NBIF2_XGBE3_STRAP0_ADDRESS_HYGX),
              (UINT32) ~(NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK),
              (1 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET),
              0
              );
