  ...
  )
{
  ...
  Pcie0MapCounter = 0;
  Pcie1MapCounter = 0;
  Address = PCIE0_LC_CNTL_ADDRESS_HYGX;
  Index   = 0;
  ...
  if (Pcie0Cntl != Pcie1Cntl) {
    NbioRegisterRead (GnbHandle, TYPE_SMN, NBIO_SPACE (GnbHandle, PCIE0_NBIO_CLKREQb_MAP_CNTL_ADDRESS_HYGX), &NBIO_CLKREQb_MAP_CNTL0, 0);
    if (Pcie0Cntl) {
      ...
      Address = NBIO_SPACE (GnbHandle, PCIE0_LC_CNTL_ADDRESS_HYGX);
    }

    NbioRegisterWrite (GnbHandle, TYPE_SMN, NBIO_SPACE (GnbHandle, PCIE0_NBIO_CLKREQb_MAP_CNTL_ADDRESS_HYGX), &NBIO_CLKREQb_MAP_CNTL0, GNB_REG_ACC_FLAG_S3SAVE);
