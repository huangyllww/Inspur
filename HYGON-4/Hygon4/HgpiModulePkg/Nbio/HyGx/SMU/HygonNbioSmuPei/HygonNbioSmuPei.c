...
#define FILECODE  NBIO_SMU_HYGX_HYGONNBIOSMUPEI_HYGONNBIOSMUPEI_FILECODE
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (MAIN_FLOW, "HygonNbioSmuHyGxPeiEntry Entry\n");
  ...
  IDS_HDT_CONSOLE (MAIN_FLOW, "HygonNbioSmuHyGxPeiEntry Exit\n");
