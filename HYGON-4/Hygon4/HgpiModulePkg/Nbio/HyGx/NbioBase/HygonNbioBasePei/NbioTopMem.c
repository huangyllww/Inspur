...
#define FILECODE  NBIO_NBIOBASE_HYGX_HYGONNBIOBASEPEI_NBIOTOPMEM_FILECODE
  ...
  )
{
  ...
  while (GnbHandle != NULL) {
    ...
    NbioRegisterRead (
      GnbHandle,
      NB_TOP_OF_DRAM_SLOT1_TYPE,
      NB_TOP_OF_DRAM_SLOT1_ADDRESS,
      &NB_TOP_OF_DRAM_SLOT1.Value,
      0
      );
    NbioRegisterRead (
      GnbHandle,
      NB_LOWER_TOP_OF_DRAM2_TYPE,
      NBIO_SPACE (GnbHandle, NB_LOWER_TOP_OF_DRAM2_ADDRESS_HYGX),
      &NBMISC_0064.Value,
      0
      );
    NbioRegisterRead (
      GnbHandle,
      NB_UPPER_TOP_OF_DRAM2_TYPE,
      NBIO_SPACE (GnbHandle, NB_UPPER_TOP_OF_DRAM2_ADDRESS_HYGX),
      &NBMISC_0068.Value,
      0
      );
    ...
    NbioRegisterWrite (
      GnbHandle,
      NB_TOP_OF_DRAM3_EXT_TYPE,
      NBIO_SPACE (GnbHandle, NB_TOP_OF_DRAM3_EXT_ADDRESS_HYGX),
      &NBMISC_013C.Value,
      0
      );
    NbioRegisterWrite (
      GnbHandle,
      NB_TOP_OF_DRAM3_TYPE,
      NBIO_SPACE (GnbHandle, NB_TOP_OF_DRAM3_ADDRESS_HYGX),
      &NBMISC_0138.Value,
      0
      );
    NbioRegisterWrite (GnbHandle, NB_MMIOBASE_TYPE, NBIO_SPACE (GnbHandle, NB_MMIOBASE_ADDRESS_HYGX), &NB_MMIOBASE.Value, 0);
    NbioRegisterWrite (
      GnbHandle,
      NB_MMIOLIMIT_TYPE,
      NBIO_SPACE (GnbHandle, NB_MMIOLIMIT_ADDRESS_HYGX),
      &NB_MMIOLIMIT.Value,
      0
      );
    NbioRegisterRMW (
      GnbHandle,
      NB_PCI_CTRL_TYPE,
      NBIO_SPACE (GnbHandle, NB_PCI_CTRL_ADDRESS_HYGX),
