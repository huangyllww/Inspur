...
GNB_TABLE ROMDATA IommuInitSequenceHyEx[] = {
  // Disable INTx
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOMMU_CONTROL_W_ADDRESS_HYEX,
  ...
  GNB_ENTRY_COPY (
    TYPE_SMN,
    L2_SB_LOCATION_ADDRESS_HYEX,
    0,
    32,
    SB_LOCATION_TYPE,
    SB_LOCATION_ADDRESS_HYEX,
    0,
    32
    ),
  ...
  GNB_ENTRY_COPY (
    TYPE_SMN,
    L1_SB_LOCATION_IOAGR_ADDRESS_HYEX,
    0,
    32,
    SB_LOCATION_TYPE,
    SB_LOCATION_ADDRESS_HYEX,
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOMMU_MMIO_CONTROL1_W_ADDRESS_HYEX,
  ...
  GNB_ENTRY_RMW (
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_MISC_CNTRL_1_PCIE0_ADDRESS_HYEX,
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_MISC_CNTRL_1_PCIE1_ADDRESS_HYEX,
      L1_MISC_CNTRL_1_REG_enable_nw_MASK |
      L1_MISC_CNTRL_1_REG_disble_eco_invaldation_0_MASK |
      L1_MISC_CNTRL_1_REG_Block_On_4K_wait_dis_MASK,
      (0x1 << L1_MISC_CNTRL_1_REG_enable_nw_OFFSET) |
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_MISC_CNTRL_1_NBIF0_ADDRESS_HYEX,
      L1_MISC_CNTRL_1_REG_enable_nw_MASK |
      L1_MISC_CNTRL_1_REG_disble_eco_invaldation_0_MASK |
      L1_MISC_CNTRL_1_REG_Block_On_4K_wait_dis_MASK,
      (0x1 << L1_MISC_CNTRL_1_REG_enable_nw_OFFSET) |
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_MISC_CNTRL_1_IOAGR_ADDRESS_HYEX,
      L1_MISC_CNTRL_1_REG_enable_nw_MASK |
      L1_MISC_CNTRL_1_REG_disble_eco_invaldation_0_MASK |
      L1_MISC_CNTRL_1_REG_Block_On_4K_wait_dis_MASK,
      (0x1 << L1_MISC_CNTRL_1_REG_enable_nw_OFFSET) |
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_FEATURE_CNTRL_PCIE0_ADDRESS_HYEX,
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_FEATURE_CNTRL_PCIE1_ADDRESS_HYEX,
      L1_FEATURE_CNTRL_EXE_lock_bit_MASK |
      L1_FEATURE_CNTRL_PMR_lock_bit_MASK,
      1 << L1_FEATURE_CNTRL_EXE_lock_bit_OFFSET |
      1 << L1_FEATURE_CNTRL_PMR_lock_bit_OFFSET
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_FEATURE_CNTRL_NBIF0_ADDRESS_HYEX,
      L1_FEATURE_CNTRL_EXE_lock_bit_MASK |
      L1_FEATURE_CNTRL_PMR_lock_bit_MASK,
      1 << L1_FEATURE_CNTRL_EXE_lock_bit_OFFSET |
      1 << L1_FEATURE_CNTRL_PMR_lock_bit_OFFSET
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_FEATURE_CNTRL_IOAGR_ADDRESS_HYEX,
      L1_FEATURE_CNTRL_EXE_lock_bit_MASK |
      L1_FEATURE_CNTRL_PMR_lock_bit_MASK,
      1 << L1_FEATURE_CNTRL_EXE_lock_bit_OFFSET |
      1 << L1_FEATURE_CNTRL_PMR_lock_bit_OFFSET
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_CNTRL_0_PCIE0_ADDRESS_HYEX,
      L1_CNTRL_0_Unfilter_dis_MASK,
      1 << L1_CNTRL_0_Unfilter_dis_OFFSET
      ),
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_CNTRL_0_PCIE1_ADDRESS_HYEX,
      L1_CNTRL_0_Unfilter_dis_MASK,
      1 << L1_CNTRL_0_Unfilter_dis_OFFSET
      ),
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_CNTRL_0_NBIF0_ADDRESS_HYEX,
      L1_CNTRL_0_Unfilter_dis_MASK,
      1 << L1_CNTRL_0_Unfilter_dis_OFFSET
      ),
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L1_CNTRL_0_IOAGR_ADDRESS_HYEX,
      L1_CNTRL_0_Unfilter_dis_MASK,
      1 << L1_CNTRL_0_Unfilter_dis_OFFSET
      ), 
    /*
    ...
    */
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L2_ERR_RULE_CONTROL_0_ADDRESS_HYEX,
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L2_ERR_RULE_CONTROL_3_ADDRESS_HYEX,
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L2_L2A_PGSIZE_CONTROL_ADDRESS_HYEX,
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L2_L2B_PGSIZE_CONTROL_ADDRESS_HYEX,
    ...
    */
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L2B_UPDATE_FILTER_CNTL_ADDRESS_HYEX,
    ...
    GNB_ENTRY_RMW (
      TYPE_SMN,
      L2A_UPDATE_FILTER_CNTL_ADDRESS_HYEX,
    ...
    */
    ...
    GNB_ENTRY_PROPERTY_RMW (
      ...
      TYPE_SMN,
      L1_CLKCNTRL_0_IOAGR_ADDRESS_HYEX,
    ...
    GNB_ENTRY_PROPERTY_RMW (
      TABLE_PROPERTY_IOMMU_L1_CLOCK_GATING,
      TYPE_SMN,
      L1_CLKCNTRL_0_NBIF0_ADDRESS_HYEX,
      L1_CLKCNTRL_0_L1_CLKGATE_HYSTERESIS_MASK |
      L1_CLKCNTRL_0_L1_DMA_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_CACHE_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_CPSLV_CLKGATE_EN_MASK |
      L1_CLKCNTRL_0_L1_PERF_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_MEMORY_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_REG_CLKGATE_EN_MASK |
      L1_CLKCNTRL_0_L1_HOSTREQ_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_DMARSP_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_HOSTRSP_CLKGATE_EN_MASK |
    ...
    GNB_ENTRY_PROPERTY_RMW (
      TABLE_PROPERTY_IOMMU_L1_CLOCK_GATING,
      TYPE_SMN,
      L1_CLKCNTRL_0_PCIE0_ADDRESS_HYEX,
      L1_CLKCNTRL_0_L1_CLKGATE_HYSTERESIS_MASK |
      L1_CLKCNTRL_0_L1_DMA_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_CACHE_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_CPSLV_CLKGATE_EN_MASK |
      L1_CLKCNTRL_0_L1_PERF_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_MEMORY_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_REG_CLKGATE_EN_MASK |
      L1_CLKCNTRL_0_L1_HOSTREQ_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_DMARSP_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_HOSTRSP_CLKGATE_EN_MASK |
    ...
    GNB_ENTRY_PROPERTY_RMW (
      TABLE_PROPERTY_IOMMU_L1_CLOCK_GATING,
      TYPE_SMN,
      L1_CLKCNTRL_0_PCIE1_ADDRESS_HYEX,
      L1_CLKCNTRL_0_L1_CLKGATE_HYSTERESIS_MASK |
      L1_CLKCNTRL_0_L1_DMA_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_CACHE_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_CPSLV_CLKGATE_EN_MASK |
      L1_CLKCNTRL_0_L1_PERF_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_MEMORY_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_REG_CLKGATE_EN_MASK |
      L1_CLKCNTRL_0_L1_HOSTREQ_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_DMARSP_CLKGATE_EN_MASK | L1_CLKCNTRL_0_L1_HOSTRSP_CLKGATE_EN_MASK |
    ...
    */
    ...
    GNB_ENTRY_PROPERTY_RMW (
      ...
      TYPE_SMN,
      L2_L2A_CK_GATE_CONTROL_ADDRESS_HYEX,
    ...
    */
    GNB_ENTRY_PROPERTY_RMW (
      TABLE_PROPERTY_IOMMU_L2_CLOCK_GATING,
      TYPE_SMN,
      L2_L2B_CK_GATE_CONTROL_ADDRESS_HYEX,
    ...
    GNB_ENTRY_PROPERTY_RMW (
      ...
      TYPE_SMN,
      L1_FEATURE_SUP_CNTRL_ADDRESS_HYEX,
