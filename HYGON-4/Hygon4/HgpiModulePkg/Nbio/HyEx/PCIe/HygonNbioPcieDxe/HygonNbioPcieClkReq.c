...
#define FILECODE NBIO_PCIE_HYGONNBIOPCIESTDXE_HYGONNBIOPCIECLKREQST_FILECODE
/*----------------------------------------------------------------------------------------
...
UINT8 ROMDATA DefaultClkReqMapCntlST [5][2] = {
  {0xFF, 0},    // CLKREQB_0
  {0xFF, 1},    // CLKREQB_1
  {0xFF, 2},    // CLKREQB_2
  {0xFF, 3},    // CLKREQB_3
...
UpdateClkReqMapCntl ()
{
  ...
  for (Index = 0; Index < 5; Index++) {
    IDS_HDT_CONSOLE (GNB_TRACE, "CLKREQB_%d: 0x%x - %d\n", Index, DefaultClkReqMapCntlST[Index][0], DefaultClkReqMapCntlST[Index][1]);
    if (DefaultClkReqMapCntlST[Index][0] != 0xFF) {
      for (Index1 = 0; Index1 < 5; Index1++) {
        if (DefaultClkReqMapCntlST[Index1][1] == DefaultClkReqMapCntlST[Index][0]) {
          DefaultClkReqMapCntlST[Index1][1] = DefaultClkReqMapCntlST[Index][1];
        }
      }
      DefaultClkReqMapCntlST[Index][1] = DefaultClkReqMapCntlST[Index][0];
      DefaultClkReqMapCntlST[Index][0] = 0xFF;
    }
  }
  for (Index = 0; Index < 5; Index++) {
    IDS_HDT_CONSOLE (GNB_TRACE, "CLKREQB_%d: 0x%x - %d\n", Index, DefaultClkReqMapCntlST[Index][0], DefaultClkReqMapCntlST[Index][1]);
  ...
  )
{
  ...
  Pcie0MapCounter = 0;
  Pcie1MapCounter = 0;
  Address = PCIE0_LC_CNTL_ADDRESS_HYEX;
  Index = 0;
          ...
          if (PcieEngine->Type.Port.ClkReq != 0) {
            if (PcieEngine->Type.Port.CoreId == 1) {
              ...
              if (Pcie1MapCounter < 5) {
                DefaultClkReqMapCntlST[PcieEngine->Type.Port.ClkReq - 1][0] = PcieEngine->Type.Port.PortId - 8;
              }
              Pcie1MapCounter++;
            } else if (PcieEngine->Type.Port.CoreId == 0) {
              Pcie0Cntl = TRUE;
              if (Pcie0MapCounter < 5) {
                DefaultClkReqMapCntlST[PcieEngine->Type.Port.ClkReq - 1][0] = PcieEngine->Type.Port.PortId;
              }
              Pcie0MapCounter++;
            }
          }
  ...
  UpdateClkReqMapCntl (DefaultClkReqMapCntlST[0][0]);

  if (Pcie0Cntl != Pcie1Cntl) {
    NbioRegisterRead ( GnbHandle, TYPE_SMN, NBIO_SPACE(GnbHandle, PCIE0_NBIO_CLKREQb_MAP_CNTL_ADDRESS_HYEX), &NBIO_CLKREQb_MAP_CNTL0, 0);
    NbioRegisterRead ( GnbHandle, TYPE_SMN, NBIO_SPACE(GnbHandle, PCIE1_NBIO_CLKREQb_MAP_CNTL_ADDRESS_HYEX), &NBIO_CLKREQb_MAP_CNTL1, 0);
    if (Pcie0Cntl) {
      NBIO_CLKREQb_MAP_CNTL0.Field.PCIE_CLKREQB_CNTL_MASK = 0;
      NBIO_CLKREQb_MAP_CNTL0.Field.PCIE_CLKREQB_0_MAP = DefaultClkReqMapCntlST[0][1];
      NBIO_CLKREQb_MAP_CNTL0.Field.PCIE_CLKREQB_1_MAP = DefaultClkReqMapCntlST[1][1];
      NBIO_CLKREQb_MAP_CNTL0.Field.PCIE_CLKREQB_2_MAP = DefaultClkReqMapCntlST[2][1];
      NBIO_CLKREQb_MAP_CNTL0.Field.PCIE_CLKREQB_3_MAP = DefaultClkReqMapCntlST[3][1];
      NBIO_CLKREQb_MAP_CNTL0.Field.PCIE_CLKREQB_4_MAP = DefaultClkReqMapCntlST[4][1];
      ...
      Address = NBIO_SPACE(GnbHandle, PCIE0_LC_CNTL_ADDRESS_HYEX);
    }
    ...
    if (Pcie1Cntl) {
      ...
      NBIO_CLKREQb_MAP_CNTL1.Field.PCIE_CLKREQB_0_MAP = DefaultClkReqMapCntlST[0][1] + 8;
      NBIO_CLKREQb_MAP_CNTL1.Field.PCIE_CLKREQB_1_MAP = DefaultClkReqMapCntlST[1][1] + 8;
      NBIO_CLKREQb_MAP_CNTL1.Field.PCIE_CLKREQB_2_MAP = DefaultClkReqMapCntlST[2][1] + 8;
      NBIO_CLKREQb_MAP_CNTL1.Field.PCIE_CLKREQB_3_MAP = DefaultClkReqMapCntlST[3][1] + 8;
      NBIO_CLKREQb_MAP_CNTL1.Field.PCIE_CLKREQB_4_MAP = DefaultClkReqMapCntlST[4][1] + 8;
      Address = NBIO_SPACE(GnbHandle, PCIE1_LC_CNTL_ADDRESS_HYEX);
    }
    NbioRegisterWrite (GnbHandle, TYPE_SMN, NBIO_SPACE(GnbHandle, PCIE0_NBIO_CLKREQb_MAP_CNTL_ADDRESS_HYEX), &NBIO_CLKREQb_MAP_CNTL0, GNB_REG_ACC_FLAG_S3SAVE);
    NbioRegisterWrite (GnbHandle, TYPE_SMN, NBIO_SPACE(GnbHandle, PCIE1_NBIO_CLKREQb_MAP_CNTL_ADDRESS_HYEX), &NBIO_CLKREQb_MAP_CNTL1, GNB_REG_ACC_FLAG_S3SAVE);
