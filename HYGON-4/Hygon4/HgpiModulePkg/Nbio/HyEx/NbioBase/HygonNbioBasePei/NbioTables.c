...
#define FILECODE        NBIO_NBIOBASE_HYEX_HYGONNBIOBASEPEI_NBIOTABLES_FILECODE
...
GNB_TABLE ROMDATA GnbEarlyInitTable [] = {
  // IOHC::NB_CNTL[DISABLE_NBIO_2_3_FOR_DEINTERLEAVING]=1      
  GNB_ENTRY_PROPERTY_RMW (
    TABLE_PROPERTY_DISABLE_NBIO23,        
    TYPE_SMN,
    NB_IOC_CNTL_ADDRESS_HYEX,
  ...
  GNB_ENTRY_RMW (
    ...
    IOC_FEATURE_CNTL_ADDRESS_HYEX,
    NBMISC_0118_P2P_mode_MASK,
    (0x1 << NBMISC_0118_P2P_mode_OFFSET)
    ),
  GNB_ENTRY_RMW (
    PCIE_VDM_CNTL2_TYPE,
    PCIE_VDM_CNTL2_ADDRESS_HYEX,
  ...
  GNB_ENTRY_WR (
    ...
    IOHC_SION_S0_Client0_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client0_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client0_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client0_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S0_Client0_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client0_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S0_Client0_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client1_Req_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client1_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client1_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client1_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client1_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S0_Client1_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client1_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S0_Client1_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client2_Req_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client2_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client2_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client2_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client2_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S0_Client2_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client2_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S0_Client2_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client3_Req_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client3_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client3_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client3_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client3_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S0_Client3_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x84218421
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client3_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S0_Client3_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x84218421
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client4_Req_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client4_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client4_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client4_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client4_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S0_Client4_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x84218421
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client4_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S0_Client4_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x84218421
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client5_Req_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client5_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client5_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client5_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client5_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S0_Client5_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x85218521
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client5_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S0_Client5_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x85218521
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client0_Req_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client0_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client0_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client0_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client0_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S1_Client0_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x42185421
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client0_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S1_Client0_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x21542185
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client1_Req_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client1_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client1_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client1_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client1_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S1_Client1_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client1_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S1_Client1_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client2_Req_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client2_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client2_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client2_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client2_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S1_Client2_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client2_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S1_Client2_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client3_Req_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client3_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client3_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client3_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client3_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S1_Client3_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client3_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S1_Client3_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client4_Req_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client4_Req_BurstTarget_Lower_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client4_Req_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client4_Req_BurstTarget_Upper_ADDRESS_HYEX,
    0x08080808
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client4_Req_TimeSlot_Lower_TYPE,
    IOHC_SION_S1_Client4_Req_TimeSlot_Lower_ADDRESS_HYEX,
    0x21212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client4_Req_TimeSlot_Upper_TYPE,
    IOHC_SION_S1_Client4_Req_TimeSlot_Upper_ADDRESS_HYEX,
    0x00212121
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client0_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client0_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client1_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client1_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client2_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client2_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client3_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client3_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client4_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client4_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client5_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S0_Client5_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client0_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client0_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client1_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client1_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client2_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client2_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client3_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client3_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client4_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client4_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client5_RdRsp_BurstTarget_Lower_TYPE,
    IOHC_SION_S1_Client5_RdRsp_BurstTarget_Lower_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client0_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client0_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client1_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client1_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client2_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client2_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client3_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client3_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client4_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client4_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S0_Client5_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S0_Client5_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client0_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client0_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client1_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client1_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client2_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client2_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client3_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client3_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client4_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client4_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  GNB_ENTRY_WR (
    IOHC_SION_S1_Client5_RdRsp_BurstTarget_Upper_TYPE,
    IOHC_SION_S1_Client5_RdRsp_BurstTarget_Upper_ADDRESS_HYEX,
    0x02020202
    ),
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR0_INTERRUPT_ROUTING_ADDRESS_HYEX,
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR1_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR2_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR3_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR4_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR5_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR6_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR7_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR8_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
    (0x7 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR9_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
    (0x6 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
    (0x2 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_OFFSET) |
    (0xD << IOAPIC_BR_INTERRUPT_Br_int_Intr_map_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR10_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
    (0x5 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
    (0x2 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_OFFSET) |
    (0xE << IOAPIC_BR_INTERRUPT_Br_int_Intr_map_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR11_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
    (0x4 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
    (0x2 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_OFFSET) |
    (0xF << IOAPIC_BR_INTERRUPT_Br_int_Intr_map_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR12_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
    (0x3 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR13_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
    (0x2 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR14_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
    (0x1 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR15_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
    (0x0 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR16_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
    (0x3 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOAPIC_BR17_INTERRUPT_ROUTING_ADDRESS_HYEX,
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
    IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
    IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
    (0x4 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
    ...
    //Two IOAPIC_BR_INTERRUPT_ROUTING Registers are added in order to support PCIE2-PortA/B (Actually Port G/H)
   GNB_ENTRY_RMW (
     TYPE_SMN,
     IOAPIC_BR18_INTERRUPT_ROUTING_ADDRESS_HYEX,
     IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
     IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
     IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
     (0x1 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
   ...
   GNB_ENTRY_RMW (
     TYPE_SMN,
     IOAPIC_BR19_INTERRUPT_ROUTING_ADDRESS_HYEX,
     IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_MASK |
     IOAPIC_BR_INTERRUPT_Br_ext_Intr_swz_MASK |
     IOAPIC_BR_INTERRUPT_Br_int_Intr_map_MASK,
     (0x2 << IOAPIC_BR_INTERRUPT_Br_ext_Intr_grp_OFFSET) |
  ...
  //NBIF DEVICE INITIALIZATION     
    //PSPCCP enabled on NBIO0/NBIF0, NTBCCP enabled on NBIO1-3/NBIF0
    GNB_ENTRY_RMW (    
    TYPE_SMN,
    NBIF0_FUNC2_STRAP0_ADDRESS_HYEX,
    NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK,
    (1 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET)
    ),
  // NTBCCP enabled on NBIO0-3/NBIF1
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF1_FUNC1_STRAP0_ADDRESS_HYEX,
    NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK,
    (1 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET)
    ),
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF1_HDAUDIO_STRAP0_ADDRESS_HYEX,
    NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK,
    (0 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF1_XGBE0_STRAP0_ADDRESS_HYEX,
    NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK,
    (0 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF1_XGBE1_STRAP0_ADDRESS_HYEX,
    NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK,
    (0 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF1_XGBE2_STRAP0_ADDRESS_HYEX,
    NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK,
    (0 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF1_XGBE3_STRAP0_ADDRESS_HYEX,
    NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK,
    (0 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET)
    ),
  //NTB disabled on all NBIOS
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF0_NTB_STRAP0_ADDRESS_HYEX,
    NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK,
    (0 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF2_NTB_STRAP0_ADDRESS_HYEX,
    NBIFSTRAP0_FUNC_EN_DEV0_F0_MASK,
    (0 << NBIFSTRAP0_FUNC_EN_DEV0_F0_OFFSET)
    ),
  // Enable interrupts for USB and PSPCCP on NBIO0/NBIF0,USB and NTBCCP on NBIO1-3/NBIF0, all others disabled
  GNB_ENTRY_WR (
    TYPE_SMN,
    NBIFMISC0_INTR_LINE_POLARITY_ADDRESS_HYEX,
    0x00000000
    ),
  //Need check register
  GNB_ENTRY_WR (
    TYPE_SMN,
    NBIFMISC0_INTR_LINE_ENABLE_ADDRESS_HYEX,
    0x0000000C
    ),
  GNB_ENTRY_WR (
    TYPE_SMN,
    NBIFMISC1_INTR_LINE_POLARITY_ADDRESS_HYEX,
    0x00000000
    ),
  //Enable NBIF1 fun 2 SATA interrupt
  GNB_ENTRY_WR (
    TYPE_SMN,
    NBIFMISC1_INTR_LINE_ENABLE_ADDRESS_HYEX,
    0x00000004
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    IOHC_P2P_CNTL_ADDRESS_HYEX,
  ...
  //NTBCCP interrupt enabled on NBIO0-3/NBIF1
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIFMISC1_INTR_LINE_ENABLE_ADDRESS_HYEX,
    (1 << 1),
  ...
  GNB_ENTRY_WR (
    TYPE_SMN,
    NBIFMISC2_INTR_LINE_POLARITY_ADDRESS_HYEX,
    0x00000000
    ),
  GNB_ENTRY_WR (
    TYPE_SMN,
    NBIFMISC2_INTR_LINE_ENABLE_ADDRESS_HYEX,
    0x00000000
    ),
  // NBIFMISC[0-2] SATA RO overide
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF0_BIFC_DMA_ATTR_OVERRIDE_F2_F3_HYEX,
    NBIF0_BIFC_DMA_ATTR_OVERRIDE_F2_F3_TX_RO_OVERIDE_P_F2_MASK,
    (1 << NBIF0_BIFC_DMA_ATTR_OVERRIDE_F2_F3_TX_RO_OVERIDE_P_F2_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF1_BIFC_DMA_ATTR_OVERRIDE_F2_F3_HYEX,
    NBIF0_BIFC_DMA_ATTR_OVERRIDE_F2_F3_TX_RO_OVERIDE_P_F2_MASK,
    (1 << NBIF0_BIFC_DMA_ATTR_OVERRIDE_F2_F3_TX_RO_OVERIDE_P_F2_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF2_BIFC_DMA_ATTR_OVERRIDE_F2_F3_HYEX,
    NBIF0_BIFC_DMA_ATTR_OVERRIDE_F2_F3_TX_RO_OVERIDE_P_F2_MASK,
    (1 << NBIF0_BIFC_DMA_ATTR_OVERRIDE_F2_F3_TX_RO_OVERIDE_P_F2_OFFSET)
    ),
  ...
  GNB_ENTRY_PROPERTY_RMW (
    ...
    IOHC_GLUE_CG_LCLK_CTRL_0_ADDRESS_HYEX,
  ...
  GNB_ENTRY_PROPERTY_RMW (
    ...
    IOHC_GLUE_CG_LCLK_CTRL_1_ADDRESS_HYEX,
...
//    (0x0 << NBMISC_008C_SOFT_OVERRIDE_CLK2_OFFSET) |
  ...
  GNB_ENTRY_PROPERTY_RMW (
    TABLE_PROPERTY_MASTER_NBIO,
    SION_WRAPPER_404_SST0_TYPE,
    SION_WRAPPER_404_SST0_ADDRESS_HYEX,
  ...
  GNB_ENTRY_PROPERTY_RMW (
    ...
    SION_WRAPPER_404_SST1_ADDRESS_HYEX,
    SION_WRAPPER_404_CFG_SSTSION_GLUE_CG_LCLK_CTRL_SOFT_OVERRIDE_CLK4_MASK,
    (0x1 << SION_WRAPPER_404_CFG_SSTSION_GLUE_CG_LCLK_CTRL_SOFT_OVERRIDE_CLK4_OFFSET)
    ),

  GNB_ENTRY_PROPERTY_RMW (
    TABLE_PROPERTY_MASTER_NBIO | TABLE_PROPERTY_SST_CLOCK_GATING_DISABLED,
    TYPE_SST0,
    SST_CLOCK_CTRL_SST0_ADDRESS_HYEX,
  ...
  GNB_ENTRY_PROPERTY_RMW (
    TABLE_PROPERTY_MASTER_NBIO | TABLE_PROPERTY_SST_CLOCK_GATING_DISABLED,
    TYPE_SST1,
    SST_CLOCK_CTRL_SST1_ADDRESS_HYEX,
    SST_CLOCK_CTRL_RXCLKGATEEn_MASK |
    SST_CLOCK_CTRL_TXCLKGATEEn_MASK,
    (0x0 << SST_CLOCK_CTRL_RXCLKGATEEn_OFFSET) |
    (0x0 << SST_CLOCK_CTRL_TXCLKGATEEn_OFFSET)
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG20_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG16_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG17_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  //Configure IOHC_Bridge_CNTL registers
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG0_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG1_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG2_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG3_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG4_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG5_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG6_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG7_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG8_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG9_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG10_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
   TYPE_SMN,
   NB_DEVINDCFG11_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG12_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG13_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG14_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG15_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG18_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NB_DEVINDCFG19_IOHC_Bridge_CNTL_ADDRESS_HYEX,
    IOHC_BRIDGE_CNTL_NoSnoopDis_MASK,
    (0x1 << IOHC_BRIDGE_CNTL_NoSnoopDis_OFFSET)
    ),
  ...
  GNB_ENTRY_WR (
    TYPE_SMN,
    PCIE_SDP_CTRL_PCIECORE1_ADDRESS_HYEX,
    0x3
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
  ...
  // Set SDP unit ID to 7 for PCIE core 2
    ...
    GNB_ENTRY_PROPERTY_WR (
      TABLE_PROPERTY_MASTER_NBIO,      
      TYPE_SMN,
      PCIE_SDP_CTRL_PCIECORE2_ADDRESS_HYEX,
      0x7
      ),
    GNB_ENTRY_PROPERTY_RMW (
      TABLE_PROPERTY_MASTER_NBIO,      
  ...
  GNB_ENTRY_PROPERTY_RMW (
    ...
    POISON_ACTION_CONTROL_ADDRESS_HYEX,
  ...
  GNB_ENTRY_RMW (
    ...
    ErrEvent_ACTION_CONTROL_ADDRESS_HYEX,
  ...
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF0_PCIEP_STRAP_MISC_ADDRESS_HYEX,
    NBIF_PCIEP_STRAP_MISC_STRAP_MULTI_FUNC_EN_MASK,
    (0x1 << NBIF_PCIEP_STRAP_MISC_STRAP_MULTI_FUNC_EN_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF1_PCIEP_STRAP_MISC_ADDRESS_HYEX,
    NBIF_PCIEP_STRAP_MISC_STRAP_MULTI_FUNC_EN_MASK,
    (0x1 << NBIF_PCIEP_STRAP_MISC_STRAP_MULTI_FUNC_EN_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    NBIF2_PCIEP_STRAP_MISC_ADDRESS_HYEX,
    NBIF_PCIEP_STRAP_MISC_STRAP_MULTI_FUNC_EN_MASK,
    (0x1 << NBIF_PCIEP_STRAP_MISC_STRAP_MULTI_FUNC_EN_OFFSET)
    ),
  GNB_ENTRY_RMW (
    TYPE_SMN,
    RCC_NBIF0_STRAP1_ADDRESS_HYEX,
  ...
  GNB_ENTRY_RMW (
    MGCG_CTRL_TYPE,
    NBIF0_MGCG_CTRL_ADDRESS_HYEX,
    MGCG_EN_MASK,
    (0x1 << MGCG_EN_OFFSET)
    ),
  GNB_ENTRY_RMW (
    MGCG_CTRL_TYPE,
    NBIF1_MGCG_CTRL_ADDRESS_HYEX,
    MGCG_EN_MASK,
    (0x1 << MGCG_EN_OFFSET)
    ),
  GNB_ENTRY_RMW (
    MGCG_CTRL_TYPE,
    NBIF2_MGCG_CTRL_ADDRESS_HYEX,
    MGCG_EN_MASK,
    (0x1 << MGCG_EN_OFFSET)
    ),
  GNB_ENTRY_RMW (
    MGCG_CTRL_TYPE,
    SYSHUBMM0_NGDC_MGCG_CTRL_ADDRESS_HYEX,
    MGCG_EN_MASK,
    (0x1 << MGCG_EN_OFFSET)
    ),
  GNB_ENTRY_RMW (
    MGCG_CTRL_TYPE,
    SYSHUBMM1_NGDC_MGCG_CTRL_ADDRESS_HYEX,
    MGCG_EN_MASK,
    (0x1 << MGCG_EN_OFFSET)
    ),
// Nbif B/D/F
...
GNB_TABLE ROMDATA GnbEnvInitTable [] = {

  GNB_ENTRY_TERMINATE
};

GNB_TABLE ROMDATA GnbMidInitTable [] = {
