  ...
  )
{
  ...
  //
  // Send the print string to HygonIdsDebugPrintLib
  //
  HygonIdsDebugPrintf (HYGON_IDS_DP_FLAG_ALL, Format, Marker);
  VA_END (Marker);
}
  ...
  )
{
  ...
  //
  // Send the ASSERT string to HygonIdsDebugPrintLib
  //
  HygonIdsDebugPrintf (HYGON_IDS_DP_FLAG_ALL, Buffer, NULL);
