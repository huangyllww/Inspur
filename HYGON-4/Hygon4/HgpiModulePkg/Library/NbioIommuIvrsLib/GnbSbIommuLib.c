  ...
  )
{
  ...
  PCI_ADDR           PciAddress;
  UINT32             Value;
  HYGON_LATE_PARAMS  *LateParamsPtr;

  IDS_HDT_CONSOLE (GNB_TRACE, "SbCreateIvhdEntries Entry\n");
  LateParamsPtr = (HYGON_LATE_PARAMS *)StdHeader;
  PciAddress.AddressValue = MAKE_SBDFO (0, 0, 0xB, 4, 0);
  // P2P alias entry
  ...
  PciAddress.AddressValue = MAKE_SBDFO (0, 0, 0xB, 0, 0);
  // HPET
