 ...
 *----------------------------------------------------------------------------------------
 */
#define FILECODE  LIBRARY_BASESOCKETLOGICALIDDMLIB_BASESOCKETLOGICALIDDMLIB_FILECODE
 ...
 *
 * @retval      HGPI_SUCCESS      Given socket's logical ID was successfully found
 * @retval      HGPI_BOUNDS_CHK   Socket is not populated
 * @retval      HGPI_BOUNDS_CHK   RawId is NULL
 */
HGPI_STATUS
  ...
  )
{
  ...
  SmnRegisterRead ((UINT32)(FabricTopologyGetHostBridgeBusBase (Socket, 0, 0)), CDD_SPACE ((UINT32)CddId, PWR_SOCID_ADDRESS), RawId);
  IDS_HDT_CONSOLE (CPU_TRACE, "    SOC Raw Id = 0x%X\n", *RawId);
  return HGPI_SUCCESS;
}
 ...
 * @retval      HGPI_SUCCESS      Given socket's logical ID was successfully found
 * @retval      HGPI_BOUNDS_CHK   Socket is not populated
 * @retval      HGPI_BOUNDS_CHK   LogicalId is NULL
 * @retval      HGPI_ERROR        The given socket's family is unknown
 */
HGPI_STATUS
