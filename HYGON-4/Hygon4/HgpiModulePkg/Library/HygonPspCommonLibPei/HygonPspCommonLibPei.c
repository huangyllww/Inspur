...
#define FILECODE  LIBRARY_HYGONPSPCOMMONLIBPEI_HYGONPSPCOMMONLIBPEI_FILECODE
...
GetPspServicePointer (
  HYGON_PSP_COMMON_SERVICE_PPI **PspServicePtr
  )
{
...
{
  EFI_STATUS                    Status;
  HYGON_PSP_COMMON_SERVICE_PPI  *PspService;
