 ...
 *
 * Save user's request about MMIO/IO size for each Rb to NV variable
 *
 * @param[in]    CurrentUsed        Current used Mmio size for each Rb
 * @param[in]    UserRequest        User's request about Mmio size for each Rb
 *
 ...
 *
 * Clear user's request about MMIO/IO size for each Rb to NV variable
 *
 *
 * @retval       EFI_UNSUPPORTED        Don't support this function during PEI
 */
 ...
 *
 * Get the information about which Rb's MMIO should be put above Pcie Cfg
 *
 ...
 *
 * Set the information about which Rb's MMIO should be put above Pcie Cfg
 *
 * @param[in, out]    ResourceDistribution       If it's above Pcie Cfg
 *
 * @retval            EFI_UNSUPPORTED            Don't support this function during PEI
