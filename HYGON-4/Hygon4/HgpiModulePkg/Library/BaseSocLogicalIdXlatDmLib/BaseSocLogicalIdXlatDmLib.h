...
#ifndef _BASE_SOC_LOGICAL_ID_XLAT_DM_H_
#define _BASE_SOC_LOGICAL_ID_XLAT_DM_H_
...
typedef struct {
  ...
  UINT32    LogicalRevision;       ///< Logical revision
...
#define SOC_LOGICAL_FAMILY_XLAT_TERMINATOR    { 0, 0, HYGON_FAMILY_UNKNOWN, NULL }
#define SOC_LOGICAL_REVISION_XLAT_TERMINATOR  { 0, 0, HYGON_REVISION_UNKNOWN }
