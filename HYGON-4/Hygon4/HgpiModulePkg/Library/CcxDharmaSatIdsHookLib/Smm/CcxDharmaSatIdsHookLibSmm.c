...
#include "CcxDharmaSatIdsSyncMsrSmm.h"
#include <IdsHookId.h>
#include "IdsNvIdSAT.h"
#include "IdsNvDefSAT.h"
#include "Filecode.h"

#define FILECODE  LIBRARY_CCXDHARMASATIDSHOOKLIB_SMM_CCXDHARMASATIDSHOOKLIBSMM_FILECODE
...
#else
  #include <Internal/CcxDharmaSatIdsHookLibIntSmm.h>
#endif
