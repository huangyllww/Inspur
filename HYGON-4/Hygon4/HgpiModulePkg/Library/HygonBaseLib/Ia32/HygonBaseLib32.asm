...
; *
; */
PUBLIC LibHygonSimNowEnterDebugger
LibHygonSimNowEnterDebugger PROC NEAR C USES EBX ECX EDX ESI
    ...
    ret
LibHygonSimNowEnterDebugger ENDP
...
; *
; */
PUBLIC LibHygonHDTBreakPoint
LibHygonHDTBreakPoint PROC NEAR C
...
PUBLIC LibHygonFinit
LibHygonFinit  PROC NEAR C
    finit
    ret
LibHygonFinit  ENDP
