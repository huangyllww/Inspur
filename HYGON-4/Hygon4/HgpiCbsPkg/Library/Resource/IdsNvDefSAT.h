...
/// SEV VMs using ASIDs below the CSV-ES ASID Space Limit must enable the CSV-ES feature. The valid values for this field are from 0x1 (1) - 0x10 (16).
#define IDSOPT_CMN_CPU_CSV_ASID_SPACE_LIMIT_MIN  1 ///< Min of CSV-ES ASID Space Limit
#define IDSOPT_CMN_CPU_CSV_ASID_SPACE_LIMIT_MAX  501 ///< Max of CSV-ES ASID Space Limit
