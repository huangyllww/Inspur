...
PEI_CBS_FUNCTION_STRUCT  CbsIdsPeiFunTableCommon[] =
{
  {
    0xFFFFFFFF,      // Common function in combo case
    HYGON_RESERVE_ALL,
    (PPEI_CBS_FUNCTION)CbsInitIdsValueCommon,
  ...
  )
{
  ...
  IdsHookDataGetNv = ((CBS_IDS_HOOK_PARAMS *)HYGON_PARAMS)->Data;
