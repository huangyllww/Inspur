...
HPCB_TYPE_HEADER  HpcbTypeHeader = {
  HPCB_GROUP_MEMORY,
  HPCB_MEM_TYPE_PS_UDIMM_DDR5_ODT_PAT,
...
HPCB_TYPE_DATA_END_SIGNATURE ();
  ...
  HPCB_TYPE_HEADER  HpcbTypeHeader = {
    HPCB_GROUP_MEMORY,
	HPCB_MEM_TYPE_PS_UDIMM_DDR5_CAD_BUS_PAT,
	sizeof (HPCB_TYPE_HEADER) + 30,
	0x0000
  };

PSCFG_CADBUS_ENTRY CadBusUDimmDdr5[] = {
  ...
  HPCB_TYPE_HEADER     HpcbTypeHeader = {
    HPCB_GROUP_MEMORY,
	HPCB_MEM_TYPE_PS_UDIMM_DDR5_DATA_BUS_PAT,
	sizeof (HPCB_TYPE_HEADER) + 30,
	0x0000
  };

PSCFG_DATABUS_ENTRY DataBusUdimmDdr5[] = {
  ...
  HPCB_TYPE_HEADER     HpcbTypeHeader = {
    HPCB_GROUP_MEMORY,
	HPCB_MEM_TYPE_PS_UDIMM_DDR5_MAX_FREQ_,
	sizeof (HPCB_TYPE_HEADER) + 7,
	0x0000
  };

PSCFG_MAXFREQ_ENTRY MaxFeqUDIMMDdr5 [] = {
	// Max Freq.
	// Format :
