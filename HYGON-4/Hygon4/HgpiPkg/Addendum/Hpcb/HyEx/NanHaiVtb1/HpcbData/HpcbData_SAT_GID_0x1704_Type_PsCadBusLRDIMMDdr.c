...
// HPCB_TYPE_HEADER  HpcbTypeHeader = { HPCB_GROUP_MEMORY, HPCB_MEM_TYPE_PS_LRDIMM_DDR5_CAD_BUS, (sizeof(HPCB_TYPE_HEADER) + sizeof (PSCFG_CADBUS_ENTRY) * 30), 0, 0, 0 };
HPCB_TYPE_HEADER  HpcbTypeHeader = {
  HPCB_GROUP_MEMORY,
  HPCB_MEM_TYPE_PS_LRDIMM_DDR5_CAD_BUS,
...
PSCFG_CADBUS_ENTRY CadBusLRDimmDdr5[] = {
