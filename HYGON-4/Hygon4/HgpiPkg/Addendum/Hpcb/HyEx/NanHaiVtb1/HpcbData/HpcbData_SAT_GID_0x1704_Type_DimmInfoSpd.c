...
//Present, Socket, Channel, Dimm, SmbusAddress
    ...
    TRUE, 1, 0, 0, BLDCF_SPD_CH_A_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x04,
    TRUE, 1, 1, 0, BLDCF_SPD_CH_B_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x04,
    TRUE, 1, 2, 0, BLDCF_SPD_CH_C_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x04,
    TRUE, 1, 3, 0, BLDCF_SPD_CH_D_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x04,
    TRUE, 1, 4, 0, BLDCF_SPD_CH_E_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x08,
    TRUE, 1, 5, 0, BLDCF_SPD_CH_F_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x08,
    TRUE, 1, 6, 0, BLDCF_SPD_CH_G_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x08,
    TRUE, 1, 7, 0, BLDCF_SPD_CH_H_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x08,
    TRUE, 1, 8, 0, BLDCF_SPD_CH_I_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x02,
    TRUE, 1, 9, 0, BLDCF_SPD_CH_J_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x02,
    TRUE, 1, 10, 0, BLDCF_SPD_CH_K_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x02,
    TRUE, 1, 11, 0, BLDCF_SPD_CH_L_DIMM0_ADDRESS, BLDCFG_I2C_MUX_ADDRESS, 0xff, 0x02,
};
