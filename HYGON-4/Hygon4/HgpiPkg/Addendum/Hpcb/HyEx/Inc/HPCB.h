...
// Add for ddr5
#define DDR3200    ((UINT32)1 << (DDR3200_FREQUENCY / 200))
...
#define ALL_SPEED (DDR3200 + DDR3600 + DDR4000 + DDR4400 + DDR4800)
...
///device width
#define DEVICEWIDTH_4  0x1
#define DEVICEWIDTH_8  0x2
#define DEVICEWIDTH_16 0x4
...
/// DDR5 CK ODT termination encoding MR32
/// GA and GB have same encode
typedef enum {
  RTT_CK_OFF = 0, ///<  0  Disabled
  RTT_CK_480 = 1, ///<  1 480 ohms
  RTT_CK_240 = 2, ///<  2 240 ohms
  RTT_CK_120 = 3, ///<  3 120 ohms
  RTT_CK_80  = 4, ///<  4 80 ohms
  RTT_CK_60  = 5, ///<  5 60 ohms
  RTT_CK_RFU = 6, ///<  6 RFU
  RTT_CK_40  = 7, ///<  7 40 ohms
} D5_RTT_CK_ENC;

/// DDR5 CS ODT termination encoding MR32
/// GA and GB have same encode
typedef enum {
  RTT_CS_OFF = 0, ///<  0  Disabled
  RTT_CS_480 = 1, ///<  1 480 ohms
  RTT_CS_240 = 2, ///<  2 240 ohms
  RTT_CS_120 = 3, ///<  3 120 ohms
  RTT_CS_80  = 4, ///<  4 80 ohms
  RTT_CS_60  = 5, ///<  5 60 ohms
  RTT_CS_RFU = 6, ///<  6 RFU ohms
  RTT_CS_40  = 7, ///<  7 40 ohms
} D5_RTT_CS_ENC;

/// DDR5 CA ODT termination encoding MR33
/// GA and GB have same encode
typedef enum {
  RTT_CA_OFF = 0, ///<  0  Disabled
  RTT_CA_480 = 1, ///<  1 480 ohms
  RTT_CA_240 = 2, ///<  2 240 ohms
  RTT_CA_120 = 3, ///<  3 120 ohms
  RTT_CA_80  = 4, ///<  4 80 ohms
  RTT_CA_60  = 5, ///<  5 60  ohms
  RTT_CA_RFU = 6, ///<  6 RFU ohms
  RTT_CA_40  = 7, ///<  7 40 ohms
} D5_RTT_CA_ENC;

/// DDR5 DQS Rtt_PARK termination encoding MR33
typedef enum {
  DQS_RTT_PARK_OFF = 0, ///<  0  Disabled
  DQS_RTT_PARK_240 = 1, ///<  1 240 ohms
  DQS_RTT_PARK_120 = 2, ///<  2 120 ohms
  DQS_RTT_PARK_80  = 3, ///<  3 80 ohms
  DQS_RTT_PARK_60  = 4, ///<  4 60 ohms
  DQS_RTT_PARK_48  = 5, ///<  5 48 ohms
  DQS_RTT_PARK_40  = 6, ///<  6 40 ohms
  DQS_RTT_PARK_34  = 7, ///<  7 34 ohms
} D5_DQS_RTT_PARK_ENC;

/// DDR5 DQ Rtt_PARK termination encoding MR34
typedef enum {
  DQ_RTT_PARK_OFF = 0, ///<  0  Disabled
  DQ_RTT_PARK_240 = 1, ///<  1 240 ohms
  DQ_RTT_PARK_120 = 2, ///<  2 120 ohms
  DQ_RTT_PARK_80  = 3, ///<  3 80 ohms
  DQ_RTT_PARK_60  = 4, ///<  4 60 ohms
  DQ_RTT_PARK_48  = 5, ///<  5 48 ohms
  DQ_RTT_PARK_40  = 6, ///<  6 40 ohms
  DQ_RTT_PARK_34  = 7, ///<  7 34 ohms
} D5_DQ_RTT_PARK_ENC;
/// DDR5 Rtt_WR termination encoding MR34
typedef enum {
  DQ_RTT_WR_OFF = 0, ///<  0  Disabled
  DQ_RTT_WR_240 = 1, ///<  1 240 ohms
  DQ_RTT_WR_120 = 2, ///<  2 120 ohms
  DQ_RTT_WR_80  = 3, ///<  3 80 ohms
  DQ_RTT_WR_60  = 4, ///<  4 60 ohms
  DQ_RTT_WR_48  = 5, ///<  5 48 ohms
  DQ_RTT_WR_40  = 6, ///<  6 40 ohms
  DQ_RTT_WR_34  = 7, ///<  7 34 ohms
} D5_DQ_RTT_WR_ENC;

/// DDR5 DQ_RTT_NOM_WR termination encoding MR35
typedef enum {
  DQ_RTT_NOM_WR_OFF = 0, ///<  0  Disabled
  DQ_RTT_NOM_WR_240 = 1, ///<  1 240 ohms
  DQ_RTT_NOM_WR_120 = 2, ///<  2 120 ohms
  DQ_RTT_NOM_WR_80  = 3, ///<  3 80 ohms
  DQ_RTT_NOM_WR_60  = 4, ///<  4 60 ohms
  DQ_RTT_NOM_WR_48  = 5, ///<  5 48 ohms
  DQ_RTT_NOM_WR_40  = 6, ///<  6 40 ohms
  DQ_RTT_NOM_WR_34  = 7, ///<  7 34 ohms
} D5_DQ_RTT_NOM_WR_ENC;

/// DDR5 DQ_RTT_NOM_RD termination encoding MR35
typedef enum {
  DQ_RTT_NOM_RD_OFF = 0, ///<  0  Disabled
  DQ_RTT_NOM_RD_240 = 1, ///<  1 240 ohms
  DQ_RTT_NOM_RD_120 = 2, ///<  2 120 ohms
  DQ_RTT_NOM_RD_80  = 3, ///<  3 80 ohms
  DQ_RTT_NOM_RD_60  = 4, ///<  4 60 ohms
  DQ_RTT_NOM_RD_48  = 5, ///<  5 48 ohms
  DQ_RTT_NOM_RD_40  = 6, ///<  6 40 ohms
  DQ_RTT_NOM_RD_34  = 7, ///<  7 34 ohms
} D5_DQ_RTT_NOM_RD_ENC;
...
typedef struct {
  ...
  _4BYTE_ALIGN UINT32 DDRrate;    ///< Bitmap of DDR rate
  _4BYTE_ALIGN UINT32 VDDIO;       ///< Bitmap of VDDIO
  _4BYTE_ALIGN UINT32 ManuFacturer;
  _4BYTE_ALIGN UINT32 Dimm0;       ///< Bitmap of rank type of Dimm0
  _4BYTE_ALIGN UINT32 Dimm1;       ///< Bitmap of rank type of Dimm1
  _4BYTE_ALIGN UINT32 DeviceWidth;

  _4BYTE_ALIGN UINT32 DqRttWr;
  _4BYTE_ALIGN UINT32 DqRttNomRd;
  _4BYTE_ALIGN UINT32 DqRttNomWr;
  _4BYTE_ALIGN UINT32 DqVrefDram;
  _4BYTE_ALIGN UINT32 PhyDrvStrenDqDqs;
  _4BYTE_ALIGN UINT32 PhyOdtStrenDqDqs;
  _4BYTE_ALIGN UINT32 RxDqVref;
  _4BYTE_ALIGN UINT32 RttCkGa;
  _4BYTE_ALIGN UINT32 RttCkGb;
  _4BYTE_ALIGN UINT32 RttCsGa;
  _4BYTE_ALIGN UINT32 RttCsGb;
  _4BYTE_ALIGN UINT32 RttCaGa;
  _4BYTE_ALIGN UINT32 RttCaGb;
  _4BYTE_ALIGN UINT32 DqsRttPark;
  _4BYTE_ALIGN UINT32 DqRttPark;
  _4BYTE_ALIGN UINT32 VrefCs;
  _4BYTE_ALIGN UINT32 VrefCa;
} PSCFG_DATABUS_ENTRY_D5;
...
typedef enum {
  ...
  HPCB_TOKEN_CONFIG_MEM_I2C_I3C_VOLTAGE_LEVEL,
...
// because ddr4 parameter is different from ddr5 , we add new token 
// what is the difference between APCB_TOKEN_CBS_DBG_MEM_CTRLLER_RTT_NOM_DDR4 and APCB_TOKEN_CBS_CMN_MEM_CTRLLER_RTT_NOM_DDR4
// #define HPCB_TOKEN_CBS_CMN_MEM_DATA_BUS_CONFIG_CTL_DDR5          0x0100
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_DQ_RTT_WR_DDR5            0x00101
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_DQ_RTT_NOM_RD_DDR5        0x0102
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_DQ_RTT_NOM_WR_DDR5        0x0103
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_DQ_VREF_DRAM_DDR5         0x0104
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_PHY_DRV_STREN_DQ_DQS_DDR5 0x0105
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_PHY_ODT_STREN_DQ_DQS_DDR5 0x0106
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_RX_DQ_VREF_DDR5           0x0107
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_RTT_CK_GA_DDR5            0x0108
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_RTT_CK_GB_DDR5            0x0109
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_RTT_CS_GA_DDR5            0x010A
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_RTT_CS_GB_DDR5            0x010B
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_RTT_CA_GA_DDR5            0x010C
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_RTT_CA_GB_DDR5            0x010D
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_DQS_RTT_PARK_DDR5         0x010E
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_DQ_RTT_PARK_DDR5          0x010F
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_VREF_CA_DDR5              0x0110
#define HPCB_TOKEN_CBS_CMN_MEM_CTRLLER_VREF_CS_DDR5              0x0111
#define HPCB_TOKEN_CBS_CMN_END                                   0x0112
