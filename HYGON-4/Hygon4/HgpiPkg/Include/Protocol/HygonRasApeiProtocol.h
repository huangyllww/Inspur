...
#ifndef _HYGON_RAS_APEI_PROTOCOL_H_
#define _HYGON_RAS_APEI_PROTOCOL_H_

#include "HygonRas.h"

extern EFI_GUID  gHygonRasApeiProtocolGuid;

// current PPI revision
#define HYGON_RAS_APEI_REV  0x01

/*----------------------------------------------------------------------------------------
 *           P R O T O T Y P E S     O F     L O C A L     F U  N C T I O N S
 *----------------------------------------------------------------------------------------
 */
typedef struct _HYGON_RAS_APEI_PROTOCOL HYGON_RAS_APEI_PROTOCOL;

// Protocol prototype
typedef
EFI_STATUS
(EFIAPI *HYGON_ADD_BOOT_ERROR_RECORD_ENTRY)(
...
struct _HYGON_RAS_APEI_PROTOCOL {
  ...
  HYGON_ADD_BOOT_ERROR_RECORD_ENTRY         AddBootErrorRecordEntry;         /// Boot error record to be added
...
#endif //_HYGON_RAS_APEI_PROTOCOL_H_
