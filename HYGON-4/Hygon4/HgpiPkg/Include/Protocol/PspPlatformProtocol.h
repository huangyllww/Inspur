 ...
 * @file
 *
 * HYGON Platform Protocol
 *
 * Contains definitions for HYGON_PSP_PLATFORM_PROTOCOL_GUID
 *
 ...
 *
 * Description: HygonHgpiDxeProtocol.h - DXE Protocol and GUID Declaration.
 *
 ******************************************************************************
 *
 *
...
#define HYGON_PSP_PLATFORM_PROTOCOL_GUID \
