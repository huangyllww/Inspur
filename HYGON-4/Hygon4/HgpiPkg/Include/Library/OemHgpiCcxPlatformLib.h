...
#ifndef _OEM_HGPI_CCX_PLATFORM_LIB_H_
#define _OEM_HGPI_CCX_PLATFORM_LIB_H_
 ...
 *    to perform HGPI HygonInitReset and HygonInitEarly. Since APs, as of now, do not
