 ...
 * @file
 *
 * PSP HPOB related functions Prototype definition
 *
 *
...
#ifndef _HYGONPSP_HPOBLIB_H_
#define _HYGONPSP_HPOBLIB_H_
#include <HPOB.h>
#define HPOB_ENTRY_INSTANCE_MAX  0xFF

/// The data struct used by HPOBLIB as global variable
typedef struct _HPOBLIB_INFO {
  BOOLEAN    Supported;              ///< Specify if HPOB supported
  UINT32     HpobSize;               ///< HpobSize
  UINT64     HpobAddr;               ///< The Address of HPOB
} HPOBLIB_INFO;
