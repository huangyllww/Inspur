 ...
 * @file
 *
 * HYGON OEM Hgpi Customization Function Prototype Header File
 *
 ...
 *
 *    @retval         HGPI_SUCCESS       Function returns successfully
 *    @retval         HGPI_UNSUPPORTED   Function is not supported
 *
 **/
/*---------------------------------------------------------------------------------------*/
EFI_STATUS
HgpiPcieSlotResetControl (
  IN      UINTN                         FcnData,
