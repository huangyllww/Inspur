...
#ifndef _HYGON_PCIE_COMPLEXFM15_H_
#define _HYGON_PCIE_COMPLEXFM15_H_
...
#define  PCIE_PORT_DATA_INITIALIZER(mPortPresent, \
                                    mChannelType, \
                                    mDevAddress, \
                                    mHotplug, \
                                    mMaxLinkSpeed, \
                                    ...
                                    mAspm, \
                                    mResetId) \
  { mPortPresent, mChannelType, mDevAddress, 0, mMaxLinkSpeed, mAspm, mHotplug, mResetId, { 0, mMaxLinkCap, 0, 0 }, \
    { 0, 0, 0 }, EndpointDetect, \
...
#define  PCIE_PORT_DATA_INITIALIZER_V2(mPortPresent, \
                                       mChannelType, \
                                       mDevAddress, \
                                       mDevFunction, \
                                       mHotplug, \
                                       ...
                                       mResetId, \
                                       mClkPmSupport) \
  { mPortPresent, mChannelType, mDevAddress, mDevFunction, mMaxLinkSpeed, mAspm, mHotplug, mResetId, \
    { 0, mMaxLinkCap, 0, mClkPmSupport }, { 0, 0, 0 }, EndpointDetect, \
    { ADAPT_IOC_ENABLED, ADAPT_DFE_CONTROL_DISABLED, ADAPT_LEQ_CONTROL_DC_GAIN_POLE, ADAPT_DOC_DISABLED, \
      ADAPT_FOMC_ENABLED, ADAPT_PIOC_DISABLED } }

#define  PCIE_PORT_DATA_INITIALIZER_GEN3(mPortPresent, \
                                         mChannelType, \
                                         mDevAddress, \
                                         mDevFunction, \
                                         mHotplug, \
                                         ...
                                         mResetId, \
                                         mClkPmSupport, \
                                         mInitOffsetCancellation, \
                                         mDFEControl, \
                                         mLEQControl, \
                                         mDynamicOffsetCalibration, \
                                         mFOMCalculation, \
