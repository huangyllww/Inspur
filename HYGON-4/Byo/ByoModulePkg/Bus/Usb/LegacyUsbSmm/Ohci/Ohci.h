...
enum {
    ...
    //
    OHC_HCREVISION_OFFSET             = 0x0,              // HC Revision register
    ...
    OHC_HCRHDESCRIPTORA_OFFSET        = 0x48,             // HC RH descriptorA register
    OHC_HCRHDESCRIPTORB_OFFSET        = 0x4C,             // HC RH descriptorB register
    ...
    OHC_HCCONTROL_CBSR                = 0x3,              // Host Controller control bulk service ratio
...
typedef struct _USB_OHCI_DEV {
    ...
    //
    // Structures to maintain asynchronous interrupt transfers.
    //
