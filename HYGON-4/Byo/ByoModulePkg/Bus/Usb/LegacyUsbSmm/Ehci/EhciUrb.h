...
#define EHC_INT_ONLY_TRANSFER_ASYNC  0x10
...
#define EHC_INTERRUPT_ONLY_DEVICE_ADDRESS    0x7F
#define EHC_INTERRUPT_ONLY_ENDPOINT_ADDRESS  0x00
...
// a sentimental whose polling interval is 1. Synchronous interrupt
...
Arguments:
  ...
  MaxPacket - Maximum packet length of the endpoint
...
Arguments:
  ...
  EpAddr    - Endpoint address & its direction
