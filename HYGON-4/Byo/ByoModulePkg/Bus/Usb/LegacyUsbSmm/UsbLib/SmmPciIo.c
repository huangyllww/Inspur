...
Returns:
  ...
  EFI_INVALID_PARAMETER  -  Width is not valid or doesn't match register address.
  Other                  -  If any error occurred when calling library functions.
...
--*/
{
    ...
    //
    // PCI Config access are all 32-bit aligned, but by accessing the
