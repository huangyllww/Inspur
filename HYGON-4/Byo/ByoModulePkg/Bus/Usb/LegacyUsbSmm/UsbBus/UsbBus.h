...
// [USB20-9.1.2]
//
#define USB_WAIT_PORT_STATUS_STABLE_STALL  20 * USB_BUS_1_MILLISECOND)
...
//
#define USB_SET_DEVICE_ADDRESS_STALL   (PcdGet32 (PcdUsbSetDeviceAddressStall) * USB_BUS_1_MILLISECOND)
...
// root hub]
//
#define USB_SET_PORT_RESET_STALL       (30 * USB_BUS_1_MILLISECOND)
...
typedef struct _USB_DEVICE {
    ...
    //
    // Saved the last device strings gotten
    //
    UINT16                    LastLangId;
    CHAR16                    *LastStrManufacturer;
    CHAR16                    *LastStrProduct;
    CHAR16                    *LastStrSerialNumber;
} USB_DEVICE;
...
typedef struct _USB_BUS {
    ...
    //
    // WantedUsbIoDPList tracks the Usb child devices which user want to recursively fully connect,
