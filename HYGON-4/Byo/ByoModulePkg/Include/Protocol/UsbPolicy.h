...
typedef struct {
  ...
  UINT8   UsbMassSupport:1;           // wz191210 -
} USB_DEVICE_INFOR;
...
struct _EFI_USB_POLICY_PROTOCOL {
  ...
  UINT8   USBPeriodSupport;             // 0;unsupported; 1:support
  UINT8   LegacyUsbEnable;              // 1: Disabled; 0: Enabled*
  UINT8   LegacyFreeSupport;            // 0:Unsupported ; 1:Support
  UINT8   CodeBase;
  UINT16  AcpiTimerReg;
  UINT8   UsbTimeTue;
  UINT8   InternelHubExist;             // 1: Host have internal hub on board; 0: No internal hub on board
