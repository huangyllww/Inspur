...
HPCB_TYPE_HEADER  HpcbTypeHeader = {
  HPCB_GROUP_CCX,
  HPCB_CCX_TYPE_CONFIG_DEFAULT_PARAMETERS,
  (
...
HPCB_PARAM_ATTRIBUTE  ParameterListDefaultsAttribute[] = {
  { HPCB_TIME_POINT_ANY, HPCB_TOKEN_CONFIG_CCX_MIN_CSV_ASID, sizeof (UINT32) - 1, 0 },
  { 0,                   HPCB_TOKEN_CONFIG_LIMIT,            0,                   0 },
};

_1BYTE_ALIGN UINT8  ParameterListDefaultsValue[] = {
  BSU32 (BLDCFG_CCX_MIN_CSV_ASID),                 // < MIN_CSV_ASID
  BSU08 (0xFF)
};
