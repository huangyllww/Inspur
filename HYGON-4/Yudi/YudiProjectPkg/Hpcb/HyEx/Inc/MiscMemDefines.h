...
typedef enum {
  ...
  VOLT1_2 = VOLT_DDR5_RANGE_START,  ///< 1.2 Volt
...
#define MEM_ERROR_FAILURE_BIOS_PMU_FW_MISMATCH_HGPI_PMU_FW_VERSION  0x04141F00ul ///< The BIOS PMU FW does not match HGPI PMU FW version
#define MEM_ERROR_FAILURE_BIOS_HPCB_MISMATCH_HGPI_HPCB_VERSION      0x04151F00ul ///< The BIOS HPCB does not match HGPI HPCB version
#define MEM_ERROR_FAILURE_BIOS_HPPB_MISMATCH_HGPI_HPPB_VERSION      0x04161F00ul ///< The BIOS HPPB does not match HGPI HPPB version
#define MEM_ERROR_FAILURE_HEAP_SIZE_OF_PSP_BL_TOO_SMALL             0x04171F00ul  ///< The Heap size of the HGPI BL larger than the PSP BL heap size
#define MEM_ERROR_FAILURE_PSP_TABLE_VERSION_MISSMATCH_WITH_HGPI_BL  0x04181F00ul ///< The PSP funciton table version does not match with the HGPI BL Function table version
...
#define MEM_ERROR_FAILURE_HPCB_DDR_TYPE_MISMATCH                    0x041C1F00ul  ///< The HPCB DDR Type missmatch with HGPI BL
#define MEM_ERROR_FAILURE_HPCB_FAMILY_MISMATCH                      0x041D1F00ul  ///< The HPCB Family missmatch with HGPI BL
#define MEM_ERROR_FAILURE_HPPB_DDR_TYPE_MISMATCH                    0x041E1F00ul  ///< The HPPB DDR Type missmatch with HGPI BL
#define MEM_ERROR_FAILURE_HPPB_FAMILY_MISMATCH                      0x041F1F00ul  ///< The HPPB Family missmatch with HGPI BL
...
#define MEM_ERROR_HEAP_ALLOCATE_FOR_DMI_TABLE_DDR5     0x040A1F00ul   ///< Heap allocation error for DMI table for DDR2
...
typedef enum {
  ...
  HGPI_IDS_NV_DRAMCON,                             ///< 0x001F                                                  Specify the mode for controller initialization                                                            Enable or disable HDTOUT feature
  HGPI_IDS_EXT_ID_END,                             ///< 0x0020                                                               specify the end of external NV ID
} IDS_EX_NV_ID;
