...
//
HYGON_CPM_HSIO_TOPOLOGY_TABLE  gCpmHsioTopologyTableNanHaiVtb1S0HyGx = {  //ByoAddHsioLane() will overwrite this table.
  // {  UINT32 TableSignature;   // Signature of CPM table
  // UINT16 TableSize;        // Table size
  // UINT8  FormatRevision;   // Revision of table format
  // UINT8  ContentRevision;  // Revision of table contect
...
//
HYGON_CPM_HSIO_TOPOLOGY_TABLE  gCpmHsioTopologyTableNanHaiVtb1S1HyGx = {  //ByoAddHsioLane() will overwrite this table.
