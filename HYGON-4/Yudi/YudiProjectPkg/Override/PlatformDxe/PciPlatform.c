...
STATIC PCI_OPTION_ROM_TABLE gOpRomTable[] = {
  {1, 0xFFFF, 0, 0, 0x1A03, 0x2000, ASPEED_VIDEO_ROM_FILE_GUID},
#if _PCD_VALUE_PcdAsm1061rOptionRomSupport
  {1, 0xFFFF, 0, 0, 0x1B21, 0x0622, ASMEDIA_SATA_ROM_FILE_GUID},
#endif
#if FixedPcdGetBool(PcdVga07501BD4OptionRomSupport)  
  {1, 0xFFFF, 0, 0, 0x1BD4, 0x0750, VGA_07501BD4_ROM_FILE_GUID},  
#endif
};
...
//DEBUG((EFI_D_INFO, "%a (%X,%X,%X) %4X%04X\n", __FUNCTION__, Bus, Device, Function, DeviceId, VendorId));
