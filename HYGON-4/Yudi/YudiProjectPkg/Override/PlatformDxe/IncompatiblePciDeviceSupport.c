...
// 0x07501BD4, bar 0 28 bit alignment, 64M
  DEVICE_INF_TAG,
  PCI_DEVICE_ID(0x1BD4, 0x0750, MAX_UINT64, MAX_UINT64, MAX_UINT64),
  DEVICE_RES_TAG,
  ...
  0,                                   // AddrRangeMin
  SIZE_256MB - 1,                      // AddrRangeMax(alignment)
  0,                                   // AddrTranslationOffset(BarIndex)
  SIZE_64MB,                           // AddrLen
