...
EFI_GUID mSignatureSupport[] = {EFI_CERT_SHA1_GUID, EFI_CERT_SHA256_GUID, EFI_CERT_RSA2048_GUID, EFI_CERT_SM3_GUID, EFI_CERT_X509_GUID};
  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "AuthVariableLibInitialize Strat!!\n"));
  ...
  //
  DEBUG ((DEBUG_INFO, "InitSecureBootVariables Start!!!\n"));
