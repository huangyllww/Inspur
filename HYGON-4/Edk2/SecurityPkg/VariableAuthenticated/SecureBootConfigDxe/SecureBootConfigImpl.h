...
//
// RSA Certificate public key minimum size (bytes). ~ 128bit AES key strength
//
#define RSA_CER_PUBKEY_MIN_SIZE     256
//
// EC Certificate public key minimum size (bytes). ~ 128bit AES key strength
//
#define EC_CER_PUBKEY_MIN_SIZE      32
