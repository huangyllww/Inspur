...
#define _ASSERT(Expression)  DebugAssert (__FILE_NAME__, DEBUG_LINE_NUMBER, DEBUG_EXPRESSION_STRING (Expression))
  #elif (FixedPcdGet8 (PcdDebugPropertyMask) & DEBUG_PROPERTY_ASSERT_ONLY_BREAKPOINT)
#define _ASSERT(Expression)  CpuBreakpoint()
  #else
#define _ASSERT(Expression)  DebugAssert (__FILE__, DEBUG_LINE_NUMBER, DEBUG_EXPRESSION_STRING (Expression))
  #endif
#endif

#define ASSERT_ENABLE (FixedPcdGet8 (PcdDebugPropertyMask) & (DEBUG_PROPERTY_DEBUG_ASSERT_ENABLED | DEBUG_PROPERTY_ASSERT_ONLY_BREAKPOINT))
...
#define ASSERT_EFI_ERROR(StatusParameter) ASSERT(!EFI_ERROR(StatusParameter))
#endif
/**
...
#define CR(Record, TYPE, Field, TestSignature)                                              \
    (ASSERT_ENABLE && (BASE_CR (Record, TYPE, Field)->Signature != TestSignature)) ?  \
