...
PRINT_GUID_VALUE_TO_NAME gPrintGuidNameFunc = NULL;
//
// Safe print checks
//
        ...
        switch (FormatCharacter) {
          ...
          case 'g':
            ...
            if (TmpGuid == NULL) {
              ...
              if (gPrintGuidNameFunc != NULL) {
                GuidNameString = gPrintGuidNameFunc (ValueBuffer);
                if (GuidNameString == NULL) {
                  ArgumentString = ValueBuffer;
                } else {
                  ArgumentString = GuidNameString;
                }
              }
            }
