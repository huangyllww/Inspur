...
if not defined VSInstallDir (
  echo Set EWDK environment
  echo call %EWDK_PATH%\BuildEnv\SetupBuildenv.cmd
  echo 
  call "%EWDK_PATH%\BuildEnv\SetupBuildenv.cmd"
  @echo off
)
set EWDK_PREFIX=%VSInstallDir%

if not defined WINSDK_PATH_FOR_RC_EXE (
  set "WINSDK_PATH_FOR_RC_EXE=%WDKContentRoot%bin\x64"
)
if /I "%1"=="EWDK" goto SetWinDDK
