  ...
  )
{
  ...
  if (DataLength == 6) {
    UsbMouseDevice->State.RelativeMovementX += *(INT16 *)((INT8 *)Data + 1);
    UsbMouseDevice->State.RelativeMovementY += *(INT16 *)((INT8 *)Data + 3);
    UsbMouseDevice->State.RelativeMovementZ += *((INT8 *)Data + 5);
  }
