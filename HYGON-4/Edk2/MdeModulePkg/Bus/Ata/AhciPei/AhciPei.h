...
#define   AHCI_PORT_IS_ERROR_MASK        (AHCI_PORT_IS_INFS | AHCI_PORT_IS_IFS | AHCI_PORT_IS_HBDS | AHCI_PORT_IS_HBFS | AHCI_PORT_IS_TFES)
#define   AHCI_PORT_IS_FATAL_ERROR_MASK  (AHCI_PORT_IS_IFS | AHCI_PORT_IS_HBDS | AHCI_PORT_IS_HBFS | AHCI_PORT_IS_TFES)
...
typedef enum {
  PeiSataCdrom,                  /* ATAPI CDROM */
  PeiSataHarddisk,               /* Hard Disk */
  PeiSataUnknown
} PEI_ATA_DEVICE_TYPE;
