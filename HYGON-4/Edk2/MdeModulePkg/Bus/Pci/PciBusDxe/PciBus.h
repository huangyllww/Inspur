...
#include <Library/PlatformPciHookLib.h>
...
#undef PCI_MAX_BAR        // original is 6
#define PCI_MAX_BAR  7    // enlarge 1 to 7 for option rom BAR

#define PCI_SPEC_MAX_BAR  6
