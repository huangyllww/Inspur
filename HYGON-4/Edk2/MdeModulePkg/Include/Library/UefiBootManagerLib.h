...
#define PXE_RETRY_FOREVER_VALUE FixedPcdGet16(PcdPxeRetryForeverValue)
...
//
// If boot option's OptionNumber is equal to it, this option will be deleted by BDS when refreshing.
//
