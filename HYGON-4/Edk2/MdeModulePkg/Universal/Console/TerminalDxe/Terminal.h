...
typedef struct {
  ...
  CHAR16                               *StringBuffer;
  UINTN                                *AttributeBuffer;
  TERMINAL_DATA_BACKUP_PROTOCOL        TerminalDataBackup;
} TERMINAL_DEV;
...
#define INPUT_CTRL_0                     0x100
#define INPUT_CTRL_1                     0x200
...
#define TERMINAL_TERMINAL_DATA_BACKUP_THIS(a) CR (a, TERMINAL_DEV, TerminalDataBackup, TERMINAL_DEV_SIGNATURE)
