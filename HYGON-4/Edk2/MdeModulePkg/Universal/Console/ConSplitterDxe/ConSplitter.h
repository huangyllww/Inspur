...
typedef struct {
  ...
  EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL         *VGopTextOut;
...
extern GLOBAL_REMOVE_IF_UNREFERENCED TEXT_OUT_SPLITTER_PRIVATE_DATA mConOut;
extern                               EFI_GRAPHICS_OUTPUT_PROTOCOL   mMiniGop;
