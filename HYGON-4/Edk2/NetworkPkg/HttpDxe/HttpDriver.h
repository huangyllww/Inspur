...
//
// Tls handskage step that server send the certificate
//
#define TLS_SERVER_HELLO_CERTIFICATE  2
//
// Protocol instances
//
...
typedef struct {
  TLS_RECORD_HEADER   TlsRecord;
  UINT8               HandshakeType;
  //
  // Length = Variable name CertificatesLength + Variable name CertificateLen + Certificate data
  //
  UINT8               Length[3];
  //
  // CertificatesLength = Variable name CertificateLen + Certificate data
  //
  UINT8               CertificatesLength[3];
  //
  // CertificateLen = Certificate data
  //
  UINT8               CertificateLen[3];
} TLS_RECORD_CERTIFICATE;
