...
ON_EXIT:
  *BufferSize = (UINTN)CurrentSize;
  ...
  if (Status == EFI_SUCCESS) {
    AsciiPrint (" >> NBP file downloaded successfully.\n");
  } else if ((Status == EFI_BUFFER_TOO_SMALL) && (Buffer != NULL)) {
    AsciiPrint (" >> PXE-E05: Buffer size is smaller than the requested file.\n");
    ...
    AsciiPrint (" >> PXE-E16: No valid offer received.\n");
  } else if (Status == EFI_TIMEOUT) {
    ...
    AsciiPrint (" >> PXE-E53: No boot filename received.\n");
