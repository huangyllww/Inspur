    ...
    case KEY_INITIATOR_URI:
      ...
      if (StrLen (Uri) != 0) {
        ...
        if (Status == EFI_INVALID_PARAMETER) {
          ...
          String1 = HiiGetString (CallbackInfo->RegisteredHandle, STRING_TOKEN (STR_UNSUPPORTED_PROMPT), NULL);
          String2 = HiiGetString (CallbackInfo->RegisteredHandle, STRING_TOKEN (STR_SUPPORT_PROMPT), NULL);
          CreatePopUp (
          ...
          String1 = HiiGetString (CallbackInfo->RegisteredHandle, STRING_TOKEN (STR_UNSUPPORTED_PROMPT), NULL);
          String2 = HiiGetString (CallbackInfo->RegisteredHandle, STRING_TOKEN (STR_HTTP_INFO_PROMPT), NULL);
          CreatePopUp (
            EFI_LIGHTGRAY | EFI_BACKGROUND_BLUE,
            &Key,
            String1,
