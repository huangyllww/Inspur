...
///
/// SM3 digest size in bytes.It is only used in Pkcs5HashPassword () API for SM3 hash
///
#define SM3_DIGEST_SIZE  36
...
/*
  BYOSOFT_OVERRIDE: Bellowing interfaces are used to support SM2 crypto

*/

/**
  Allocates and initializes one EC Key context for subsequent SM2 use.
...
/**
  ...
  Note: In SM2 verification, private Key is not required
