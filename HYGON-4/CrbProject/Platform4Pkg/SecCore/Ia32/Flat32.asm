;
;      NOTICE: Copyright (c) 2006 - 2023 Byosoft Corporation. All rights reserved.
...
HIGH_MEMORY_REGION_BASE  EQU     _PCD_VALUE_PcdPspLoadBiosBaseAddress
...
; we are in memory start from HIGH_MEMORY_REGION_BASE
...
; AMD_ENABLE_UEFI_STACK2 will destory mm register, so here we need protect it.
  ...
  HYGON_ENABLE_UEFI_STACK2 STACK_AT_BOTTOM, _PCD_VALUE_PcdTemporaryRamSize, _PCD_VALUE_PcdTemporaryRamBase
